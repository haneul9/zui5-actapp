...
(function(){
	...
	sap.ui.controller("zhr_payreport.Payreport",{
//	sap.ui.controller("sap.ushell.components.tiles.zhr_payreport.Payreport",{
		timer:null,
		oDataRequest:null,
...
//						a.getView().addContent(T);
		...
		onGetData: function() { 
		  ...
		  var oData2 = { Amt01: "71" ,
				  ...
				  Amt05: "20",
				  Btmsg: "전년 대비 20%",
				  Tip01: "2015년<BR>66,142,630원",
				  Tip02: "2016년<BR>78,471,480원",
				  Tip03: "2017년<BR>81,750,431원",
				  Tip04: "2018년<BR>93,302,490원",
				  Tip05: "2019년<BR>18,404,500원"};
		  oData.results.push(oData2);
		  
		  var oneData = oData.results[0] ;
			oneData.Top01 = 100 - parseInt(oData.results[0].Amt01) + "%";
			oneData.Top02 = 100 - parseInt(oData.results[0].Amt02) + "%";
			oneData.Top03 = 100 - parseInt(oData.results[0].Amt03) + "%";
			oneData.Top04 = 100 - parseInt(oData.results[0].Amt04) + "%";
			oneData.Top05 = 100 - parseInt(oData.results[0].Amt05) + "%";
			
			if(oneData.Amt01 == "0"){
				oneData.Amt01P = "3%" ;
				oneData.Top01 = "97%" ;
				oneData.Color01 = "#2ecc71";
			}
			else{
				oneData.Amt01P = oneData.Amt01 + "%";
				oneData.Color01 = "#2ecc71";
			}
			...
			if(oneData.Amt02 == "0"){
				oneData.Amt02P = "3%" ;
				oneData.Top02 = "97%" ;
				oneData.Color02 = "#2ecc71";
			}
			else{
				oneData.Amt02P = oneData.Amt02 + "%";
				oneData.Color02 = "#2ecc71";
			}
			...
			if(oneData.Amt03 == "0"){
				oneData.Amt03P = "3%" ;
				oneData.Top03 = "97%" ;
				oneData.Color03 = "#2ecc71";
			}
			else{
				oneData.Amt03P = oneData.Amt03 + "%";
				oneData.Color03 = "#2ecc71";
			}
			...
			if(oneData.Amt04 == "0"){
				oneData.Amt04P = "3%" ;
				oneData.Top04 = "97%" ;
				oneData.Color04 = "#2ecc71";
			}
			else{
				oneData.Amt04P = oneData.Amt04 + "%";
				oneData.Color04 = "#2ecc71";
			}
			...
			if(oneData.Amt05 == "0"){
				oneData.Amt05P = "3%" ;
				oneData.Top05 = "97%" ;
				oneData.Color05 = "#FABD64";
			}
			else{
				oneData.Amt05P = oneData.Amt05 + "%";
				oneData.Color05 = "#FABD64";
			}
...
//		  oModel.read("/TotalCompensationSet",
//				null, 
//				null, 
//				false, 
...
//			}
		...
		onUpdateDynamicData:function(){
			...
			if(!n){n=0;}
				...
				jQuery.sap.log.warning("Refresh Interval "+n+" seconds for service URL "+c.service_url+" is less than 10 seconds, which is not supported. "+"Increased to 10 seconds automatically.",null,"zhr_payreport.Payreport.controller");
				n=10;
			}
			if(c.service_url){
				this.loadData(n);
        ...
        onSaveRuntimeSettings: function (oSettingsView) {
            ...
            function logErrorAndReject(oError) {
                jQuery.sap.log.error(oError, null, "zhr_payreport.Payreport.controller");
            }
        ...
        loadData: function (nservice_refresh_interval) {
            ...
            if (nservice_refresh_interval > 0) {
                ...
                jQuery.sap.log.info(
                    ...
                    null,
                    "zhr_payreport.Payreport.controller"
                );
                // call again later
