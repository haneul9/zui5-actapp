...
(function(){
	...
	sap.ui.controller("zui5_hrxx_chart.chart",{
//	sap.ui.controller("sap.ushell.components.tiles.zui5_hrxx_chart.chart",{
		timer:null,
		oDataRequest:null,
...
//			}
		...
		onUpdateDynamicData:function(){
			...
			if(!n){n=0;}
				...
				jQuery.sap.log.warning("Refresh Interval "+n+" seconds for service URL "+c.service_url+" is less than 10 seconds, which is not supported. "+"Increased to 10 seconds automatically.",null,"zui5_hrxx_chart.chart.controller");
				n=10;
			}
			if(c.service_url){
				this.loadData(n);
        ...
        onSaveRuntimeSettings: function (oSettingsView) {
            ...
            function logErrorAndReject(oError) {
                jQuery.sap.log.error(oError, null, "zui5_hrxx_chart.chart.controller");
            }
        ...
        loadData: function (nservice_refresh_interval) {
            ...
            if (nservice_refresh_interval > 0) {
                ...
                jQuery.sap.log.info(
                    ...
                    null,
                    "zui5_hrxx_chart.chart.controller"
                );
                // call again later
