...
(function(){
	...
	sap.ui.controller("zui5_hrxx_empprofile.zhrEmpprofile",{
//	sap.ui.controller("sap.ushell.components.tiles.zui5_hrxx_empprofile.zhrEmpprofile",{
		timer:null,
		oDataRequest:null,
...
//						a.getView().addContent(T);
		...
		onBeforeRendering: function() {
			  ...
			  var vPernr = "";
			  var vMenuId = "ESS00";
			  var oPath = "/EmpLoginInfoSet/?$filter=Lpmid eq 'ESS00'";
			  oCommonModel.read(oPath,null,null,false,function(Data,Res){
			  ...
			  if(vPernr == ""){
				  oController._JSonModel.setData(oDatas);
				  return ;
			  }
...
//			}
		...
		onUpdateDynamicData:function(){
			...
			if(!n){n=0;}
				...
				jQuery.sap.log.warning("Refresh Interval "+n+" seconds for service URL "+c.service_url+" is less than 10 seconds, which is not supported. "+"Increased to 10 seconds automatically.",null,"zui5_hrxx_empprofile.zhrEmpprofile.controller");
				n=10;
			}
			if(c.service_url){
				this.loadData(n);
        ...
        onSaveRuntimeSettings: function (oSettingsView) {
            ...
            function logErrorAndReject(oError) {
                jQuery.sap.log.error(oError, null, "zui5_hrxx_empprofile.zhrEmpprofile.controller");
            }
        ...
        errorHandlerFn: function (oMessage) {
            ...
            jQuery.sap.log.error(
                "Failed to update data via service "
                    ...
                    + ": " + sMessage,
                null,
                "zui5_hrxx_empprofile.zhrEmpprofile"
            );
        ...
        loadData: function (nservice_refresh_interval) {
            ...
            if (nservice_refresh_interval > 0) {
                ...
                jQuery.sap.log.info(
                    ...
                    null,
                    "zui5_hrxx_empprofile.zhrEmpprofile.controller"
                );
                // call again later
