...
(function(){
	...
	sap.ui.controller("zhr_ass_tile.DynamicTile",{
//	sap.ui.controller("sap.ushell.components.tiles.zhr_ass_tile.DynamicTile",{
		timer:null,
		oDataRequest:null,
...
//			}
		...
		onUpdateDynamicData:function(){
			...
			if(!n){n=0;}
				...
				jQuery.sap.log.warning("Refresh Interval "+n+" seconds for service URL "+c.service_url+" is less than 10 seconds, which is not supported. "+"Increased to 10 seconds automatically.",null,"zhr_ass_tile.DynamicTile.controller");
				n=10;
			}
			if(c.service_url){
				this.loadData(n);
        ...
        onSaveRuntimeSettings: function (oSettingsView) {
            ...
            function logErrorAndReject(oError) {
                jQuery.sap.log.error(oError, null, "zhr_ass_tile.DynamicTile.controller");
            }
        ...
        successHandleFn: function (oResult) {
            ...
            // Number -> String 으로 변환            
            oDataToDisplay.Cnt01 = parseInt(oData.Cnt01) + "";
            oDataToDisplay.Cnt02 = parseInt(oData.Cnt02) + "";
            oDataToDisplay.Cnt03 = parseInt(oData.Cnt03) + "";
            oDataToDisplay.Cnt04 = parseInt(oData.Cnt04) + "";
            oDataToDisplay.Cnt05 = parseInt(oData.Cnt05) + "";
            
            // 기간
            oDataToDisplay.display_info_text = "기간 : " + oData.Prdtx;
        ...
        loadData: function (nservice_refresh_interval) {
            ...
            if (nservice_refresh_interval > 0) {
                ...
                jQuery.sap.log.info(
                    ...
                    null,
                    "zhr_ass_tile.DynamicTile.controller"
                );
                // call again later
