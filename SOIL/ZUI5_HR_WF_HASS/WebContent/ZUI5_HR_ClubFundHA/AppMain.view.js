...
sap.ui.jsview("ZUI5_HR_ClubFundHA.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ClubFundHA.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ClubFundHA.ZUI5_HR_ClubFundList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ClubFundHA.ZUI5_HR_ClubFundList", "ZUI5_HR_ClubFundHA.ZUI5_HR_ClubFundList"));
		
		return new sap.m.Shell({
			title : "인포멀그룹 지원금 인출 신청관리",
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_CLUB_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_CLUB_SRV"); 
