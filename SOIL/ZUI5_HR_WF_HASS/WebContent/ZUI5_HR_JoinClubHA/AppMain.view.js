...
sap.ui.jsview("ZUI5_HR_JoinClubHA.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_JoinClubHA.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_JoinClubHA.ZUI5_HR_JoinClubList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_JoinClubHA.ZUI5_HR_JoinClubList", "ZUI5_HR_JoinClubHA.ZUI5_HR_JoinClubList"));
		
		return new sap.m.Shell({
			title : "인포멀그룹 가입/탈퇴 신청 결재",
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL3 = this.getUrl("/sap/opu/odata/sap/ZHR_ATTD_SRV/");
		...
		sap.ui.getCore().setModel(oModel3, "ZHR_ATTD_SRV"); 
