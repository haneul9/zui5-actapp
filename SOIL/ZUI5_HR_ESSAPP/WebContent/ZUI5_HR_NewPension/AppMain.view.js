...
sap.ui.jsview("ZUI5_HR_NewPension.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_NewPension.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_NewPension.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_NewPension.ZUI5_HR_NewPensionList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_NewPension.ZUI5_HR_NewPensionList", "ZUI5_HR_NewPension.ZUI5_HR_NewPensionList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0298"),	// 298:New Pension 내역조회
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_EXTRA_PAY_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_EXTRA_PAY_SRV"); 
