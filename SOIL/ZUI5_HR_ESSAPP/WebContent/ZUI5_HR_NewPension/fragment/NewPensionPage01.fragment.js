...
sap.ui.jsfragment("ZUI5_HR_NewPension.fragment.NewPensionPage01", {
	
	_colModel : [
		{id: "Number", label : "No.", plabel : "", span : 0, type : "string", sort : true, filter : true, width : "6%"},
		{id: "Zyymm", label : oBundleText.getText("LABEL_0220"), plabel : "", span : 0, type : "string", sort : true, filter : true, width : "12%"},	// 220:기준년월
		{id: "Ocrtx", label : oBundleText.getText("LABEL_0300"), plabel : "", span : 0, type : "string", sort : true, filter : true, width : "21%"},	// 300:구분
		{id: "Orgtx", label : oBundleText.getText("LABEL_0028"), plabel : "", span : 0, type : "string", sort : false, filter : false, width : "23%", align : sap.ui.core.TextAlign.Begin},	// 28:부서
		{id: "Bet01", label : oBundleText.getText("LABEL_0299"), plabel : "", span : 0, type : "money", sort : false, filter : false, width : "19%", align : sap.ui.core.TextAlign.End},	// 299:개인부담금
		{id: "Bet02", label : oBundleText.getText("LABEL_0303"), plabel : "", span : 0, type : "money", sort : false, filter : false, width : "19%", align : sap.ui.core.TextAlign.End}	// 303:회사부담금
	],
