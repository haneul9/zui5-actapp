sap.ui.jsfragment("ZUI5_HR_Scholarship.fragment.ScholarshipPage01", {
	_colModel : [
		 ...
		 {id: "Famtx", label : oBundleText.getText("LABEL_1104"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "120px"},	// 1104:지원대상
		 {id: "Fname", label : oBundleText.getText("LABEL_0111"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 111:대상자
		 {id: "Sltxt", label : oBundleText.getText("LABEL_0993"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "120px"},	// 993:학력
		 {id: "Grdspt", label : oBundleText.getText("LABEL_1159"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "60px"},	// 1159:학년
		 {id: "Divtx", label : oBundleText.getText("LABEL_1158"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "85px"},	// 1158:학기/분기
		 {id: "ZbetTotl", label : oBundleText.getText("LABEL_1164"), plabel : "", span : 0, type : "listmoney", sort : true, filter : true, width : "100px"},	// 1164:학자금총액
		 ...
		 {id: "ZListComment", label : oBundleText.getText("LABEL_1086"), plabel : "", span : 0, type : "commentpopover3", sort : true, filter : true, width : "300px", align : "Begin"}	// 1086:담당자 의견
	 ],
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_1163")	// 1163:학자금 신청
