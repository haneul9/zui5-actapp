...
sap.ui.controller("ZUI5_HR_Scholarship.ZUI5_HR_ScholarshipList", {
	/**
	...
	PAGEID : "ZUI5_HR_ScholarshipList",
	...
	onDetailPage : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_Scholarship.ZUI5_HR_ScholarshipList");
		var oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_Scholarship.ZUI5_HR_ScholarshipDetail",
		      data : {
		    	  Appno : _Appno
		      }
		});
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1163") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1163:학자금 신청
			};
