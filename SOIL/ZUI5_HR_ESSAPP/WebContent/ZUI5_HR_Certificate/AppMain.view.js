...
sap.ui.jsview("ZUI5_HR_Certificate.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Certificate.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Certificate.ZUI5_HR_CertificateList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Certificate.ZUI5_HR_CertificateList", "ZUI5_HR_Certificate.ZUI5_HR_CertificateList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1292"),	// 1292:제증명 신청
			showLogout : false,
			app : this.app,
