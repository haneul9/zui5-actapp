sap.ui.jsfragment("ZUI5_HR_Certificate.fragment.CertificatePage01", {
	_colModel : [
			 {id: "Idx", label : "No.", plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "3%"},
			 {id: "ZappStxtAl", label : oBundleText.getText("LABEL_0036"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "4%"},	// 36:상태
			 {id: "Perid", label : oBundleText.getText("LABEL_0031"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "80px"},	// 31:사번
			 {id: "Ename", label : oBundleText.getText("LABEL_0038"), plabel : "", span : 0, type : "listText", sort : true, filter : true , width : "10%"},	// 38:성명
			 {id: "Zzjiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true},	// 67:직위
			 {id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : "Begin"},	// 39:소속부서
			 {id: "Cerno", label : oBundleText.getText("LABEL_1296"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 1296:증명서번호
			 {id: "Certyt", label : oBundleText.getText("LABEL_1297"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "12%"},	// 1297:증명서종류
			 {id: "Reqnt", label : oBundleText.getText("LABEL_1286"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "90px"},	// 1286:신청부수
			 {id: "Sendp", label : oBundleText.getText("LABEL_1293"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : "Begin"},	// 1293:제출처
			 {id: "Preview", label : "미리보기", plabel : "", span : 0, type : "listcert2", sort : true, filter : true, width : "125px"},	// 미리보기
			 {id: "Pntck", label : oBundleText.getText("LABEL_1295"), plabel : "", span : 0, type : "listcert", sort : true, filter : true, width : "125px"},	// 1295:증명서 출력여부
			 {id: "Prtnt", label : oBundleText.getText("LABEL_2874"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "90px"},	// 2874:출력부수
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_1292")	// 1292:제증명 신청
	...
	getFilterLayoutRender : function(oController) {
		...
		return new sap.m.Toolbar({
			...
			content : [
				...
				new sap.m.ToolbarSpacer({width : "20px"}),
				new sap.m.Text({
					text : oBundleText.getText("LABEL_0019"),	// 84:신청자 성명 
					visible : displayYn
				}).addStyleClass("Font14px FontBold"),
				new sap.m.ToolbarSpacer({width : "10px"}),
