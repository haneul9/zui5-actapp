...
sap.ui.jsview("ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList", {
	...
	getControllerName : function() {
		return "ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList";
	},
	...
	createContent : function(oController) {
		...
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			content : sap.ui.jsfragment("ZUI5_HR_RecRequest.fragment.RecRequestPage01",oController),
//			customHeader : new sap.m.Bar({
//				contentMiddle : new sap.m.Text({
//					text : oBundleText.getText("LABEL_2248")	// 2248:충원요청서 작성
