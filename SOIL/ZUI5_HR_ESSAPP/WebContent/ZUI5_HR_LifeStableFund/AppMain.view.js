...
sap.ui.jsview("ZUI5_HR_LifeStableFund.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_LifeStableFund.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_LifeStableFund.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_LifeStableFund.ZUI5_HR_LifeStableFundList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_LifeStableFund.ZUI5_HR_LifeStableFundList", "ZUI5_HR_LifeStableFund.ZUI5_HR_LifeStableFundList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0227"),	// 227:생활안정자금 조회
			showLogout : false,
			app : this.app,
