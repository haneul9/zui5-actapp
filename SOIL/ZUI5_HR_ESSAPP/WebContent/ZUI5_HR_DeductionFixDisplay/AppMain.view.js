...
sap.ui.jsview("ZUI5_HR_DeductionFixDisplay.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeductionFixDisplay.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeductionFixDisplay.ZUI5_HR_DeductionFixDisplayList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeductionFixDisplay.ZUI5_HR_DeductionFixDisplayList", "ZUI5_HR_DeductionFixDisplay.ZUI5_HR_DeductionFixDisplayList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0589"),	// 589:고정공제 조회(개인)
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_DEDUCT_FIX_DISP_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_DEDUCT_FIX_DISP_SRV");
