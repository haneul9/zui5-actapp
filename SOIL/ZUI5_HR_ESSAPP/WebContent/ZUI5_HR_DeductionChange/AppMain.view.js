...
sap.ui.jsview("ZUI5_HR_DeductionChange.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeductionChange.AppMain";
	},

	/** Is initially called once after the Controller has been instantiated. It is the place where the UI is constructed. 
	* Since the Controller is given to this method, its event handlers can be attached right away. 
	* @memberOf ZHR_UI5_DeductionChange.AppMain
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeductionChange.ZUI5_HR_DeductionChangeList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeductionChange.ZUI5_HR_DeductionChangeList", "ZUI5_HR_DeductionChange.ZUI5_HR_DeductionChangeList"));
