...
//	        .attr("style",function(d){return d.style1})
		...
		nodeEnter.append("text")
	        ...
	        .text(function(d){if(d.Objid == "99999999") return ""; 
	              else return d.Ename+" "+d.Ztext; });
		
		nodeEnter.append("text")
	        .attr("x", function(d){if(d.nX2) return d.nX2; else return ""; })
	        .attr("y", function(d){if(d.nY2) return d.nY2; else return ""; })
	        .attr("class", function(d){return d.nClass;})
	        .attr("text-anchor", function(d){return d.Left;})
	        .text(function(d){if(d.AEname) return d.AEname+" "+d.Ztext; else return "" ;});
		...
		nodeEnter.append("text")
	        ...
	        .attr("text-anchor", function(d){return d.Left;})
	        .text(function(d){if(d.Objid == "99999999") return ""; 
	 			              else return oBundleText.getText("LABEL_2189") + " : "+d.Zjktt });	// 2189:직책
		
		nodeEnter.append("text")
	        .attr("x", function(d){if(d.jX2) return d.jX2; else return ""; })
	        .attr("y", function(d){if(d.jY2) return d.jY2; else return ""; })
	        .attr("class", function(d){return d.jClass;})
	        .attr("text-anchor", function(d){return d.Left;})
	        .text(function(d){if(d.AZjktt) return oBundleText.getText("LABEL_2189") + " : "+d.AZjktt; else return "" ;});	// 2189:직책
		...
		nodeEnter.append("text")
	        ...
	        .text(function(d){if(d.Objid == "99999999") return ""; 
				 			  else return oBundleText.getText("LABEL_2073") + " : "+d.Ipdat });	// 2073:입사일자
		
		nodeEnter.append("text")
	        .attr("x", function(d){if(d.dX2) return d.dX2; else return ""; })
	        .attr("y", function(d){if(d.dY2) return d.dY2; else return ""; })
	        .attr("class", function(d){return d.jClass;})
	        .attr("text-anchor", function(d){return d.Left;})
	        .attr("text-rendering", function(d){return d.tr;})
	        .text(function(d){if(d.AIpdat) return oBundleText.getText("LABEL_2073") + " : "+d.AIpdat; else return "" ;});	// 2073:입사일자
		...
		nodeEnter.append("text")
	        ...
	        .attr("text-rendering", function(d){return d.tr;})
	        .text(function(d){if(d.Objid == "99999999") return ""; 
							 else return oBundleText.getText("LABEL_2089") + " : "+d.Tenure });	// 2089:재임기간
		
		nodeEnter.append("text")
	        .attr("x", function(d){if(d.jaX2) return d.jaX2; else return ""; })
	        .attr("y", function(d){if(d.jaY2) return d.jaY2; else return ""; })
	        .attr("class", function(d){return d.jClass;})
	        .attr("text-rendering", function(d){return d.tr;})
	        .text(function(d){if(d.ATenure) return oBundleText.getText("LABEL_2089") + " : "+d.ATenure; else return "" ;});	// 2089:재임기간
