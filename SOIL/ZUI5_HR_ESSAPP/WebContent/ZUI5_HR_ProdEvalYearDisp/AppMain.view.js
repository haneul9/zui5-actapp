...
sap.ui.jsview("ZUI5_HR_ProdEvalYearDisp.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ProdEvalYearDisp.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ProdEvalYearDisp.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ProdEvalYearDisp.ZUI5_HR_ProdEvalYearDispList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ProdEvalYearDisp.ZUI5_HR_ProdEvalYearDispList", "ZUI5_HR_ProdEvalYearDisp.ZUI5_HR_ProdEvalYearDispList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0897"),	// 897:연도별 평가결과 조회
			showLogout : false,
			app : this.app,
