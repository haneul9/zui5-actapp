...
sap.ui.jsview("ZUI5_HR_WorktimeReportOrg.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorktimeReportOrg.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorktimeReportOrg.ZUI5_HR_WorktimeReportOrgList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorktimeReportOrg.ZUI5_HR_WorktimeReportOrgList", "ZUI5_HR_WorktimeReportOrg.ZUI5_HR_WorktimeReportOrgList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0909"),	// 909:근로시간 조회(부서별/기간지정)
			showLogout : false,
			app : this.app,
