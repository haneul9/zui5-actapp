...
sap.ui.jsview("ZUI5_HR_CommuteRecordGroup.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_CommuteRecordGroup.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_CommuteRecordGroup.ZUI5_HR_CommuteRecordGroupList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_CommuteRecordGroup.ZUI5_HR_CommuteRecordGroupList", "ZUI5_HR_CommuteRecordGroup.ZUI5_HR_CommuteRecordGroupList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0703"),	// 703:근태기록부확인(부서장)
			showLogout : false,
			app : this.app,
