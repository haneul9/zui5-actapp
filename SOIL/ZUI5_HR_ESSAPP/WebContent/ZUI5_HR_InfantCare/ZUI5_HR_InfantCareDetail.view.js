...
sap.ui.jsview("ZUI5_HR_InfantCare.ZUI5_HR_InfantCareDetail", {
	...
	getControllerName : function() {
		return "ZUI5_HR_InfantCare.ZUI5_HR_InfantCareDetail";
	},
	...
	createContent : function(oController) {
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			showHeader : false,
			content : sap.ui.jsfragment("ZUI5_HR_InfantCare.fragment.InfantCarePage02",oController)
