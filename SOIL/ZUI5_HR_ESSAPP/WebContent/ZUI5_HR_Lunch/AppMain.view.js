...
sap.ui.jsview("ZUI5_HR_Lunch.AppMain", {
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Lunch.ZUI5_HR_LunchList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Lunch.ZUI5_HR_LunchList", "ZUI5_HR_Lunch.ZUI5_HR_LunchList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1383"),	// 1383:중식비 예외자 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_LUNCH_FEE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_LUNCH_FEE_SRV"); 
