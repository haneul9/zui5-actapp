...
sap.ui.jsview("ZUI5_HR_DeductionItem.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_DeductionItem.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeductionItem.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeductionItem.ZUI5_HR_DeductionItemList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeductionItem.ZUI5_HR_DeductionItemList", "ZUI5_HR_DeductionItem.ZUI5_HR_DeductionItemList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0457"),	// 457:고정/변동 공제신청 (항목)
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_DEDUCT_OBJ_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_DEDUCT_OBJ_SRV");
