...
sap.ui.jsfragment("ZUI5_HR_DeductionItem.fragment.DeductionItemPage01", {
	...
	_colModel : [
		...
		{id: "Dedgbtx", label : oBundleText.getText("LABEL_0446"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 446:변동/고정
		{id: "Dedtx", label : oBundleText.getText("LABEL_0439"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "200px", align : sap.ui.core.TextAlign.Begin},	// 439:공제명
		{id: "Newyntx", label : oBundleText.getText("LABEL_0448"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "120px"},	// 448:신규/수정
		{id: "Bnkgbtx", label : oBundleText.getText("LABEL_0455"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "120px"},	// 455:입금구분
		{id: "Reqym", label : oBundleText.getText("LABEL_0441"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 441:공제예정월
		{id: "Pdeym", label : oBundleText.getText("LABEL_0443"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 443:급여공제월
		...
		{id: "Attachyn", label : oBundleText.getText("LABEL_0069"), plabel : "", span : 0, type : "ptifile", sort : true, filter : true, width : "80px"},	// 69:첨부
	...
	getFilterLayoutRender : function(oController) {
		...
		return new sap.m.Toolbar({
			...
			content : [
				...
				new sap.m.ToolbarSpacer({width : "20px"}),
				new sap.m.Text({
					text : oBundleText.getText("LABEL_0447") 	// 447:변동/고정 공제
				}).addStyleClass("Font14px FontBold"),
				new sap.m.ToolbarSpacer({width : "10px"}),
				new sap.m.ComboBox(oController.PAGEID + "_Dedgb", {
					width : "150px",
					selectedKey : "{Dedgb}",
					editable : true
				}).addStyleClass("Font14px FontColor6"),
