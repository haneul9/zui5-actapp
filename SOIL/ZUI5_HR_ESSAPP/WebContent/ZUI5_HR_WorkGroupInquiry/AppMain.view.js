...
sap.ui.jsview("ZUI5_HR_WorkGroupInquiry.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_WorkGroupInquiry.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorkGroupInquiry.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorkGroupInquiry.ZUI5_HR_WorkGroupInquiryList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorkGroupInquiry.ZUI5_HR_WorkGroupInquiryList", "ZUI5_HR_WorkGroupInquiry.ZUI5_HR_WorkGroupInquiryList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0667"),	// 667:부서별근무편제표조회
			showLogout : false,
			app : this.app,
