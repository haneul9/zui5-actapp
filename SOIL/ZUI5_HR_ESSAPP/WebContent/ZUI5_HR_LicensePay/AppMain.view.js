...
sap.ui.jsview("ZUI5_HR_LicensePay.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_LicensePay.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_LicensePay.ZUI5_HR_LicensePayList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_LicensePay.ZUI5_HR_LicensePayList", "ZUI5_HR_LicensePay.ZUI5_HR_LicensePayList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1337"),	// 1337:자격면허수당 신청
			showLogout : false,
			app : this.app,
