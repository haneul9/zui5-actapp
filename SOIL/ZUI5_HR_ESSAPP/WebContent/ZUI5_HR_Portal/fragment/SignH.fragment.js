sap.ui.jsfragment("ZUI5_HR_Portal.fragment.SignH", {
	...
	createContent : function(oController) {
		...
		var oMatrixLayout = new sap.ui.commons.layout.MatrixLayout({
			...
			columns : 2,
			width : "100%"
		}).setModel(oController._SignH).bindElement("/Data");
		...
		var oChart = new sap.ui.commons.layout.VerticalLayout({
			content : new sap.ui.core.HTML({preferDOM : false, content : "<canvas id='chart-areaH'  width='120' height='120' style='padding-right:2px' />"})
		});
