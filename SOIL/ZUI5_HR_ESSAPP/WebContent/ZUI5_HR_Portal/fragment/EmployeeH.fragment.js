sap.ui.jsfragment("ZUI5_HR_Portal.fragment.EmployeeH", {
...
//			height : "90px",
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			content : [ new sap.m.Toolbar({ 
							content : [
								...
								new sap.m.Button(oController.PAGEID +"_DownorgchartK3",{
									text : "조직도 국문",
									width : "96px",
									type : sap.m.ButtonType.Emphasized,
								}).addDelegate({
									onAfterRendering: function(evt) {
										$("#ZUI5_HR_PortalList_DownorgchartK3-inner")
								...
								new sap.m.Button(oController.PAGEID +"_DownorgchartE3",{
									text : "조직도 영문",
									width : "96px",
									type : sap.m.ButtonType.Emphasized,
									press : function(){
									...
									onAfterRendering: function(evt) {
										$("#ZUI5_HR_PortalList_DownorgchartE3-inner")
										.removeClass("sapMBtnEmphasized")
										.addClass("TileButton");
									}
								}).attachBrowserEvent("click", function(e){
		...
		var oMainMatrixLayout = new sap.ui.commons.layout.MatrixLayout({
			...
			oController.goToPage(oController,"Emp_H","");
