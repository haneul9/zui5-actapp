...
sap.ui.controller("ZUI5_HR_WorktimeReduction.ZUI5_HR_WorktimeReductionList", {
	/**
	...
	PAGEID : "ZUI5_HR_WorktimeReductionList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data") || oController._ListCondJSonModel.getProperty("/Data").length < 1) {			
			...
			var JSonData = { Data : { Apbeg : dateFormat.format(prevDate) , Apend : dateFormat.format(curDate), Begda : "", Endda : "", Encid : vEncid, Ename : vEname, Wktrd : "" }};
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_WorktimeReduction.ZUI5_HR_WorktimeReductionList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_WorktimeReduction.ZUI5_HR_WorktimeReductionDetail",
			data : { Appno : _Appno }
		});
	},
	...
	onPressSearch : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_WorktimeReduction.ZUI5_HR_WorktimeReductionList"),
			oController = oView.getController(),
			oModel = sap.ui.getCore().getModel("ZHR_WORKTIME_REDUCE_SRV"),
			oTable = sap.ui.getCore().byId(oController.PAGEID + "_Table"),
		...
		if(SerchCond.Wktrd != "") {
			aFilters.push(new sap.ui.model.Filter('Wktrd', sap.ui.model.FilterOperator.EQ, SerchCond.Wktrd));
		}
...
//			}
	...
	onExport : function(oEvent) {
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_2989") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2989:근로시간 단축 신청
			};
