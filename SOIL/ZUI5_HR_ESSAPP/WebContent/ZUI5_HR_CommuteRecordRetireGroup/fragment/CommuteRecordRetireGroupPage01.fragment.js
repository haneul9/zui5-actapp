...
sap.ui.jsfragment("ZUI5_HR_CommuteRecordRetireGroup.fragment.CommuteRecordRetireGroupPage01", {
	
	_colModel : [
		{id: "Idx", label : "No.", plabel : "No.", resize : false, span : 0, type : "string", sort : true, filter : true, width : "4%"},
		{id: "Perid", label : oBundleText.getText("LABEL_0031"), plabel : oBundleText.getText("LABEL_0031"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "8%"},	// 31:사번
		...
		{id: "Begda", label : oBundleText.getText("LABEL_0700"), plabel : oBundleText.getText("LABEL_0042"), resize : false, span : 2, type : "date", sort : true, filter : true, width : "8%"},	// 42:시작일, 700:근무기간
		{id: "Endda", label : "", plabel : oBundleText.getText("LABEL_0065"), resize : false, span : 0, type : "date", sort : true, filter : true, width : "8%"},	// 65:종료일
		{id: "Step1", label : oBundleText.getText("LABEL_0705"), plabel : oBundleText.getText("LABEL_0705"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "7%"},	// 705:확인단계
		{id: "Step2", label : oBundleText.getText("LABEL_0709"), plabel : oBundleText.getText("LABEL_0709"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "7%"},	// 709:확인차수
		{id: "Tschd", label : oBundleText.getText("LABEL_0634"), plabel : oBundleText.getText("LABEL_0634"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "7%", align : sap.ui.core.TextAlign.End},	// 634:정상근무
		{id: "Tovrt", label : oBundleText.getText("LABEL_0693"), plabel : oBundleText.getText("LABEL_0693"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "7%", align : sap.ui.core.TextAlign.End},	// 693:특근
		{id: "Totex", label : oBundleText.getText("LABEL_0643"), plabel : oBundleText.getText("LABEL_0643"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "7%", align : sap.ui.core.TextAlign.End},	// 643:특근연장
		{id: "Tnght", label : oBundleText.getText("LABEL_0691"), plabel : oBundleText.getText("LABEL_0691"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "7%", align : sap.ui.core.TextAlign.End},	// 691:심야
		{id: "Tofix", label : oBundleText.getText("LABEL_0699"), plabel : oBundleText.getText("LABEL_0699"), resize : false, span : 0, type : "string", sort : true, filter : true, width : "7%", align : sap.ui.core.TextAlign.End},	// 699:고정특근
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_0916")	// 916:퇴직자근태기록부확인(부서장)
		...
		oTable.addEventDelegate({
			onAfterRendering: function() {
				...
				common.Common.generateRowspan({
					selector : '#ZUI5_HR_CommuteRecordRetireGroupList_Table-header > tbody',
