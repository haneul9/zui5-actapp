...
sap.ui.jsview("ZUI5_HR_ActionRequest.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ActionRequest.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ActionRequest.ZUI5_HR_ActionRequestList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ActionRequest.ZUI5_HR_ActionRequestList", "ZUI5_HR_ActionRequest.ZUI5_HR_ActionRequestList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1036"),	// 1036:내신서 신청
			showLogout : false,
			app : this.app,
