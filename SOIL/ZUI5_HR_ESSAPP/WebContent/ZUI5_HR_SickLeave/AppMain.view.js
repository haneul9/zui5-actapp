...
sap.ui.jsview("ZUI5_HR_SickLeave.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_SickLeave.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_SickLeave.ZUI5_HR_SickLeaveList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_SickLeave.ZUI5_HR_SickLeaveList", "ZUI5_HR_SickLeave.ZUI5_HR_SickLeaveList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1751"),	// 1751:병가 신청
			showLogout : false,
			app : this.app,
