...
sap.ui.controller("ZUI5_HR_SickLeave.ZUI5_HR_SickLeaveList", {
	/**
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data")){
			...
			var JSonData = {Data : {Apbeg : dateFormat.format(prevDate), Apend : dateFormat.format(curDate), 
				                    Zpernr : vPernr, Ename : vEname, Encid : vEncid, Auth : _gAuth}};
	...
	onPressRegCheck : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_SickLeave.ZUI5_HR_SickLeaveList");
	...
	onPressNew : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_SickLeave.ZUI5_HR_SickLeaveDetail",
		      data : {Appno : ""}
		});	
	},
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1751") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1751:병가 신청
			};
