sap.ui.jsfragment("ZUI5_HR_OvertimeOrder.fragment.WorktimeDialog", {
		...
		oTable.addEventDelegate({
			onAfterRendering: function() {
				...
				common.Common.generateRowspan({
					selector : '#ZUI5_HR_OvertimeOrderDetail_Worktime_Table-header > tbody',
...
//			contentHeight : "520px",
			showHeader : true,
			title : oBundleText.getText("LABEL_0619"),	// 619:개인별 근로시간 조회
