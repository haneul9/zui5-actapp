...
sap.ui.jsfragment("ZUI5_HR_OvertimeOrder.fragment.OvertimeOrderPage01", {
	...
	_colModel : [
		...
		{id: "Apperid", label : oBundleText.getText("LABEL_0031"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 31:사번
		...
		{id: "Datum", label : oBundleText.getText("LABEL_0644"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "13%"},	// 644:특근일
		{id: "Inwon", label : oBundleText.getText("LABEL_0628"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "11%"},	// 628:대상인원수
		{id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "13%"},	// 49:신청일
		{id: "ZappDate", label : oBundleText.getText("LABEL_0070"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "13%"}	// 70:최종결재일
	],
