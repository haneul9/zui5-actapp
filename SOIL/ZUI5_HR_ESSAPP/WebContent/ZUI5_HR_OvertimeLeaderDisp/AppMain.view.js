...
sap.ui.jsview("ZUI5_HR_OvertimeLeaderDisp.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OvertimeLeaderDisp.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OvertimeLeaderDisp.ZUI5_HR_OvertimeLeaderDispList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OvertimeLeaderDisp.ZUI5_HR_OvertimeLeaderDispList", "ZUI5_HR_OvertimeLeaderDisp.ZUI5_HR_OvertimeLeaderDispList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0871"),	// 871:특근내역조회
			showLogout : false,
			app : this.app,
