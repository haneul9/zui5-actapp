sap.ui.jsfragment("ZUI5_HR_OvertimeConfirmMulti.fragment.OvertimeConfirmMultiPage02", {
...
//			columnHeaderHeight : 35,
		...
		oTable.getColumns()[19].setTemplate(new sap.m.Input({
			value : "{Tmrsn}",
			maxLength : common.Common.getODataPropertyLength("ZHR_SPECIAL_WORK_SRV", "CfmSpecialWorkDetail", "Tmrsn"),
			editable : {
				parts : [{path : "ZappStatAl"}],
				formatter : function(fVal1) {
					return (fVal1 == "" || fVal1 == "10") ? true : false;
