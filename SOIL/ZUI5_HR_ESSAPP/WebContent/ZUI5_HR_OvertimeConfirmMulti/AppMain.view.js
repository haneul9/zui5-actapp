...
sap.ui.jsview("ZUI5_HR_OvertimeConfirmMulti.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_OvertimeConfirmMulti.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OvertimeConfirmMulti.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OvertimeConfirmMulti.ZUI5_HR_OvertimeConfirmMultiList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OvertimeConfirmMulti.ZUI5_HR_OvertimeConfirmMultiList", "ZUI5_HR_OvertimeConfirmMulti.ZUI5_HR_OvertimeConfirmMultiList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0719"),	// 719:특근확인서
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_SPECIAL_WORK_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_SPECIAL_WORK_SRV"); 
