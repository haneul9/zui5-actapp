...
sap.ui.jsview("ZUI5_HR_Resort.AppMain", {
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Resort.ZUI5_HR_ResortList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Resort.ZUI5_HR_ResortList", "ZUI5_HR_Resort.ZUI5_HR_ResortList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2380"),	// 2380:휴양소 신청/당첨내역 조회
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_RNRCENTER_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_RNRCENTER_SRV"); 
