...
sap.ui.jsview("ZUI5_HR_TaxDataInquiry.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZUI5_HR_TaxDataInquiry.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_TaxDataInquiry.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_TaxDataInquiry.ZUI5_HR_TaxDataInquiryList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_TaxDataInquiry.ZUI5_HR_TaxDataInquiryList", "ZUI5_HR_TaxDataInquiry.ZUI5_HR_TaxDataInquiryList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1913"),	// 1913:실근무지 인원조회
			showLogout : false,
			app : this.app,
