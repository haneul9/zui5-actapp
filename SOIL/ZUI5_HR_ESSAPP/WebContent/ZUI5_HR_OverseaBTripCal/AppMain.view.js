...
sap.ui.jsview("ZUI5_HR_OverseaBTripCal.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OverseaBTripCal.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OverseaBTripCal.ZUI5_HR_OverseaBTripCalList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OverseaBTripCal.ZUI5_HR_OverseaBTripCalList", "ZUI5_HR_OverseaBTripCal.ZUI5_HR_OverseaBTripCalList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1279"),	// 1279:해외출장비 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_BUSITRIP_PAY_INT_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_BUSITRIP_PAY_INT_SRV"); 
