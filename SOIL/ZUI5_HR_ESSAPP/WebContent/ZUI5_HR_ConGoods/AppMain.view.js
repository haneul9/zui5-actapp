...
sap.ui.jsview("ZUI5_HR_ConGoods.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ConGoods.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ConGoods.ZUI5_HR_ConGoodsList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ConGoods.ZUI5_HR_ConGoodsList", "ZUI5_HR_ConGoods.ZUI5_HR_ConGoodsList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1351"),	// 1351:경조화환 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL3 = this.getUrl("/sap/opu/odata/sap/ZHR_CON_GOODS_SRV/");
		...
		sap.ui.getCore().setModel(oModel3, "ZHR_CON_GOODS_SRV"); 
