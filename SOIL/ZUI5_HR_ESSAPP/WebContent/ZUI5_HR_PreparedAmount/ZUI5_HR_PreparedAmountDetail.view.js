...
sap.ui.jsview("ZUI5_HR_PreparedAmount.ZUI5_HR_PreparedAmountDetail", {
	...
	getControllerName : function() {
		return "ZUI5_HR_PreparedAmount.ZUI5_HR_PreparedAmountDetail";
	},
	...
	createContent : function(oController) {
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			showHeader : false,
			content : sap.ui.jsfragment("ZUI5_HR_PreparedAmount.fragment.PreparedAmountPage02",oController)
