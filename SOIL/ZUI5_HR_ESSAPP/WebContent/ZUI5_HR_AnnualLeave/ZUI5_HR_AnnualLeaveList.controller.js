...
sap.ui.controller("ZUI5_HR_AnnualLeave.ZUI5_HR_AnnualLeaveList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_AnnualLeave.ZUI5_HR_AnnualLeaveList
	 */

	PAGEID : "ZUI5_HR_AnnualLeaveList",
	...
	onPressNew : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_AnnualLeave.ZUI5_HR_AnnualLeaveList");
		var oController = oView.getController();
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_AnnualLeave.ZUI5_HR_AnnualLeaveDetail",
		      data : {Appno : ""}
		});	
	},
...
//		}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1051") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1051:연간휴가 신청
			};
