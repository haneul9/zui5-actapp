...
sap.ui.jsview("ZUI5_HR_ProductionEvaluationAdjust.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ProductionEvaluationAdjust.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ProductionEvaluationAdjust.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ProductionEvaluationAdjust.ZUI5_HR_ProductionEvaluationAdjustList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ProductionEvaluationAdjust.ZUI5_HR_ProductionEvaluationAdjustList", "ZUI5_HR_ProductionEvaluationAdjust.ZUI5_HR_ProductionEvaluationAdjustList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0835"),	// 835:생산직 평가조정
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_APPRAISAL_ADJ_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_APPRAISAL_ADJ_SRV");
