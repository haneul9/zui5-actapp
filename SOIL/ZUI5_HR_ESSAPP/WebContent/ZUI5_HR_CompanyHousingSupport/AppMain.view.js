...
sap.ui.jsview("ZUI5_HR_CompanyHousingSupport.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_CompanyHousingSupport.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_CompanyHousingSupport.ZUI5_HR_CompanyHousingSupportList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_CompanyHousingSupport.ZUI5_HR_CompanyHousingSupportList", "ZUI5_HR_CompanyHousingSupport.ZUI5_HR_CompanyHousingSupportList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0320"),	// 320:사택지원 신청
			showLogout : false,
			app : this.app,
