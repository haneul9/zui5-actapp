...
sap.ui.jsview("ZUI5_HR_CompanyHousingSupport.ZUI5_HR_CompanyHousingSupportList", {
	...
	getControllerName : function() {
		return "ZUI5_HR_CompanyHousingSupport.ZUI5_HR_CompanyHousingSupportList";
	},
	...
	createContent : function(oController) {
		...
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			showHeader : false,
			content : sap.ui.jsfragment("ZUI5_HR_CompanyHousingSupport.fragment.CompanyHousingSupportPage01",oController)
