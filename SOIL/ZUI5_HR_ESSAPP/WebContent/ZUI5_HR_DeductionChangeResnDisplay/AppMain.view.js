...
sap.ui.jsview("ZUI5_HR_DeductionChangeResnDisplay.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeductionChangeResnDisplay.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeductionChangeResnDisplay.ZUI5_HR_DeductionChangeResnDisplayList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeductionChangeResnDisplay.ZUI5_HR_DeductionChangeResnDisplayList", "ZUI5_HR_DeductionChangeResnDisplay.ZUI5_HR_DeductionChangeResnDisplayList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0560"),	// 560:변동공제 조회(사유발생자)
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_DEDUCT_CHG_DISP_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_DEDUCT_CHG_DISP_SRV");
