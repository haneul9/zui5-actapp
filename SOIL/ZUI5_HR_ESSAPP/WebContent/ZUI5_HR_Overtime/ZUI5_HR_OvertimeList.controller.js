...
sap.ui.controller("ZUI5_HR_Overtime.ZUI5_HR_OvertimeList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_Overtime.ZUI5_HR_OvertimeList
	 */

	PAGEID : "ZUI5_HR_OvertimeList",
...
//		if(vData != undefined) oController.onGetCountDown(oController ,vData.Pernr );
	...
	onPressNew : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_Overtime.ZUI5_HR_OvertimeList");
		var oController = oView.getController();
		
//		var myPages = sap.ui.getCore().byId("ZNK_PORTAL" + "_notUnifiedSpllit");
//		var nextPage = "ZUI5_HR_Overtime.ZUI5_HR_OvertimeDetail";
//		var vExist = "";
...
//		
//		if(vExist == ""){
//			myPages.addDetailPage(sap.ui.jsview("ZUI5_HR_Overtime.ZUI5_HR_OvertimeDetail", "ZUI5_HR_Overtime.ZUI5_HR_OvertimeDetail"));
//		}
//		
//		myPages.toDetail("ZUI5_HR_Overtime.ZUI5_HR_OvertimeDetail",{Appno : ""});
		
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_Overtime.ZUI5_HR_OvertimeDetail",
		      data : {Appno : ""}
			});	
...
//		}
		...
		function Search(){
			var oPath = "/OvertimeApplContentSet";
			var filterString = "";
...
//	        var setDate = new Date(arrDate[0],arrDate[1]-1,arrDate[2], arrTime[0],arrTime[1],arrTime[2], 0);
	...
	onEmpListPopover : function(oEvent){
		...
		if(!oController._EmpListPopover) {
			oController._EmpListPopover = sap.ui.jsfragment("ZUI5_HR_Overtime.fragment.DisplayEmpList", oController);
	...
	beforeOpenPopover : function(oEvent){
		...
		var oModel = sap.ui.getCore().getModel("ZHR_OVERTIME_SRV");
		var oPath = "/OvertimeApplEmpListSet?$filter=Appno eq '" + oController._vAppno + "' and Prcty eq 'R'";
