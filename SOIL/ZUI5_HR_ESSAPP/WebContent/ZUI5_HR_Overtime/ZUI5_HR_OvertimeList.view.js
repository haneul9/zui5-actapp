...
sap.ui.jsview("ZUI5_HR_Overtime.ZUI5_HR_OvertimeList", {
	...
	getControllerName : function() {
		return "ZUI5_HR_Overtime.ZUI5_HR_OvertimeList";
	},
	...
	createContent : function(oController) {
		...
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			content : sap.ui.jsfragment("ZUI5_HR_Overtime.fragment.OvertimePage01",oController),
