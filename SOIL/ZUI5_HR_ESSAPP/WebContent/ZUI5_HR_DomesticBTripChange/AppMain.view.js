...
sap.ui.jsview("ZUI5_HR_DomesticBTripChange.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DomesticBTripChange.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DomesticBTripChange.ZUI5_HR_DomesticBTripChangeList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DomesticBTripChange.ZUI5_HR_DomesticBTripChangeList", "ZUI5_HR_DomesticBTripChange.ZUI5_HR_DomesticBTripChangeList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1225"),	// 1225:국내출장명령 변경/취소 신청
			showLogout : false,
			app : this.app,
