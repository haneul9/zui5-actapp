sap.ui.jsfragment("ZUI5_HR_VacationRequest.fragment.VacationRequestPage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : "Begin", width : "120px"},	// 39:소속부서
		{id: "Aptxt", label : oBundleText.getText("LABEL_0763"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 763:휴가
		{id: "Period", label : oBundleText.getText("LABEL_1204"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "15%"},	// 1204:기간
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({text : oBundleText.getText("LABEL_2359") }).addStyleClass("Font18px FontColor0"),	// 2359:휴가 신청
