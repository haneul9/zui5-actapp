...
sap.ui.jsview("ZUI5_HR_EntryRecord.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_EntryRecord.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_EntryRecord.ZUI5_HR_EntryRecordList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_EntryRecord.ZUI5_HR_EntryRecordList", "ZUI5_HR_EntryRecord.ZUI5_HR_EntryRecordList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0575"),	// 575:출퇴근 기록 조회
			showLogout : false,
			app : this.app,
