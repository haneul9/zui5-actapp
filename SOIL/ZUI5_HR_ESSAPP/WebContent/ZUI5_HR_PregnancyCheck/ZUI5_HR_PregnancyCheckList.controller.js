...
sap.ui.controller("ZUI5_HR_PregnancyCheck.ZUI5_HR_PregnancyCheckList", {
	/**
	...
	PAGEID : "ZUI5_HR_PregnancyCheckList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data")){
			...
			var JSonData = {Data : {Apbeg : dateFormat.format(prevDate), Apend : dateFormat.format(curDate), Usedt : '', Encid : vEncid, Ename : vEname, Auth : _gAuth}};
	...
	/*onPressRegCheck : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_PregnancyCheck.ZUI5_HR_PregnancyCheckList");
	...
	onPressNew : function(oEvent) {
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_PregnancyCheck.ZUI5_HR_PregnancyCheckDetail",
		      data : {Appno : ""}
		});	
	},
	...
	onPressSearch : function(oEvent){
		...
		if(SerchCond.Usedt != "") {
			aFilters.push(new sap.ui.model.Filter('Usedt', sap.ui.model.FilterOperator.EQ, common.Common.adjustGMT(sap.ui.getCore().byId(oController.PAGEID + "_Usedt").getDateValue())));
		}
		if(SerchCond.Encid != "") {
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_0164") + "-" + dateFormat.format(curDate) + ".xlsx"	// 164:태아검진 외출 신청
			};
