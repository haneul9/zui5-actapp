...
sap.ui.jsview("ZUI5_HR_PregnancyCheck.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_PregnancyCheck.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_PregnancyCheck.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_PregnancyCheck.ZUI5_HR_PregnancyCheckList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_PregnancyCheck.ZUI5_HR_PregnancyCheckList", "ZUI5_HR_PregnancyCheck.ZUI5_HR_PregnancyCheckList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0164"),	// 164:태아검진 외출 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_PREGNANT_DIAG_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_PREGNANT_DIAG_SRV"); 
