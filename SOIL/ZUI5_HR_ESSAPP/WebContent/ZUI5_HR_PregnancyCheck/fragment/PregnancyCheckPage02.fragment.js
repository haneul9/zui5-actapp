sap.ui.jsfragment("ZUI5_HR_PregnancyCheck.fragment.PregnancyCheckPage02", {
	
	_colModel : [
		{id: "Montx", label : oBundleText.getText("LABEL_0160"), plabel : "", span : 0, type : "string", sort : true, filter : true, width : "14%"},	// 160:임신개월수
		{id: "Days", label : oBundleText.getText("LABEL_0159"), plabel : "", span : 0, type : "string", sort : true, filter : true, width : "14%"},	// 159:일수
		{id: "Begda", label : oBundleText.getText("LABEL_0042"), plabel : "", span : 0, type : "string", sort : true, filter : true, width : "16%"},	// 42:시작일
		{id: "Endda", label : oBundleText.getText("LABEL_0065"), plabel : "", span : 0, type : "string", sort : true, filter : true, width : "16%"},	// 65:종료일
		{id: "Usedt", label : oBundleText.getText("LABEL_0156"), plabel : "", span : 0, type : "string", sort : true, filter : true, width : "16%"},	// 156:사용일자
		{id: "Atext", label : oBundleText.getText("LABEL_0157"), plabel : "", span : 0, type : "string", sort : true, filter : true}	// 157:신청유형
	],
	...
	getPageAllContentRender : function(oController) {
		...
		var oContents = [
			...
			this.getTableRender(oController),										// 테이블
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text(oController.PAGEID + "_DetailTitle", {text : oBundleText.getText("LABEL_0164") }).addStyleClass("Font18px FontColor0"),	// 164:태아검진 외출 신청
						...
						content : 
							new sap.m.Toolbar({
								content : [
									...
									new sap.m.Button({
										text : oBundleText.getText("LABEL_0163"),	// 163:첨부파일 저장
										press : oController.onPressFileUpload,
										visible : {
											path : "ZappStatAl",
		...
		var aRows = [
				...
				cells : [
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							text : oBundleText.getText("LABEL_0149")	// 149:출산예정일
			...
			new sap.ui.commons.layout.MatrixLayoutRow({
				...
				cells : [
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							text : oBundleText.getText("LABEL_0154"),	// 154:사용일
							required : true
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [
								new sap.m.DatePicker(oController.PAGEID + "_Usedt", {
									...
									value : "{Usedt}",
									width : "150px",
									change : oController.onUsedtChange,
									editable : {
			...
			new sap.ui.commons.layout.MatrixLayoutRow({
				...
				cells : [
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							text : oBundleText.getText("LABEL_0161")	// 161:임신기간
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_0152")	// 152:개월
								}).addStyleClass("Font14px FontColor3")
							]
						}).addStyleClass("ToolbarNoBottomLine")
					}).addStyleClass("MatrixData"),
						...
						content : new sap.m.Toolbar({
							content : [
								new sap.m.Input({
									width : "95%",
									value : "{Zbigo}",
									maxLength : common.Common.getODataPropertyLength("ZHR_PREGNANT_DIAG_SRV", "PregnantDiagRequestAppl", "Zbigo"),
									editable : {
										parts : [{path : "ZappStatAl"}, {path : "Pernr"}],
										formatter : function(fVal1, fVal2) {
											return ((fVal1 == "" || fVal1 == "10") && fVal2) ? true : false;
	 ...
	 */
	getTableRender : function(oController) {
...
//			rowHeight  : 30,
			...
			extension : new sap.m.Toolbar({
				content : [
					new sap.m.Image({src : "/sap/bc/ui5_ui5/sap/zui5_hr_common/images/Title_icon_B.png"}),
					new sap.m.Text({text : oBundleText.getText("LABEL_0153")}).addStyleClass("MiddleTitle")	// 153:사용실적
				]
			}).addStyleClass("ToolbarNoBottomLine")
		})
