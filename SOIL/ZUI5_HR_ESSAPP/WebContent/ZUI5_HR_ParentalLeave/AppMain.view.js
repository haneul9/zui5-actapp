...
sap.ui.jsview("ZUI5_HR_ParentalLeave.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ParentalLeave.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ParentalLeave.ZUI5_HR_ParentalLeaveList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ParentalLeave.ZUI5_HR_ParentalLeaveList", "ZUI5_HR_ParentalLeave.ZUI5_HR_ParentalLeaveList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2008"),	// 2008:육아 휴직 신청
			showLogout : false,
			app : this.app,
