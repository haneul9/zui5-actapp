...
sap.ui.jsview("ZUI5_HR_Resignation.ZUI5_HR_ResignationDetail", {
	...
	getControllerName : function() {
		return "ZUI5_HR_Resignation.ZUI5_HR_ResignationDetail";
	},
	...
	createContent : function(oController) {
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			showHeader : false,
			content : sap.ui.jsfragment("ZUI5_HR_Resignation.fragment.ResignationPage02",oController)
