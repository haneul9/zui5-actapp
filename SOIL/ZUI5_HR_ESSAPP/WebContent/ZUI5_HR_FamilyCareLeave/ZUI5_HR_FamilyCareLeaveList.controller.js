...
sap.ui.controller("ZUI5_HR_FamilyCareLeave.ZUI5_HR_FamilyCareLeaveList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_FamilyCareLeave.ZUI5_HR_FamilyCareLeaveList
	 */

	PAGEID : "ZUI5_HR_FamilyCareLeaveList",
	...
	onPressNew : function(oEvent){
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_FamilyCareLeave.ZUI5_HR_FamilyCareLeaveDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_FamilyCareLeave.ZUI5_HR_FamilyCareLeaveList");
	...
	onPressSearch : function(oEvent){
		...
		function Search() {
			...
			oModel.read("/FamilyCareLeaveListSet", {
				async : false,
				filters : aFilters,
				success : function(data,res){
					if(data && data.results.length){
						for(var i=0;i<data.results.length;i++){
							...
							OneData.Idx = i + 1;
							OneData.Useday = (OneData.Useday * 1).toFixed(0);
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_2970") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2970:가족돌봄휴직 신청
			};
