sap.ui.jsfragment("ZUI5_HR_FamilyCareLeave.fragment.FamilyCareLeavePage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : "Begin", width : "14%"},	// 39:소속부서
		{id: "ZreqForx", label : oBundleText.getText("LABEL_0157"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 157:신청유형
		...
		{id: "ZappDate", label : oBundleText.getText("LABEL_0070"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "8%"},	// 70:최종결재일
		{id: "Docyn", label : oBundleText.getText("LABEL_0069"), plabel : "", span : 0, type : "ptifile", sort : true, filter : true, width : "4%"},	// 69:첨부
		{id: "Zbigo", label : oBundleText.getText("LABEL_0096"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "14%", align : "Begin"}	// 96:비고
	],
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_2970")	// 2970:가족돌봄휴직 신청
