...
sap.ui.controller("ZUI5_HR_VacationRequestEN.ZUI5_HR_VacationRequestList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_VacationRequestEN.ZUI5_HR_VacationRequestList
	 */

	PAGEID : "ZUI5_HR_VacationRequestList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data")){
			...
			var JSonData = {Data : {Apbeg : dateFormat.format(prevDate), Apend : dateFormat.format(curDate), 
				Zpernr : vPernr, Ename : vEname, Auth : _gAuth, Encid : vEncid }};
	...
	onPressNew : function(oEvent){
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_VacationRequestEN.ZUI5_HR_VacationRequestDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_VacationRequestEN.ZUI5_HR_VacationRequestList");
...
//			aFilters.push(new sap.ui.model.Filter('Zpernr', sap.ui.model.FilterOperator.EQ, SerchCond.Pernr));
//		}
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_2359") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2359:휴가 신청
			};
