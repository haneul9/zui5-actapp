...
sap.ui.jsview("ZUI5_HR_VacationRequestEN.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_VacationRequestEN.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_VacationRequestEN.ZUI5_HR_VacationRequestList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_VacationRequestEN.ZUI5_HR_VacationRequestList", "ZUI5_HR_VacationRequestEN.ZUI5_HR_VacationRequestList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2358"),	// 2358:휴가 변경/취소 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL3 = this.getUrl("/sap/opu/odata/sap/ZHR_WORKSCHDULE_SRV/");
		...
		sap.ui.getCore().setModel(oModel3, "ZHR_WORKSCHDULE_SRV"); 
		...
		var vLoginData = common.Common.getEmpLoginInfo(_gAuth, _gZworktyp, "EN");
