sap.ui.jsfragment("ZUI5_HR_VacationRequestEN.fragment.VacationRequestPage01", {
	...
	_colModel : [
		...
		{id: "Aptxt", label : oBundleText.getText("LABEL_0763"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 763:휴가
		{id: "Period", label : oBundleText.getText("LABEL_1204"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "13%"},	// 1204:기간
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({text : oBundleText.getText("LABEL_2361") }).addStyleClass("Font18px FontColor0"),	// 2361:휴가신청EN
