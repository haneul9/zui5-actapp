...
sap.ui.jsview("ZUI5_HR_YearVacationDisp.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_YearVacationDisp.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_YearVacationDisp.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_YearVacationDisp.ZUI5_HR_YearVacationDispList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_YearVacationDisp.ZUI5_HR_YearVacationDispList", "ZUI5_HR_YearVacationDisp.ZUI5_HR_YearVacationDispList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0920"),	// 920:휴가사용조회
			showLogout : false,
			app : this.app,
