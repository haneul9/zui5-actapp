sap.ui.jsfragment("ZUI5_HR_Manpower2.fragment.Detail11", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var col_info1 = [
			{id: "Grouptx", label : "Year", plabel : "Year", resize : false, span : 0, type : "string2", sort : false, filter : false, width : "18%"},
