sap.ui.jsfragment("ZUI5_HR_Manpower2.fragment.Detail12", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var oTable = new sap.ui.table.Table(oController.PAGEID + "_Table12", {
		...
		var col_info1 = [
			{id: "Grouptx", label : "Quarter", plabel : "Quarter", resize : false, span : 0, type : "string2", sort : false, filter : false, width : "18%"},
		...
		oTable.addEventDelegate({
			  onAfterRendering: function() {
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table12-header > tbody',
						colIndexes : [0, 1, 2]
					});
				   
				// 상단 Header 의 우측 border 없에기
				   var vColumnId = "";
				   $target = $('#ZUI5_HR_ManpowerList_Table12-header > tbody');
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table12-table > tbody',
						colIndexes : [0]
					});
				   
				   $target = $('#ZUI5_HR_ManpowerList_Table12-table > tbody');
				   $target.each(function() {
