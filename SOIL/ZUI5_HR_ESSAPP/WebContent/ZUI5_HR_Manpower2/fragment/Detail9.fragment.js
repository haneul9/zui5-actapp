sap.ui.jsfragment("ZUI5_HR_Manpower2.fragment.Detail9", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var oTable = new sap.ui.table.Table(oController.PAGEID + "_Table9", {
		...
		var col_info1 = [
			{id: "Grouptx", label : oBundleText.getText("LABEL_0300"), plabel : oBundleText.getText("LABEL_0300"), resize : false, span : 0, type : "string2", sort : false, filter : false, width : "17%"},	// 300:구분
			 {id: "Subgrtx", label : oBundleText.getText("LABEL_0067"), plabel : oBundleText.getText("LABEL_0067"), resize : false, span : 0, type : "string", sort : false, filter : false, width : "20%"},	// 67:직위
			 ...
			 {id: "Zatyr1", label : oBundleText.getText("LABEL_0700"), plabel : oBundleText.getText("LABEL_2702"), resize : false, span : 2, type : "string", sort : false, filter : false, width : "7%"},	// 700:근무기간, 2702:1년이상
			 {id: "Zatyr2", label : "", plabel : oBundleText.getText("LABEL_2703"), resize : false, span : 0, type : "string", sort : false, filter : false, width : "7%"}	// 2703:1년미만
						 ];
		...
		oTable.addEventDelegate({
			  onAfterRendering: function() {
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table9-header > tbody',
						colIndexes : [0, 1, 2]
					});
				   
				// 상단 Header 의 우측 border 없에기
				   var vColumnId = "";
				   $target = $('#ZUI5_HR_ManpowerList_Table9-header > tbody');
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table9-table > tbody',
						colIndexes : [0]
					});
				   
				   
				   $target = $('#ZUI5_HR_ManpowerList_Table9-table > tbody');
