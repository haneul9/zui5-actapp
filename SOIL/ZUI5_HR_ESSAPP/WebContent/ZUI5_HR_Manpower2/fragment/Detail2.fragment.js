sap.ui.jsfragment("ZUI5_HR_Manpower2.fragment.Detail2", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var col_info1 = [
			{id: "Grouptx", label : oBundleText.getText("LABEL_1030"), plabel : oBundleText.getText("LABEL_1030"), resize : false, span : 0, type : "string2", sort : false, filter : false, width : "11%"},	// 1030:직군
			 {id: "Subgrtx", label : oBundleText.getText("LABEL_2187"), plabel : oBundleText.getText("LABEL_2187"), resize : false, span : 0, type : "string", sort : false, filter : false, width : "11%"},	// 2187:직위/직급
		...
		oTable.addEventDelegate({
			  onAfterRendering: function() {
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table2-header > tbody',
						colIndexes : [0, 1, 2]
					});
					
				   // 상단 Header 의 우측 border 없에기
				   var vColumnId = "";
				   $target = $('#ZUI5_HR_ManpowerList_Table2-header > tbody');
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table2-table > tbody',
						colIndexes : [0]
					});
				   
				    $target = $('#ZUI5_HR_ManpowerList_Table2-table > tbody');
