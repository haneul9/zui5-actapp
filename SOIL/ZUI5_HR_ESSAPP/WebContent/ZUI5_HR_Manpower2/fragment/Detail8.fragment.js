sap.ui.jsfragment("ZUI5_HR_Manpower2.fragment.Detail8", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var oTable = new sap.ui.table.Table(oController.PAGEID + "_Table8", {
		...
		var col_info1 = [
			{id: "Grouptx", label : "Month", plabel : "Month", resize : false, span : 0, type : "string2", sort : false, filter : false, width : "16%"},
		...
		oTable.addEventDelegate({
			  onAfterRendering: function() {
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table8-header > tbody',
						colIndexes : [0, 1, 2]
					});
				   
				// 상단 Header 의 우측 border 없에기
				   var vColumnId = "";
				   $target = $('#ZUI5_HR_ManpowerList_Table8-header > tbody');
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table8-table > tbody',
						colIndexes : [0]
					});
				   
				   $target = $('#ZUI5_HR_ManpowerList_Table8-table > tbody');
				   $target.each(function() {
