...
sap.ui.jsview("ZUI5_HR_Manpower2.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Manpower2.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Manpower2.ZUI5_HR_ManpowerList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Manpower2.ZUI5_HR_ManpowerList", "ZUI5_HR_Manpower2.ZUI5_HR_ManpowerList"));
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_MANPOWER_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_MANPOWER_SRV"); 
