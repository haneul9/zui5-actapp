...
sap.ui.controller("ZUI5_HR_DomesticBTripCal.ZUI5_HR_DomesticBTripCalList", {
	/**
	...
	PAGEID : "ZUI5_HR_DomesticBTripCalList",
	...
	onPressNew : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_DomesticBTripCal.ZUI5_HR_DomesticBTripCalList");
	...
	onPressCreate : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_DomesticBTripCal.ZUI5_HR_DomesticBTripCalDetail",
		      data : {Appno : ""}
		});	
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1242") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1242:국내출장비 신청
			};
