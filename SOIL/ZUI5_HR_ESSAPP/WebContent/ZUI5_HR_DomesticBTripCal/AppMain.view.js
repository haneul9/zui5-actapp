...
sap.ui.jsview("ZUI5_HR_DomesticBTripCal.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_CompanyHousingSupport.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DomesticBTripCal.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DomesticBTripCal.ZUI5_HR_DomesticBTripCalList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DomesticBTripCal.ZUI5_HR_DomesticBTripCalList", "ZUI5_HR_DomesticBTripCal.ZUI5_HR_DomesticBTripCalList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1242"),	// 1242:국내출장비 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_BUSITRIP_PAY_DOM_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_BUSITRIP_PAY_DOM_SRV"); 
		oModel2.setSizeLimit(1000);
		
		var oServiceURL3 = this.getUrl("/sap/opu/odata/sap/ZHR_BIZ_CARD_SRV/");
		...
		sap.ui.getCore().setModel(oModel3, "ZHR_BIZ_CARD_SRV"); 
