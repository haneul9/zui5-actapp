...
sap.ui.jsview("ZUI5_HR_VacationSickAndBabyChange.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_VacationSickAndBabyChange.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_VacationSickAndBabyChange.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_VacationSickAndBabyChange.ZUI5_HR_VacationSickAndBabyChangeList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_VacationSickAndBabyChange.ZUI5_HR_VacationSickAndBabyChangeList", "ZUI5_HR_VacationSickAndBabyChange.ZUI5_HR_VacationSickAndBabyChangeList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0764"),	// 764:병가/출산휴가/육아휴직 변경/취소 신청서
			showLogout : false,
			app : this.app,
