sap.ui.jsfragment("ZUI5_HR_ChangeShift.fragment.SaveCheck1", {
	
	createContent : function(oController) {
		jQuery.sap.require("common.ZHR_TABLES");
		
		var oErrorTable = new sap.ui.table.Table(oController.PAGEID + "_Check1Table", {
...
//			columnHeaderHeight : 35,
		...
		.setModel(oController._Check1TableJSonModel)
		.bindRows("/Data");
		...
		var oCheck1Dialog = new sap.m.Dialog(oController.PAGEID + "_Check1Dialog", {
			content : [
		...
		oCheck1Dialog.bindElement("/Data");
		oCheck1Dialog.addStyleClass("sapUiSizeCompact");
		
		return oCheck1Dialog;
