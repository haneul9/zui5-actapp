...
sap.ui.controller("ZUI5_HR_ChangeShift.ZUI5_HR_ChangeShiftList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_ChangeShift.ZUI5_HR_ChangeShiftList
	 */

	PAGEID : "ZUI5_HR_ChangeShiftList",
...
//		if(vData != undefined) oController.onGetCountDown(oController ,vData.Pernr );
	...
	/*onPressRegCheck : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_ChangeShift.ZUI5_HR_ChangeShiftList");
...
//		oController._RegnoCheckDialog.close();
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_ChangeShift.ZUI5_HR_ChangeShiftDetail",
		      data : {Appno : ""}
		});	
	},
