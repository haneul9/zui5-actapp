...
sap.ui.jsview("ZUI5_HR_CommuteRecordIndv.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_CommuteRecordIndv.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_CommuteRecordIndv.ZUI5_HR_CommuteRecordIndvList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_CommuteRecordIndv.ZUI5_HR_CommuteRecordIndvList", "ZUI5_HR_CommuteRecordIndv.ZUI5_HR_CommuteRecordIndvList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0688"),	// 688:근태기록부확인(개인)
			showLogout : false,
			app : this.app,
