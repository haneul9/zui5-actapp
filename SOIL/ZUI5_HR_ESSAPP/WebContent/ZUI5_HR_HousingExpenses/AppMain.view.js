...
sap.ui.jsview("ZUI5_HR_HousingExpenses.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_HousingExpenses.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_HousingExpenses.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_HousingExpenses.ZUI5_HR_HousingExpensesList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_HousingExpenses.ZUI5_HR_HousingExpensesList", "ZUI5_HR_HousingExpenses.ZUI5_HR_HousingExpensesList"));
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_COMPANYHOUSE_EXP_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_COMPANYHOUSE_EXP_SRV"); 
