...
sap.ui.jsview("ZUI5_HR_DeductionChangeIndvDisplay.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeductionChangeIndvDisplay.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeductionChangeIndvDisplay.ZUI5_HR_DeductionChangeIndvDisplayList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeductionChangeIndvDisplay.ZUI5_HR_DeductionChangeIndvDisplayList", "ZUI5_HR_DeductionChangeIndvDisplay.ZUI5_HR_DeductionChangeIndvDisplayList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0555"),	// 555:변동공제 조회(개인)
			showLogout : false,
			app : this.app,
