...
sap.ui.jsview("ZUI5_HR_LifeStableRepayment.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_LifeStableRepayment.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_LifeStableRepayment.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_LifeStableRepayment.ZUI5_HR_LifeStableRepaymentList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_LifeStableRepayment.ZUI5_HR_LifeStableRepaymentList", "ZUI5_HR_LifeStableRepayment.ZUI5_HR_LifeStableRepaymentList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0431"),	// 431:생활안정자금 중도상환 신청
			showLogout : false,
			app : this.app,
