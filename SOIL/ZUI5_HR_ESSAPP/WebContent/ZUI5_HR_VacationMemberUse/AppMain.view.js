...
sap.ui.jsview("ZUI5_HR_VacationMemberUse.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_VacationMemberUse.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_VacationMemberUse.ZUI5_HR_VacationMemberUseList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_VacationMemberUse.ZUI5_HR_VacationMemberUseList", "ZUI5_HR_VacationMemberUse.ZUI5_HR_VacationMemberUseList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0609"),	// 609:부서원휴가사용조회
			showLogout : false,
			app : this.app,
