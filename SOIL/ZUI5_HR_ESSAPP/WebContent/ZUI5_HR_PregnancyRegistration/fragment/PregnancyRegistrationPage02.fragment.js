sap.ui.jsfragment("ZUI5_HR_PregnancyRegistration.fragment.PregnancyRegistrationPage02", {
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text(oController.PAGEID + "_DetailTitle", {text : oBundleText.getText("LABEL_0146") }).addStyleClass("Font18px FontColor0"),	// 146:임신직원 등록 신청
		...
		var aRows = [
			new sap.ui.commons.layout.MatrixLayoutRow({
				...
				cells : [
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							text : oBundleText.getText("LABEL_0144")	// 144:건강관리 서비스 신청
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
						...
						content : new sap.m.Toolbar({
							content : [ 
								new sap.m.Input({
									width : "100%",
									value : "{Zbigo}",
									maxLength : common.Common.getODataPropertyLength("ZHR_PREGNANT_REGI_SRV", "PregnantRegiRequestAppl", "Zbigo"),
									editable : {
										path : "ZappStatAl",
										formatter : function(fVal) {
											return (fVal == "" || fVal == "10") ? true : false;
