...
sap.ui.jsfragment("ZUI5_HR_PregnancyRegistration.fragment.PregnancyRegistrationPage01", {
	...
	_colModel : [
		...
		{id: "ZdateBf3", label : oBundleText.getText("LABEL_0150"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "100px"},	// 150:출산예정일\n(3개월전)
		{id: "Zhear", label : oBundleText.getText("LABEL_0145"), plabel : "", span : 0, type : "Checkbox2", sort : true, filter : true, width : "100px"},	// 145:건강관리\n서비스 신청
		{id: "Conpr", label : oBundleText.getText("LABEL_0148"), plabel : "", span : 0, type : "Checkbox2", sort : true, filter : true, width : "80px"},	// 148:축하선물\n여부
		{id: "Parki", label : oBundleText.getText("LABEL_0147"), plabel : "", span : 0, type : "Checkbox2", sort : true, filter : true, width : "80px"},	// 147:주차지원\n여부
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({text : oBundleText.getText("LABEL_0146") }).addStyleClass("Font18px FontColor0"),	// 146:임신직원 등록 신청
