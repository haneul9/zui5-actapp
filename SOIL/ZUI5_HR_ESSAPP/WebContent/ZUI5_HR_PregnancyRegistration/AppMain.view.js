...
sap.ui.jsview("ZUI5_HR_PregnancyRegistration.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_PregnancyRegistration.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_PregnancyRegistration.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_PregnancyRegistration.ZUI5_HR_PregnancyRegistrationList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_PregnancyRegistration.ZUI5_HR_PregnancyRegistrationList", "ZUI5_HR_PregnancyRegistration.ZUI5_HR_PregnancyRegistrationList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0146"),	// 146:임신직원 등록 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_PREGNANT_REGI_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_PREGNANT_REGI_SRV"); 
