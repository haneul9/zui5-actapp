...
sap.ui.jsview("ZUI5_HR_WorktimeRecordException.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_WorktimeRecordException.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorktimeRecordException.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorktimeRecordException.ZUI5_HR_WorktimeRecordExceptionList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorktimeRecordException.ZUI5_HR_WorktimeRecordExceptionList", "ZUI5_HR_WorktimeRecordException.ZUI5_HR_WorktimeRecordExceptionList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0802"),	// 802:근태기록부(예외자)
			showLogout : false,
			app : this.app,
