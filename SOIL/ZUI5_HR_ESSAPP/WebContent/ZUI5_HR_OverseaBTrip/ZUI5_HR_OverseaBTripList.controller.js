...
sap.ui.controller("ZUI5_HR_OverseaBTrip.ZUI5_HR_OverseaBTripList", {
	/**
	...
	PAGEID : "ZUI5_HR_OverseaBTripList",
	...
	onPressNew : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_OverseaBTrip.ZUI5_HR_OverseaBTripList");
		var oController = oView.getController();		
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_OverseaBTrip.ZUI5_HR_OverseaBTripDetail",
		      data : {Appno : ""}
		});	
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1234") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1234:해외출장명령 신청
			};
