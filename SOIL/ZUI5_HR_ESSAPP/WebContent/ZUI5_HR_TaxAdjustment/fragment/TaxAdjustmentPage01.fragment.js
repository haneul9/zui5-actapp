sap.ui.jsfragment("ZUI5_HR_TaxAdjustment.fragment.TaxAdjustmentPage01", {
	...
	_colModel : [
		 ...
		 {id: "Zzjiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 67:직위
	  	 {id: "Orgtx", label : oBundleText.getText("LABEL_0479"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : "Begin"},	// 479:소속
		 {id: "ItpctOtx", label : oBundleText.getText("LABEL_1322"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 1322:조정 전 세율
		 {id: "Itpctx", label : oBundleText.getText("LABEL_1320"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 1320:조정 세율
		 {id: "Apstym", label : oBundleText.getText("LABEL_1321"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 1321:조정 시작년월
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_1319")	// 1319:원천징수 세액조정 신청
