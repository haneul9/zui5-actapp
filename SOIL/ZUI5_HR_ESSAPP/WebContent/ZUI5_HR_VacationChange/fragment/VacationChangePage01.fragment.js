sap.ui.jsfragment("ZUI5_HR_VacationChange.fragment.VacationChangePage01", {
	...
	_colModel : [
		...
		{id: "Chtxt", label : oBundleText.getText("LABEL_0157"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 157:신청유형
		{id: "Operiod", label : oBundleText.getText("LABEL_1612"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "200px"},	// 1612:기신청 기간
		{id: "Aptxt", label : oBundleText.getText("LABEL_0763"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 763:휴가
		{id: "Period", label : oBundleText.getText("LABEL_1204"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "200px"},	// 1204:기간
		{id: "Useday", label : oBundleText.getText("LABEL_0918"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "80px"},	// 918:사용일수
						...
						new sap.ui.commons.layout.MatrixLayoutCell({
							content : new sap.ui.commons.layout.VerticalLayout({
								...
								content : [ 
									...
									sap.ui.jsfragment("fragment.IconTab", oController),			
									new sap.ui.core.HTML({content : "<div style='height : 10px;'/>"}),
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({text : oBundleText.getText("LABEL_2358") }).addStyleClass("Font18px FontColor0"),	// 2358:휴가 변경/취소 신청
