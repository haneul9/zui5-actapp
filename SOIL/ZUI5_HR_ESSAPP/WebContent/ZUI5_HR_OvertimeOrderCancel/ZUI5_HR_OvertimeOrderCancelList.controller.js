...
sap.ui.controller("ZUI5_HR_OvertimeOrderCancel.ZUI5_HR_OvertimeOrderCancelList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_OvertimeOrderCancel.ZUI5_HR_OvertimeOrderCancelList
	 */

	PAGEID : "ZUI5_HR_OvertimeOrderCancelList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_OvertimeOrderCancel.ZUI5_HR_OvertimeOrderCancelList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_OvertimeOrderCancel.ZUI5_HR_OvertimeOrderCancelDetail",
			data : { Appno : _Appno }
		});
	},
	...
	onPressSearch : function(oEvent) {
		...
		function Search() {
			...
			oModel.read("/CanSpecialWorkListSet", {
				async: false,
				filters: aFilters,
...
//			}
	...
	onExport : function(oEvent) {
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0678") + "-" + dateFormat.format(curDate) + ".xlsx"	// 678:특근명령서 취소신청서
			};
