...
sap.ui.jsfragment("ZUI5_HR_ChangeAccount.fragment.ChangeAccountPage01", {
	...
	_colModel : [
		...
		{id: "Chk01", label : oBundleText.getText("LABEL_0598"), plabel : "", span : 0, type : "Checkbox2", sort : true, filter : true, width : "100px"},	// 598:급여계좌
		{id: "Chk02", label : oBundleText.getText("LABEL_0594"), plabel : "", span : 0, type : "Checkbox2", sort : true, filter : true, width : "100px"},	// 594:e-Office계좌
		{id: "Chk03", label : oBundleText.getText("LABEL_0599"), plabel : "", span : 0, type : "Checkbox2", sort : true, filter : true, width : "140px"},	// 599:무재해 보상금 계좌
		{id: "Banka", label : oBundleText.getText("LABEL_0499"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "180px"},	// 499:은행명
		{id: "Bankn", label : oBundleText.getText("LABEL_0556"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "140px", align : sap.ui.core.TextAlign.Begin},	// 556:계좌번호
		...
		{id: "ZListComment", label : oBundleText.getText("LABEL_2869"), plabel : "", span : 0, type : "commentpopover3", sort : true, filter : true, width : "300px", align : sap.ui.core.TextAlign.Begin}	// 2869:반려 의견
	],
...
//					maxTokens : 1,
				...
				new sap.m.ToolbarSpacer({width : "10px"}),
				new sap.m.ComboBox(oController.PAGEID + "_Bnksa", {
					width : "150px",
					selectedKey : "{Bnksa}",
					editable : true,
					items : {
						path: "ZHR_ACCOUNTCHG_SRV>/BnksaCodeListSet",
				...
				new sap.m.ToolbarSpacer({width : "10px"}),
				new sap.m.Button({
					text: oBundleText.getText("LABEL_0597"),	// 597:계좌현황
					icon : "sap-icon://search",
					type : sap.m.ButtonType.Emphasized,
					press : oController.onPressRetrieveAccount,
					visible : {
						path : "Pernr",
