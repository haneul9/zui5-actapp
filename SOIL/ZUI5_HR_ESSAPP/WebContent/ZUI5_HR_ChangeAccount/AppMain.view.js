...
sap.ui.jsview("ZUI5_HR_ChangeAccount.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ChangeAccount.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ChangeAccount.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ChangeAccount.ZUI5_HR_ChangeAccountList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ChangeAccount.ZUI5_HR_ChangeAccountList", "ZUI5_HR_ChangeAccount.ZUI5_HR_ChangeAccountList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0595"),	// 595:계좌변경 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_ACCOUNTCHG_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_ACCOUNTCHG_SRV");
