sap.ui.jsfragment("ZUI5_HR_DomesticBTrip.fragment.DomesticBTripPage01", {
	...
	_colModel : [
		...
		{id: "Period", label : oBundleText.getText("LABEL_1204"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "11%"},	// 1204:기간
		{id: "Busin", label : oBundleText.getText("LABEL_1210"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%", align : "Begin"},	// 1210:용무
		{id: "Slotx", label : oBundleText.getText("LABEL_1211"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 1211:출발지
		{id: "Elotx", label : oBundleText.getText("LABEL_1206"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 1206:도착지
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Toolbar({
				...
				content : [ new sap.m.Image({
							...
							new sap.m.Text({text : oBundleText.getText("LABEL_1203") }).addStyleClass("Font18px FontColor0"),	// 1203:국내출장명령 신청
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Toolbar({	
				content : [ new sap.m.Toolbar(oController.PAGEID + "_ManualToolbar",{	
							...
							new sap.m.ToolbarSpacer(),
							new sap.m.Button({
								text : oBundleText.getText("LABEL_1208"), 	// 1208:신청(국문)
								press : oController.onPressNew1
							}),
							new sap.m.Button({
								text : oBundleText.getText("LABEL_1209"), 	// 1209:신청(영문)
								type : "Default", 
