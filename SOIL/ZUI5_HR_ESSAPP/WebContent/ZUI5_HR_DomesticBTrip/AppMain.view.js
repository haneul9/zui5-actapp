...
sap.ui.jsview("ZUI5_HR_DomesticBTrip.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DomesticBTrip.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripList", "ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1203"),	// 1203:국내출장명령 신청
			showLogout : false,
			app : this.app,
