...
sap.ui.jsview("ZUI5_HR_ApprovalOverview.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ApprovalOverview.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ApprovalOverview.ZUI5_HR_ApprovalOverviewList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ApprovalOverview.ZUI5_HR_ApprovalOverviewList", "ZUI5_HR_ApprovalOverview.ZUI5_HR_ApprovalOverviewList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1897"),	// 1897:신청문서 Overview
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_BUSITRIP_DOM_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_BUSITRIP_DOM_SRV"); 
...
//		gReqAuth = vLoginData.ReqAuth || gReqAuth;
