...
sap.ui.jsview("ZUI5_HR_BookReserve.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_BookReserve.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_BookReserve.ZUI5_HR_BookReserveList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_BookReserve.ZUI5_HR_BookReserveList", "ZUI5_HR_BookReserve.ZUI5_HR_BookReserveList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1619"),  	// 1619:나의 예약 도서
			showLogout : false,
			app : this.app,
