...
sap.ui.jsview("ZUI5_HR_WorktimeDispatchDailyRecord.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorktimeDispatchDailyRecord.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorktimeDispatchDailyRecord.ZUI5_HR_WorktimeDispatchDailyRecordList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorktimeDispatchDailyRecord.ZUI5_HR_WorktimeDispatchDailyRecordList", "ZUI5_HR_WorktimeDispatchDailyRecord.ZUI5_HR_WorktimeDispatchDailyRecordList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0977"),	// 977:파견직근태기록부조회
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_DAILYTIME_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_DAILYTIME_SRV");
