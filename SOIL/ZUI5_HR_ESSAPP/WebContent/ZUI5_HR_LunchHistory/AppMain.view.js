...
sap.ui.jsview("ZUI5_HR_LunchHistory.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_LunchHistory.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_LunchHistory.ZUI5_HR_LunchHistoryDetail"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_LunchHistory.ZUI5_HR_LunchHistoryDetail", "ZUI5_HR_LunchHistory.ZUI5_HR_LunchHistoryDetail"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2154"),	// 2154:중식비 사용내역 조회 (본사)
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_LUNCH_CARD_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_LUNCH_CARD_SRV"); 
