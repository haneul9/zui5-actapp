...
sap.ui.jsview("ZUI5_HR_ExcWork.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ExcWork.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ExcWork.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ExcWork.ZUI5_HR_ExcWorkList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ExcWork.ZUI5_HR_ExcWorkList", "ZUI5_HR_ExcWork.ZUI5_HR_ExcWorkList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1978"),	// 1978:예외근무 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_WORKSCHDULE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_WORKSCHDULE_SRV"); 
		
		var oServiceURL3 = this.getUrl("/sap/opu/odata/sap/ZHR_SPECIAL_WORK_SRV/");
		...
		sap.ui.getCore().setModel(oModel3, "ZHR_SPECIAL_WORK_SRV");
