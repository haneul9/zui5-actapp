...
sap.ui.controller("ZUI5_HR_ResignationInterview.ZUI5_HR_ResignationInterviewList", {
	/**
	...
	PAGEID : "ZUI5_HR_ResignationInterviewList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_ResignationInterview.ZUI5_HR_ResignationInterviewList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_ResignationInterview.ZUI5_HR_ResignationInterviewDetail",
		      data : { Appno : _Appno }
		});
	},
...
//			}
	...
	onExport : function(oEvent) {
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_0393") + "-" + dateFormat.format(curDate) + ".xlsx"	// 393:퇴직자 면접표 작성
			};
