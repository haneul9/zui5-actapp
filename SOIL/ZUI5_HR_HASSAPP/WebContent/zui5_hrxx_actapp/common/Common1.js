...
//			oRow.addCell(oCell);
	...
	setSubjectListColumn : function(oController) {
		...
		var vColumns = [ {id : "Photo", label : "", control : "image", width : "40px"},
		                 {id : "Ename", label : "성명", control : "link", width : "150px"},
		                 {id : "Acttx", label : "발령유형", control : "textarea", width : "150px"},
		                 {id : "Actda", label : "발령일", control : "date", width : "100px"},
		                 {id : "Batyp", label : "구분", control : "Batyp", width : "70px"},
...
//		                 {id : "Zzempwp_Tx", label : "", control : "", width : ""}
		...
		for(var i=0; i<vDisplayControl.length; i++) {
			...
			var oColumn = new sap.ui.table.Column();
			oColumn.setLabel(new sap.ui.commons.TextView({text: vDisplayControl[i].Label, textAlign : "Left", wrapping : true}).addStyleClass("L2P13Font"));
			oColumn.setHAlign(sap.ui.core.HorizontalAlign.Left);
...
//		                 {id : "Sub05", label : "해외", control : "icon", width : "50px"},		//해외
		                 ...
		                 {id : "Batyp", label : "구분", control : "Batyp", width : "70px"},		//발령구분
		                 {id : "Docno", label : "", control : "", width : ""},
		                 {id : "Pernr", label : "", control : "", width : ""},
		                 {id : "Docty", label : "", control : "", width : ""},
