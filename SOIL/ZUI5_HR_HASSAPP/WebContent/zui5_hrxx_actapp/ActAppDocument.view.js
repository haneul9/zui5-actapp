sap.ui.jsview("zui5_hrxx_actapp.ActAppDocument", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_actapp.ActAppDocument";
	},
		...
		var oListPanel = new sap.m.Panel({
			...
			headerToolbar : new sap.m.Toolbar({
				...
				content : [new sap.ui.core.Icon({src : "sap-icon://collaborate", size : "1.0rem", color : "#666666"}),
				           ...
				           new sap.m.Image({src : "/sap/bc/ui5_ui5/sap/zhrxx_common/images/Radiation.png"}),
				           new sap.m.Label({text : "소급발령"}).addStyleClass("L2P13Font"),
				           new sap.m.ToolbarSpacer(),
