		...
		var oListPanel = new sap.m.Panel({
			...
			headerToolbar : new sap.m.Toolbar({
				...
				content : [new sap.ui.core.Icon({src : "sap-icon://collaborate", size : "1.0rem", color : "#666666"}),
				           ...
				           new sap.m.ToolbarSpacer(),
				           new sap.m.Button(oController.PAGEID + "_Add_Rec_Btn",{text: "계약자정보등록", icon : "sap-icon://add-contact", press : oController.addRecPerson, visible : false}),
				           new sap.m.Button(oController.PAGEID + "_Mod_Rec_Btn",{text: "계약자정보수정", icon : "sap-icon://edit", press : oController.modifyRecPerson, visible : false}),
				           new sap.m.Button(oController.PAGEID + "_View_Rec_Btn",{text: "계약자정보조회", icon : "sap-icon://personnel-view", press : oController.viewRecPerson, visible : false}),
		...
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			...
			customHeader : new sap.m.Bar({
								...
								contentMiddle : new sap.m.Text({
									   			text : "Register approval request for 3rd party contractor action"
