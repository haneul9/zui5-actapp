// Provides control contorl.XNavigationListItem.
sap.ui.define(["jquery.sap.global", "sap/ui/core/Item",
	...
	function(jQuery, Item, Icon, NavigationList, Renderer, IconPool, NavigationListItem, MessageToast) {
		...
		var XNavigationListItem = NavigationListItem.extend("contorl.XNavigationListItem", /** @lends sap.tnt.NavigationListItem.prototype */ {
			metadata: {
				defaultAggregation: "items",
				aggregations: {
					xitems: {
						type: "contorl.XNavigationListItem",
						multiple: true,
						singularName: "item"
					}
				}
			...
			getLevel: function() {
				...
				while (parent && parent.getMetadata().getName() == 'contorl.XNavigationListItem') {
					level = level + 1;
