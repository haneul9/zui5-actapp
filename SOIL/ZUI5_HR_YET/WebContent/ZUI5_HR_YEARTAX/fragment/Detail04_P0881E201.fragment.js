sap.ui.jsfragment("ZUI5_HR_YEARTAX.fragment.Detail04_P0881E201", {
	/** 그 밖의 소득공제(개인연금 저축공제) **/
	createContent : function(oController) {
		
		var oTable = new sap.ui.table.Table(oController.PAGEID + "_P0881E201Table", {
			...
			extension : [new sap.m.Toolbar({
							content : [new sap.m.Button({
											...
											press : function(oEvent){
												oController.onAddLine2(oEvent, "P0881E201");
											}
									   }),
									   new sap.m.Button({
										    icon : "sap-icon://less",
											...
											press : function(oEvent){
												oController.onDeleteLine(oEvent, "P0881E201");
											}
									   }),
		...
		var oDialog = new sap.m.Dialog({
			...
			beginButton : [new sap.m.Button({
								...
								press : function(oEvent){
									oController.onPressSaveSubty(oEvent, "P0881E201");
								}
						   })],			
