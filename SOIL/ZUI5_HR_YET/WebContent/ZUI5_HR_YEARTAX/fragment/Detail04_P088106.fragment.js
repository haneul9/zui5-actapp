sap.ui.jsfragment("ZUI5_HR_YEARTAX.fragment.Detail04_P088106", {
	/** 세액감면 및 세액공제 - 직불/선불카드 **/
	createContent : function(oController) {
		
		var oTable = new sap.ui.table.Table(oController.PAGEID + "_P088106Table", {
			...
			extension : [new sap.m.Toolbar({
							content : [new sap.m.Button({
											...
											press : function(oEvent){
												oController.onAddLine(oEvent, "P088106");
											}
									   }),
									   new sap.m.Button({
										    icon : "sap-icon://less",
											...
											press : function(oEvent){
												oController.onDeleteLine(oEvent, "P088106");
											}
									   }),
		...
		var oDialog = new sap.m.Dialog({
			...
			beginButton : [new sap.m.Button({
								...
								press : function(oEvent){
									oController.onPressSaveSubty(oEvent, "P088106");
								}
						   })],			
