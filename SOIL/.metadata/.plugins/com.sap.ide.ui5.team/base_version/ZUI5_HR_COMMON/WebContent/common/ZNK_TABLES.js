jQuery.sap.declare("common.ZNK_TABLES");
...
//	        	vAlign : "Middle",
			...
			oColumn.addMultiLabel(new sap.ui.commons.TextView({text : vColumnInfo[i].label, textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"));
			if(vColumnInfo[i].plabel != "") {
				oColumn.addMultiLabel(new sap.ui.commons.TextView({text : vColumnInfo[i].plabel, textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"));
			}
...
//				 			        }
				...
				case "stringT" :
					oColumn.setTemplate(new sap.m.Link({
						...
						press : common.ZNK_TABLES.onOpenTooltip,
					}).addStyleClass("L2PFontFamily"));
					break;
				case "string4" :
					oColumn.setTemplate(new sap.ui.commons.TextView({
...
//						textAlign : "Center",
						customData : new sap.ui.core.CustomData({key : "Appno", value : "{Appno}"}),
						press : oController.onPressRow
					}).addStyleClass("L2PFontFamily2"));
					oColumn.removeAllMultiLabels();
					oColumn.addMultiLabel(new sap.ui.commons.TextView({text : vColumnInfo[i].label, textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily2"));
...
//						    	if(fVal && fVal != "0000"){
				...
				case "listtime" :
					oColumn.setTemplate(new sap.m.Link({
					    ...
					    textAlign : "Center",
						customData : new sap.ui.core.CustomData({key : "Appno", value : "{Appno}"}),
						press : oController.onPressRow}).addStyleClass("L2PFontFamily"));
									...
									formatter : function(x){
										 if(x == null || x == ""){
											 ...
											 if(x * 1 < 0){
												 ...
												 this.addStyleClass("L2PFontFamilyRed"); 
											 }else{
												 this.removeStyleClass("L2PFontFamilyRed");
				...
				case "number" :
					oColumn.setTemplate(new sap.ui.commons.TextView({
						text : "{" + vColumnInfo[i].id + "}", 
						textAlign : "Right"}).addStyleClass("L2PFontFamily"));
					
					break;
				case "onlyNumber" :
					oColumn.setTemplate(
							new sap.m.Input({liveChange : common.ZNK_TABLES.onlyNumber, value : "{" + vColumnInfo[i].id + "}"}).addStyleClass("L2PFontFamily")					
					);
							...
							new sap.m.Toolbar({
								content : [new sap.m.ToolbarSpacer(),
										   new sap.ui.core.Icon({
											...
											press : common.ZNK_TABLES.onOpenZappResn,
...
//					oColumn.setTemplate(new sap.m.Link({
//						text : "{Symptn}", 
//						textAlign : common.Common.checkNull(vColumnInfo[i].align) ? "Begin" :  vColumnInfo[i].align,
////						textAlign : "Center",
//						press : common.ZNK_TABLES.onOpenZappResn,
//						customData : [new sap.ui.core.CustomData({key : "Symptn", value : "{Symptn}"}),
//					              	 new sap.ui.core.CustomData({key : "ZappResn", value : "{ZappResn}"})]
				...
				case "file" :
					oColumn.setTemplate(
							new sap.ui.core.Icon({
								...
								press :common.ZNK_TABLES.onOpenAttachList,
				...
				case "ptifile" :
					oColumn.setTemplate(
							new sap.ui.core.Icon({
								size : "15px",
								src : "sap-icon://attachment",
								press :common.ZNK_TABLES.onOpenPTIAttachList,
								customData : [new sap.ui.core.CustomData({key : "Appno",value:"{Appno}"}),
									          new sap.ui.core.CustomData({key : "Orgeh",value:"{Orgeh}"}),
...
//				oColumn.setShowSortMenuEntry(false);
			...
			oColumn.addMultiLabel(new sap.m.Text({text : vColumnInfo[i].label, textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"));
			if(vColumnInfo[i].plabel != "") {
				oColumn.addMultiLabel(new sap.m.Text({text : vColumnInfo[i].plabel, textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"));
			}
			if(vColumnInfo[i].plabel2 && vColumnInfo[i].plabel2 != "") {
				oColumn.addMultiLabel(new sap.m.Text({text : vColumnInfo[i].plabel2, textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"));
			}
//			oColumn.addMultiLabel(new sap.ui.commons.TextView({text : vColumnInfo[i].label, textAlign : "Center", width : "100%"}).addStyleClass("L2PFontFamily"));
			...
			if(vColumnInfo[i].type=="link"){
				...
				oColumn.setTemplate(new sap.ui.commons.TextView({
					text : "{" + vColumnInfo[i].id + "}", 
					textAlign : "End"}).addStyleClass("L2PFontFamily"));
				...
				oColumn.setTemplate(
						new sap.ui.layout.HorizontalLayout({
							...
							content : [
								...
								}).addStyleClass("L2PPaddingRightRem"),
								new sap.ui.layout.VerticalLayout({
									content : [
										new sap.m.Link({
											text : {
	...
	autoColumn : function(oController,oTable,oHeaders,oTypes,oFields,rowLength,oSizes,oAligns,mLabel){	
		...
		if(oHeaders&&oHeaders.length){
			for(var i=0;i<oHeaders.length;i++){
				var cColumn = common.ZNK_TABLES.cColumn(oController , oFields[i]);
				if(oHeaders[i]!="checkbox"){
					if(mLabel){
						cColumn.addMultiLabel(new sap.ui.commons.TextView({text : mLabel[i].split(";;")[0]}).addStyleClass("L2PFontFamily"));
						cColumn.setHeaderSpan([parseInt(mLabel[i].split(";;")[1]),1]);
					}				
					cColumn.addMultiLabel(new sap.ui.commons.TextView({text : oHeaders[i]}).addStyleClass("L2PFontFamily"));
//					cColumn.addMultiLabel(new sap.m.Text({text : "gg \n gg"}).addStyleClass("L2PFontFamily"));
					if(oAligns){
					...
					if(oTypes[i]=="string"){
						if(oAligns){
							cColumn.setTemplate(new sap.ui.commons.TextView({text : "{"+oFields[i]+"}", textAlign : oAligns[i]}).addStyleClass("L2PFontFamily"));
						}else{
							cColumn.setTemplate(new sap.ui.commons.TextView({text : "{"+oFields[i]+"}", textAlign : "Center"}).addStyleClass("L2PFontFamily"));
						}
						...
						if(oAligns){
							cColumn.setTemplate(new sap.ui.commons.TextView({text :{parts:[{path:oFields[i].split(",")[0]},{path:oFields[i].split(",")[1]}],formatter:function(fVal1,fVal2){if(fVal1&&fVal2){
								return fVal1 + fVal2;
							}}}, textAlign : oAligns[i]}).addStyleClass("L2PFontFamily L2PWhiteSpace"));
						}else{
							cColumn.setTemplate(new sap.ui.commons.TextView({text :{parts:[{path:oFields[i].split(",")[0]},{path:oFields[i].split(",")[1]}],formatter:function(fVal1,fVal2){if(fVal1&&fVal2){
								return fVal1 + fVal2;
							}}}, textAlign : "Center"}).addStyleClass("L2PFontFamily L2PWhiteSpace"));
						}
					}else if(oTypes[i]=="string1"){
						if(oAligns){
							cColumn.setTemplate(new sap.ui.commons.TextView({text : "{"+oFields[i]+"}", textAlign : oAligns[i]}).addStyleClass("L2PFontFamily L2PWhiteSpace"));
						}else{
							cColumn.setTemplate(new sap.ui.commons.TextView({text : "{"+oFields[i]+"}", textAlign : "Center"}).addStyleClass("L2PFontFamily L2PWhiteSpace"));
						}
					}else if(oTypes[i]=="year"){
						if(oAligns){
							cColumn.setTemplate(new sap.ui.commons.TextView({text : "{"+oFields[i]+"} " + oBundleText.getText("LABEL_1623"), textAlign : oAligns[i]}).addStyleClass("L2PFontFamily L2PWhiteSpace"));	// 1623:년
						}else{
							cColumn.setTemplate(new sap.ui.commons.TextView({text : "{"+oFields[i]+"} " + oBundleText.getText("LABEL_1623"), textAlign : "Center"}).addStyleClass("L2PFontFamily L2PWhiteSpace"));	// 1623:년
						}
					}else if(oTypes[i]=="date"){
						cColumn.setTemplate(new sap.ui.commons.TextView({text : {path : oFields[i], type :  new sap.ui.model.type.Date({pattern : "yyyy.MM.dd"})}, textAlign : "Center"}).addStyleClass("L2PFontFamily"));
...
//										},
						...
						cColumn.setTemplate(
								new sap.m.TextArea({text : {path : oFields[i]},
													rows : 2 }).addStyleClass("L2PFontFamily")
							);
	...
	//								customData : new sap.ui.core.CustomData({key : "Seqno",value : i})
						...
						cColumn.setTemplate(
								new sap.m.Input({
									...
									customData : new sap.ui.core.CustomData({value : "{Seqno}",key : "Key"})}).addStyleClass("L2PFontFamily")					
						);
					}else if(oTypes[i]=="onlyNumber"){
						cColumn.setTemplate(
								new sap.m.Input({liveChange : oController.onlyNum, value : "{"+oFields[i]+"}"}).addStyleClass("L2PFontFamily")					
						);
	...
	onOpenPTIAttachList : function(oEvent){
		...
		if(oCustomData && oCustomData.length) {
			for(var i=0; i<oCustomData.length; i++) {
				if(oCustomData[i].getKey() == "Appno") {
					vAppno = oCustomData[i].getValue();
				}else if(oCustomData[i].getKey() == "Orgeh"){
					vOrgeh = oCustomData[i].getValue();
				}else if(oCustomData[i].getKey() == "Perid"){
					vPerid = oCustomData[i].getValue();
				}else if(oCustomData[i].getKey() == "Ename"){
					vEname = oCustomData[i].getValue();
				}else if(oCustomData[i].getKey() == "Orgtx"){
					vOrgtx = oCustomData[i].getValue();
				}
			}
		}
		
	
	    var vUrl = "/sap/bc/ui5_ui5/sap/zui5_hr_common/pti.html?sap-client=200";
	    var vMode = "VIEW";
	 
	 	var vHostName = location.hostname;
	    if(vHostName.indexOf("hqhrsapdevap") > -1) {
  	       vAppno = "T"+ vAppno;
        }
	...
	onOpenZappResn : function(oEvent){
		if(oEvent.getSource().getCustomData() && oEvent.getSource().getCustomData().length > 0){
			...
			if(!common.Common.checkNull(vSymptn)){
				...
				oCell = new sap.ui.commons.layout.MatrixLayoutCell({
					content : new sap.m.Label({text : oBundleText.getText("LABEL_1086")}).addStyleClass("L2PFontFamilyBold"),	// 1086:담당자 의견
				}); 
				oRow.addCell(oCell);
				oMatrix.addRow(oRow);
			...
			if(!common.Common.checkNull(vZappResn)){
				if(!common.Common.checkNull(vSymptn)){
					...
					oCell = new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({text : ""}).addStyleClass("L2PFontFamilyBold"),
					}); 
					oRow.addCell(oCell);
					oMatrix.addRow(oRow);
					vHeight = "200px";
				...
				oCell = new sap.ui.commons.layout.MatrixLayoutCell({
					content : new sap.m.Label({text : oBundleText.getText("LABEL_1075")}).addStyleClass("L2PFontFamilyBold"),	// 1075:반려사유
				}); 
				oRow.addCell(oCell);
				oMatrix.addRow(oRow);
