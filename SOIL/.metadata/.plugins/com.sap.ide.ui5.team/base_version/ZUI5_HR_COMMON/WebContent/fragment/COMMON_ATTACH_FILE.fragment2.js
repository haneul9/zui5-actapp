...
//										else return "#6a6d70";
						...
						new sap.ui.commons.layout.MatrixLayoutCell({rowSpan : 2}),
						new sap.ui.commons.layout.MatrixLayoutCell({
...
//				                	   icon : "sap-icon://delete", 
			...
			}).addStyleClass("ToolbarNoBottomLine marginTop20px marginBottom10px"), oAttachFileList]
		});
