	...
	createContent : function(oController) {
		...
		var oToolbarLayout = new sap.ui.commons.layout.VerticalLayout({
			...
			content : [new sap.ui.core.Icon({src : "sap-icon://filter", size : "1.0rem", color : "#666666"}),
			           new sap.m.Label({text : oBundleText.getText("LABEL_2774") , design : "Bold"}).addStyleClass("FontFamily"),	// 2774:검색조건
			...
			new sap.ui.layout.VerticalLayout(oController.PAGEID + "_ES_Filter3", {
				content : [new sap.m.Label({text : oBundleText.getText("LABEL_0479") + ": "}),	// 479:소속
				           new sap.m.MultiInput(oController.PAGEID + "_ES_Fulln", {
								...
								valueHelpRequest: common.TargetUser.displayMultiOrgSearchDialog
							}).addStyleClass("L2P13Font")]
			}).addStyleClass("FilterItem")
		);
		...
		var vColumns = [
			 ...
			 {id : "Pbtxt", label : oBundleText.getText("LABEL_0563"), control : "txt", width : "120px", change : "", align : "left"},	// 563:사업장
		...
		var oResultPanel = new sap.m.Panel({
			...
			headerToolbar : new sap.m.Toolbar({
				...
				content : [new sap.ui.core.Icon({src : "sap-icon://table-chart", size : "1.2rem", color : "#666666"}),
				           new sap.m.Label({text : oBundleText.getText("LABEL_1467"), design : "Bold"}).addStyleClass("FontFamily"),	// 1467:검색결과
				           new sap.m.ToolbarSpacer()]
			}).addStyleClass("ToolbarNoBottomLine"),
			content : [oPersonList]
		});
...
//			contentHeight : "500px",
			...
			beginButton : new sap.m.Button({
				...
				press : common.TargetUser.onESSelectPerson
			}),
			endButton : new sap.m.Button({
				text : oBundleText.getText("LABEL_0071"), 	// 71:취소
				icon: "sap-icon://sys-cancel-2", 
				press : common.TargetUser.onESSClose
			})
		});
