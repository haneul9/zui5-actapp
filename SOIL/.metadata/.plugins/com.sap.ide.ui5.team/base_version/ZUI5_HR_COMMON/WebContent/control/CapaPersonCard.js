    ...
    sap.ui.core.Control.extend("control.CapaPersonCard", {
        ...
        renderer : {
            ...
            render : function(oRm, oControl) {
                ...
                oRm.write("<table cellpadding='0' cellspacing='0' style='background : white; border-bottom : 1px solid #aaaaaa; width:100%; height:100%; margin :0px; border-bottom : 1px solid rgb(220,220,220);'>");
                ...
                oRm.write("<td style='text-align:left; padding-top:5px' colSpan='2' class='L2PPersonCardOrgName'>");
                ...
                oRm.write("<tr>");
                oRm.write("<td style='text-align:left;padding-bottom:5px' class='L2PPersonLabel'>");
                oRm.write("??å : ");
                oRm.write("</td>");
                oRm.write("<td style='text-align:left;padding-bottom:5px' class='L2PPersonInfo'>");
