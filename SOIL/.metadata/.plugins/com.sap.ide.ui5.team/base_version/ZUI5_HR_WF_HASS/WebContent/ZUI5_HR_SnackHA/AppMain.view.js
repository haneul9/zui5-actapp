...
sap.ui.jsview("ZUI5_HR_SnackHA.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_SnackHA.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_SnackHA.ZUI5_HR_SnackList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_SnackHA.ZUI5_HR_SnackList", "ZUI5_HR_SnackHA.ZUI5_HR_SnackList"));
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_SNACK_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_SNACK_SRV"); 
