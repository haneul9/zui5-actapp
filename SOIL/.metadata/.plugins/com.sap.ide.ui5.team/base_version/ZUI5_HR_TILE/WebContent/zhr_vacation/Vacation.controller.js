...
(function(){
	...
	sap.ui.controller("zhr_vacation.Vacation",{
//	sap.ui.controller("sap.ushell.components.tiles.zhr_vacation.DynamicTile",{
		timer:null,
		oDataRequest:null,
...
//						vData.results = oData.results[0] ;
//						vData.results.CntBl1 = parseInt(vData.results.CntBl1);
//						vData.results.CntBl2 = parseInt(vData.results.CntBl2);
//						vData.results.CntBl3 = parseInt(vData.results.CntBl3);
//						vData.results.CntCr1 = parseInt(vData.results.CntCr1);
//						vData.results.CntCr2 = parseInt(vData.results.CntCr2);
//						vData.results.CntCr3 = parseInt(vData.results.CntCr3);
//						oController._JSonModel.setData(vData);
//					}
//				},
//				function(oResponse) {
...
//			}
		...
		onUpdateDynamicData:function(){
			...
			if(!n){n=0;}
				...
				jQuery.sap.log.warning("Refresh Interval "+n+" seconds for service URL "+c.service_url+" is less than 10 seconds, which is not supported. "+"Increased to 10 seconds automatically.",null,"zhr_vacation.Vacation.controller");
				n=10;
			}
			if(c.service_url){
				this.loadData(n);
        ...
        onSaveRuntimeSettings: function (oSettingsView) {
            ...
            function logErrorAndReject(oError) {
                jQuery.sap.log.error(oError, null, "zhr_vacation.Vacation.controller");
            }
        ...
        loadData: function (nservice_refresh_interval) {
            ...
            if (nservice_refresh_interval > 0) {
                ...
                jQuery.sap.log.info(
                    ...
                    null,
                    "zhr_vacation.Vacation.controller"
                );
                // call again later
