...
jQuery.sap.declare("zhr_mss_tile.DynamicTile.Component");

sap.ui.define([
               "sap/ui/core/UIComponent"
    ], function(UIComponent) {
        "use strict";
        return UIComponent.extend("zhr_mss_tile.DynamicTile.Component", {
            metadata : {
                "manifest": "json"
            },
...
//            },
            ...
            createContent : function() {
                var oTile = sap.ui.view({
                    viewName : "zhr_mss_tile.DynamicTile.DynamicTile",
