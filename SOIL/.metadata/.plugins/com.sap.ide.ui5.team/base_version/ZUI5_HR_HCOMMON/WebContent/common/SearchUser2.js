...
//	vColumns : [ {id : "Ename", label : oBundleText.getText("ENAME"), control : "txt", width : "180px", align : "left"}, //성명
//	             {id : "Pernr", label : oBundleText.getText("PERNR"), control : "txt", width : "80px", align : "left"}, //사번
//                 {id : "Fulln", label : oBundleText.getText("FULLN"), control : "txt", width : "180px", change : "OrgehC", align : "left"}, //소속
//                 {id : "Pgtxt", label : oBundleText.getText("PGTXT"), control : "txt", width : "100px", change : "PersgC", align : "left"}, //사원그룹
//                 {id : "Pktxt", label : oBundleText.getText("PKTXT"), control : "txt", width : "100px", change : "PersgC", align : "left"}, //사원하위그룹                
//                 {id : "Statx", label : oBundleText.getText("STATX"), control : "txt", width : "80px", change : "PersgC", align : "left"}, //재직구분
//                 {id : "Btrtx", label : oBundleText.getText("BTRTX"), control : "txt", width : "100px", change : "BtrtlC", align : "left"}, //인사 하위 영역
//                 {id : "Gbdat", label : oBundleText.getText("GBDAT"), control : "txt", width : "80px", align : "left"}, //생년월일
//                 {id : "Geschtx", label : oBundleText.getText("GESCH"), control : "txt", width : "60px", align : "left"}, //성별
//                 {id : "Entda", label : oBundleText.getText("ENTDA"), control : "txt", width : "80px", align : "left"}, //입사일
//                 {id : "Retda", label : oBundleText.getText("RETDA"), control : "txt", width : "80px", align : "left"}, //퇴사일
//                 
//                ],
                
	vColumns : [ {id : "Ename", label : "성명", control : "txt", width : "180px", align : "left"}, //성명
...
//		oCheckHeader.setChecked(false);
		...
		if(!oController.EsBusyDialog) {
			...
			oController.EsBusyDialog.addContent(new sap.m.BusyIndicator({text : oBundleText.getText("MSG_SEARCH_WAIT")}));
