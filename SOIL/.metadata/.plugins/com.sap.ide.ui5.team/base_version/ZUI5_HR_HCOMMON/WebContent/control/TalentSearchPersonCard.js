 ...
 */
    ...
    sap.ui.core.Control.extend("control.TalentSearchPersonCard", {
    	...
    	metadata : {
    		properties : {
    			...
    			event           : {type : "string", defaultValue : ""},
    		},
                ...
                for(var i = 0; i<vItemCount; i++) {
                	...
                	if(i==0){
                        ...
                        if(oControl.getFid009() == "임원"){
                        	...
                        	vColor = "#32CD32" ;
                        }else if(oControl.getFid013() != "" && oControl.getFid013() != "-"){ // 부서장
                        	vColor = "#E64848" ;
                        }
                        oRm.write("<td rowSpan='" + vRowSapn + "' style='width: 10px; background-color : " + vColor + ";' align='center'></td>");
                        oRm.write("</tr>");
                	}
                }
    ...
    control.TalentSearchPersonCard.onPressPerson = function(oPernr){
...
//    	if(oClickedControlId == "IMG") this.firePress({pernr : this.getPernr(), ename : this.getName(), wave : this.getWave()});
    	if(oClickedControlId == "IMG") window.open("/sap/bc/ui5_ui5/sap/zui5_hr_essapp/EmployeeProfile.html?_gAuth=" + _gAuth + "&_inPerer=" +  this.getPernr());
