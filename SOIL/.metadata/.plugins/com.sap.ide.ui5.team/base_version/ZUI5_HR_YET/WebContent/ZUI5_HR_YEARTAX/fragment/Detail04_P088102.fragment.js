			...
			extension : [new sap.m.Toolbar({
							content : [new sap.m.Button({
											...
											press : function(oEvent){
												oController.onAddLine(oEvent, "P088102");
											}
									   }),
									   new sap.m.Button({
										    icon : "sap-icon://less",
											...
											press : function(oEvent){
												oController.onDeleteLine(oEvent, "P088102");
											}
									   }),
...
//			 			{id: "Haned", label : "장애인여부", plabel : "", span : 0, type : "checkbox2", editable : false, sort : true, filter : true, width : "100px"}
		...
		var col_info = [{id: "Exsty1", label : "교복구입비", plabel : "", span : 0, type : "radiobutton", editable : true, sort : true, filter : true, width : "100px"},
		...
		var oDialog = new sap.m.Dialog({
			...
			beginButton : [new sap.m.Button({
								...
								press : function(oEvent){
									oController.onPressSaveSubty(oEvent, "P088102");
								}
						   })],			
