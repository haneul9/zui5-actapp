...
sap.ui.jsview("ZUI5_HR_MedicalReport.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_MedicalReport.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_MedicalReport.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_MedicalReport.ZUI5_HR_MedicalReportList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_MedicalReport.ZUI5_HR_MedicalReportList", "ZUI5_HR_MedicalReport.ZUI5_HR_MedicalReportList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0278"),	// 278:이사비 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_MEDICAL_REP_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_MEDICAL_REP_SRV");
