...
common.baseAppController("ZUI5_HR_ProductionEvaluationAdjust.AppMain", {
	
	onInit : function () {		
		// Any of the strings can be replaced with a function, that returns a string
		var oAppConfig = {
				
				defaultPageId : "ZUI5_HR_ProductionEvaluationAdjust.ZUI5_HR_ProductionEvaluationAdjustList",
