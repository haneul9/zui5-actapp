...
sap.ui.jsview("ZUI5_HR_EmTransport.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_EmTransport.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_EmTransport.ZUI5_HR_EmTransportList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_EmTransport.ZUI5_HR_EmTransportList", "ZUI5_HR_EmTransport.ZUI5_HR_EmTransportList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1391"),	// 1391:긴급업무 수행교통비 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_UGRTRANS_FEE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_UGRTRANS_FEE_SRV"); 
