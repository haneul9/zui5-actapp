...
sap.ui.jsfragment("ZUI5_HR_PreparedAmount.fragment.PreparedAmountPage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "180px", align : "Begin"},	// 39:소속부서
		{id: "Payym", label : oBundleText.getText("LABEL_0108"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "110px"},	// 108:급여반영월
		{id: "Ovrseayntx", label : oBundleText.getText("LABEL_0289"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 289:국내외구분
		{id: "Movdt", label : oBundleText.getText("LABEL_0292"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "100px"},	// 292:발령일
		{id: "Zzwork1T", label : oBundleText.getText("LABEL_0294"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "160px"},	// 294:발령전
		{id: "Zzwork2T", label : oBundleText.getText("LABEL_0296"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "160px"},	// 296:발령후
		{id: "Reqamt", label : oBundleText.getText("LABEL_0275"), plabel : "", span : 0, type : "listmoney", sort : true, filter : true, width : "100px"},	// 275:신청액
		{id: "Aplamt", label : oBundleText.getText("LABEL_0285"), plabel : "", span : 0, type : "listmoney", sort : true, filter : true, width : "100px"},	// 285:지원액
	...
	getFilterLayoutRender : function(oController) {
		...
		return new sap.m.Toolbar({
			...
			content : [
				...
				new sap.m.Input(oController.PAGEID + "_Payym", {
					value : "{Payym}",
					width : "150px",
					maxLength : 6,
					type : "Number",
