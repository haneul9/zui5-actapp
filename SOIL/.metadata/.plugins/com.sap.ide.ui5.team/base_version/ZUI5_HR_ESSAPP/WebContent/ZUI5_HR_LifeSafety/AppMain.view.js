...
sap.ui.jsview("ZUI5_HR_LifeSafety.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_LifeSafety.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_LifeSafety.ZUI5_HR_LifeSafetyList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_LifeSafety.ZUI5_HR_LifeSafetyList", "ZUI5_HR_LifeSafety.ZUI5_HR_LifeSafetyList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0077"),	// 77:생활안정자금 신청
			showLogout : false,
			app : this.app,
