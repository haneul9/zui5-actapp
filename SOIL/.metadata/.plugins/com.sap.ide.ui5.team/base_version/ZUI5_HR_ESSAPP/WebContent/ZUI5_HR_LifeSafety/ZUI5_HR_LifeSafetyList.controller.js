...
sap.ui.controller("ZUI5_HR_LifeSafety.ZUI5_HR_LifeSafetyList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_LifeSafety.ZUI5_HR_LifeSafetyList
	 */

	PAGEID : "ZUI5_HR_LifeSafetyList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_LifeSafety.ZUI5_HR_LifeSafetyList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_LifeSafety.ZUI5_HR_LifeSafetyDetail",
		      data : { Appno : _Appno }
		});
	},
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_0077") + "-" + dateFormat.format(curDate) + ".xlsx"	// 77:생활안정자금 신청
			};
