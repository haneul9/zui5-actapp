...
sap.ui.controller("ZUI5_HR_VacationRequest.ZUI5_HR_VacationRequestList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_VacationRequest.ZUI5_HR_VacationRequestList
	 */
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data")){
			...
			var JSonData = {Data : {Apbeg : dateFormat.format(prevDate), Apend : dateFormat.format(curDate), Zpernr : vPernr, Ename : vEname, Encid : vEncid,Auth : _gAuth}};
	...
	onPressNew : function(oEvent){
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_VacationRequest.ZUI5_HR_VacationRequestDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_VacationRequest.ZUI5_HR_VacationRequestList");
