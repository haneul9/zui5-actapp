sap.ui.jsfragment("ZUI5_HR_AnnualLeave.fragment.AnnualLeavePage01", {
	_colModel : [
		...
		{id: "Perid", label : oBundleText.getText("LABEL_0031"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 31:사번
		{id: "Ename", label : oBundleText.getText("LABEL_0038"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 38:성명
		{id: "Zzjiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "11%"},	// 67:직위
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "17%", align : "Begin"},	// 39:소속부서
		{id: "Useyr", label : oBundleText.getText("LABEL_1053"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 1053:연도
		{id: "Useday", label : oBundleText.getText("LABEL_0918"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 918:사용일수
		{id: "Docyn", label : oBundleText.getText("LABEL_0069"), plabel : "", span : 0, type : "ptifile", sort : false, filter : false, width : "6%"},	// 69:첨부
		{id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "10%"},	// 49:신청일
		{id: "ZappDate", label : oBundleText.getText("LABEL_0070"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "10%"}	// 70:최종결재일
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_1051")	// 1051:연간휴가 신청
	...
	getFilterLayoutRender : function(oController) {
		...
		var oFilterLayout = new sap.m.Toolbar({	
			...
			content : [new sap.m.ToolbarSpacer({width : "20px"}),
					   ...
					   new sap.m.ToolbarSpacer({width : "20px"}),
					   new sap.m.Text({text : oBundleText.getText("LABEL_0084"), visible : displayYn}).addStyleClass("Font14px FontBold FontColor3"),	// 84:신청자 성명 
					   new sap.m.ToolbarSpacer({width : "10px"}),
