...
sap.ui.jsview("ZUI5_HR_AnnualLeave.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_AnnualLeave.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_AnnualLeave.ZUI5_HR_AnnualLeaveList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_AnnualLeave.ZUI5_HR_AnnualLeaveList", "ZUI5_HR_AnnualLeave.ZUI5_HR_AnnualLeaveList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1051"),	// 1051:연간휴가 신청
			showLogout : false,
			app : this.app,
