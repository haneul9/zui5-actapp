...
sap.ui.jsview("ZUI5_HR_Expenditure.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Expenditure.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Expenditure.ZUI5_HR_ExpenditureList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Expenditure.ZUI5_HR_ExpenditureList", "ZUI5_HR_Expenditure.ZUI5_HR_ExpenditureList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1180"),	// 1180:경조금 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_CONTY_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_CONTY_SRV"); 
