sap.ui.jsfragment("ZUI5_HR_Expenditure.fragment.ExpenditurePage01", {
    ...
    _colModel1 : [
		 ...
		 {id: "Fname", label : oBundleText.getText("LABEL_1104"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "150px"},	// 1104:지원대상
		 {id: "Context", label : oBundleText.getText("LABEL_1183"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 1183:경조유형
		 {id: "Conretx", label : oBundleText.getText("LABEL_1085"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "150px"},	// 1085:관계
		 {id: "Conrdate", label : oBundleText.getText("LABEL_1184"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "100px"},	// 1184:경조일
		 {id: "ZpayBet", label : oBundleText.getText("LABEL_1194"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : "End", width : "120px"},	// 1194:지급금액
		 ...
		 {id: "ZListComment", label : oBundleText.getText("LABEL_0072"), plabel : "", span : 0, type : "commentpopover3", sort : false, filter : false, width : "300px"}	// 72:담당자의견
		 ],
   ...
   _colModel2 : [
	...
	createContent : function(oController) {
		...
		// Excel column info
		oController._Columns = common.Common.convertColumnArrayForExcel(_gAuth=="E" ? this._colModel1 : this._colModel2);
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_1180")	// 1180:경조금 신청
...
//			rowHeight  : 30,
		...
		common.ZHR_TABLES.makeColumn(oController, oTable, _gAuth=="E" ? this._colModel1 : this._colModel2);
