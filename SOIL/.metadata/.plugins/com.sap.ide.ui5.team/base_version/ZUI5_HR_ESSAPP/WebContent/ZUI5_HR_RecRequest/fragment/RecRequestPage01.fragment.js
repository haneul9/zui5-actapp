sap.ui.jsfragment("ZUI5_HR_RecRequest.fragment.RecRequestPage01", {
	...
	_colModel : [
		...
		{id: "Zzjiktlt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 67:직위
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "15%", align : "Begin"},	// 39:소속부서
		{id: "Recrn", label : oBundleText.getText("LABEL_2245"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "", align : "Begin"},	// 2245:충원 요청 근거
		{id: "Zorgtx", label : oBundleText.getText("LABEL_1551"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "15%", align : "Begin"},	// 1551:근무부서
		{id: "Recno", label : oBundleText.getText("LABEL_1028"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "80px"},	// 1028:신청 인원
	    ...
	    {id: "ZListComment", label : oBundleText.getText("LABEL_0072"), plabel : "", span : 0, type : "commentpopover", sort : false, filter : false, width : "90px"}	// 72:담당자의견
	],
...
//				new sap.m.ToolbarSpacer({width : "20px"}),
//				new sap.m.Text({text : oBundleText.getText("LABEL_2029") + " :", visible : displayYn})
//			    .addStyleClass("Font14px FontBold"),	// 2029:인사영역
//				new sap.m.ToolbarSpacer({width : "10px", visible : displayYn}),
//				new sap.m.Select({
//					width: "200px",
//					items:{
//						path: "ZL2P01GW9000_SRV>/PersAreaListSet",
