...
sap.ui.jsview("ZUI5_HR_RecRequest.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_RecRequest.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList", "ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2035"),	// 2035:인원 충원 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_ACTION_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_ACTION_SRV"); 
