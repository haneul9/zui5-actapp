...
sap.ui.controller("ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList
	 */

	PAGEID : "ZUI5_HR_RecRequestList",
	...
	onPressRegCheck : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_RecRequest.ZUI5_HR_RecRequestList");
	...
	onPressNew : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_RecRequest.ZUI5_HR_RecRequestDetail",
		      data : {Appno : ""}
		});	
	},
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_2248") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2248:충원요청서 작성
			};
