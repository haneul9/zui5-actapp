...
sap.ui.jsview("ZUI5_HR_SmockReg.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZUI5_HR_SmockReg.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_SmockReg.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_SmockReg.ZUI5_HR_SmockRegDetail"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_SmockReg.ZUI5_HR_SmockRegDetail", "ZUI5_HR_SmockReg.ZUI5_HR_SmockRegDetail"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0172"),	// 172:방염 작업복 사이즈 등록관리
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_BSUIT_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_BSUIT_SRV");
