sap.ui.jsfragment("ZUI5_HR_Manpower2.fragment.Detail4", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var col_info1 = [
			{id: "Grouptx", label : oBundleText.getText("LABEL_0953"), plabel : oBundleText.getText("LABEL_0953"), resize : false, span : 0, type : "string2", sort : false, filter : false, width : "22%"},	// 953:연령
		...
		oTable.addEventDelegate({
			  onAfterRendering: function() {
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table4-header > tbody',
						colIndexes : [0, 1]
					});
				   
				// 상단 Header 의 우측 border 없에기
				   var vColumnId = "";
				   $target = $('#ZUI5_HR_ManpowerList_Table4-header > tbody');
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table4-table > tbody',
						colIndexes : [0]
					});
				   
				    $target = $('#ZUI5_HR_ManpowerList_Table4-table > tbody');
