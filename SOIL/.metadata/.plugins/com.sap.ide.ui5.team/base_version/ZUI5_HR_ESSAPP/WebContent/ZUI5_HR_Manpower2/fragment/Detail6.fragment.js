sap.ui.jsfragment("ZUI5_HR_Manpower2.fragment.Detail6", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var oTable = new sap.ui.table.Table(oController.PAGEID + "_Table6", {
		...
		var col_info1 = [
			 {id: "Grouptx", label : "Year", plabel : "Year", resize : false, span : 0, type : "string2", sort : false, filter : false, width : "16%"},
		...
		oTable.addEventDelegate({
			  onAfterRendering: function() {
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table6-header > tbody',
						colIndexes : [0, 1, 2]
					});
				   
				// 상단 Header 의 우측 border 없에기
				   var vColumnId = "";
				   $target = $('#ZUI5_HR_ManpowerList_Table6-header > tbody');
				   ...
				   common.Common.generateRowspan({
						selector : '#ZUI5_HR_ManpowerList_Table6-table > tbody',
						colIndexes : [0]
					});
				   
				   $target = $('#ZUI5_HR_ManpowerList_Table6-table > tbody');
