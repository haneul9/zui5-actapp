...
sap.ui.controller("ZUI5_HR_OverseaBTripCal.ZUI5_HR_OverseaBTripCalList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_OverseaBTripCal.ZUI5_HR_OverseaBTripCalList
	 */

	PAGEID : "ZUI5_HR_OverseaBTripCalList",
	...
	onPressNew : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_OverseaBTripCal.ZUI5_HR_OverseaBTripCalList");
	...
	onPressCreate : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_OverseaBTripCal.ZUI5_HR_OverseaBTripCalDetail",
		      data : {Appno : ""}
		});	
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1279") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1279:해외출장비 신청
			};
