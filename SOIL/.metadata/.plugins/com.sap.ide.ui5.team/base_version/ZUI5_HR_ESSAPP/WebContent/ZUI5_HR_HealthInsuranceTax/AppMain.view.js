...
sap.ui.jsview("ZUI5_HR_HealthInsuranceTax.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_HealthInsuranceTax.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_HealthInsuranceTax.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_HealthInsuranceTax.ZUI5_HR_HealthInsuranceTaxList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_HealthInsuranceTax.ZUI5_HR_HealthInsuranceTaxList", "ZUI5_HR_HealthInsuranceTax.ZUI5_HR_HealthInsuranceTaxList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0859"),	// 859:건강보험 연말정산 금액 조회
			showLogout : false,
			app : this.app,
