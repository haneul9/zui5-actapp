sap.ui.jsfragment("ZUI5_HR_ParentalLeave.fragment.ParentalLeavePage01", {
	
	_colModel : [
		{id: "Idx", label : "No.", plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "50px"},
	 	{id: "ZappStxtAl", label : oBundleText.getText("LABEL_0036"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 36:상태
		{id: "Perid", label : oBundleText.getText("LABEL_0031"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 31:사번
		...
		{id: "Aptxt", label : oBundleText.getText("LABEL_0157"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "7%"},	// 157:신청유형
		{id: "Useday", label : oBundleText.getText("LABEL_0918"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 918:사용일수
		{id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "120px"},	// 49:신청일
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_2240")	// 2240:출산휴가/육아휴직 신청
