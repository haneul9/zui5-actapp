...
sap.ui.controller("ZUI5_HR_ParentalLeave.ZUI5_HR_ParentalLeaveList", {
	/**
	...
	PAGEID : "ZUI5_HR_ParentalLeaveList",
	...
	onPressNew : function(oEvent){
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_ParentalLeave.ZUI5_HR_ParentalLeaveDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_ParentalLeave.ZUI5_HR_ParentalLeaveList");
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_2240") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2240:출산휴가/육아휴직 신청
			};
