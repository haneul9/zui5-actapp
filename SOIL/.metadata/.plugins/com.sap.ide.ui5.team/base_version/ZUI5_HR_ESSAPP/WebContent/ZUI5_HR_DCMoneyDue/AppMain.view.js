...
sap.ui.jsview("ZUI5_HR_DCMoneyDue.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_DCMoneyDue.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DCMoneyDue.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DCMoneyDue.ZUI5_HR_DCMoneyDueList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DCMoneyDue.ZUI5_HR_DCMoneyDueList", "ZUI5_HR_DCMoneyDue.ZUI5_HR_DCMoneyDueList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0851"),	// 851:DC 퇴직연금 불입내역 조회
			showLogout : false,
			app : this.app,
