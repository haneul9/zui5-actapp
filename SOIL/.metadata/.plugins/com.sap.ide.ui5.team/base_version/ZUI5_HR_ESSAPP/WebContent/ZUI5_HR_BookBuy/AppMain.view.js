...
sap.ui.jsview("ZUI5_HR_BookBuy.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_BookBuy.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_BookBuy.ZUI5_HR_BookBuyList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_BookBuy.ZUI5_HR_BookBuyList", "ZUI5_HR_BookBuy.ZUI5_HR_BookBuyList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1533"),	// 1533:구독희망도서
			showLogout : false,
			app : this.app,
