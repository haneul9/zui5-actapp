...
sap.ui.controller("ZUI5_HR_VisitTransport.ZUI5_HR_VisitTransportList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_VisitTransport.ZUI5_HR_VisitTransportList
	 */

	PAGEID : "ZUI5_HR_VisitTransportList",
	...
	onPressNew : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_VisitTransport.ZUI5_HR_VisitTransportDetail",
		      data : {Appno : ""}
		});	
	},
	...
	onPressSearch : function(oEvent){
		...
		if(!common.Common.checkNull(SerchCond.Apend)) {
		...
		if(!common.Common.checkNull(SerchCond.Begda)) {
			aFilters.push(new sap.ui.model.Filter('Datb1', sap.ui.model.FilterOperator.EQ, common.Common.adjustGMT(sap.ui.getCore().byId(oController.PAGEID + "_Begda").getDateValue())));
		}
		if(!common.Common.checkNull(SerchCond.Endda)) {
			aFilters.push(new sap.ui.model.Filter('Date1', sap.ui.model.FilterOperator.EQ, common.Common.adjustGMT(sap.ui.getCore().byId(oController.PAGEID + "_Endda").getDateValue())));
		}
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_0011") + "-" + dateFormat.format(curDate) + ".xlsx"	// 근무편제변경 신청
			};
