sap.ui.jsfragment("ZUI5_HR_VisitTransport.fragment.VisitTransportPage01", {
	...
	_colModel : [
		...
		{id: "Datb1", label : oBundleText.getText("LABEL_1827"), plabel : "", span : 0, type : "date", sort : true, filter : true, width : "100px"},	// 1827:사용일(1차)
		{id: "Sloc1", label : oBundleText.getText("LABEL_1941"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "180px"},	// 1941:연고지(1차)
		{id: "Tran1tx", label : oBundleText.getText("LABEL_1531"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "150px"},	// 1531:교통편(1차)
		{id: "Objx1", label : oBundleText.getText("LABEL_1739"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "200px"},	// 1739:방문목적(1차)
		{id: "Datb2", label : oBundleText.getText("LABEL_1828"), plabel : "", span : 0, type : "date", sort : true, filter : true, width : "100px"},	// 1828:사용일(2차)
		{id: "Sloc2", label : oBundleText.getText("LABEL_1942"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "180px"},	// 1942:연고지(2차)
		{id: "Tran2tx", label : oBundleText.getText("LABEL_1532"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "150px"},	// 1532:교통편(2차)
		{id: "Objx2", label : oBundleText.getText("LABEL_1740"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "200px"},	// 1740:방문목적(2차)
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({text : oBundleText.getText("LABEL_1738") }).addStyleClass("Font18px FontColor0"),	// 2361:방문교통비 신청
