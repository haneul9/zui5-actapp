...
sap.ui.jsview("ZUI5_HR_VisitTransport.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_AnnualLeave.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_VisitTransport.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_VisitTransport.ZUI5_HR_VisitTransportList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_VisitTransport.ZUI5_HR_VisitTransportList", "ZUI5_HR_VisitTransport.ZUI5_HR_VisitTransportList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1738"),	// 1738:방문교통비 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_VISITRANS_FEE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_VISITRANS_FEE_SRV"); 
