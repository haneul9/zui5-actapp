...
sap.ui.controller("ZUI5_HR_Medical.ZUI5_HR_MedicalList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_Medical.ZUI5_HR_MedicalList
	 */

	PAGEID : "ZUI5_HR_MedicalList",
...
//		};
	...
	onDetailPage : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_Medical.ZUI5_HR_MedicalList");
		var oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_Medical.ZUI5_HR_MedicalDetail",
		      data : {
		    	  Appno : _Appno ,
		    	  Famgb : "",
		      }
	...
	onPressSearch : function(oEvent){
		...
		if(SerchCond.Payym != ""){
			if(filterString == ""){
				filterString = "/?$filter=Payym eq '" + SerchCond.Payym.replace(".","") + "'";	
			}else{
					...
					if(data && data.results.length){
						for(var i=0;i<data.results.length;i++){
							...
							if(OneData.ZappResn && OneData.ZappResn != ""){
								...
								OneData.ZListComment += oBundleText.getText("LABEL_1091") + " : " + OneData.ZappResn;	// 1091:반려 사유
							}
