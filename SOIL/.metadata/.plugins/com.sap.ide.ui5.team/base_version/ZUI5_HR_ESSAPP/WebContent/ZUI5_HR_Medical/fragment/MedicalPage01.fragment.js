sap.ui.jsfragment("ZUI5_HR_Medical.fragment.MedicalPage01", {
	 ...
	 _colModel : [
		 ...
		 {id: "Zzjiklntx", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "120px"},	// 67:직위
		 ...
		 {id: "Famgbtx", label : oBundleText.getText("LABEL_1104"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 1104:지원대상
		 {id: "Mdprd", label : oBundleText.getText("LABEL_1106"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "180px" },	// 1106:진료기간
		 {id: "Apamt", label : oBundleText.getText("LABEL_0081"), plabel : "", span : 0, type : "listmoney", sort : true, filter : true, width : "100px"},	// 81:신청금액
		 {id: "Pyamt", label : oBundleText.getText("LABEL_0139"), plabel : "", span : 0, type : "listmoney", sort : true, filter : true, width : "100px"},	// 139:지원금액
		 ...
		 {id: "Stfda", label : oBundleText.getText("LABEL_1087"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "100px"},	// 1087:담당자결재
		 {id: "ZappDate", label : oBundleText.getText("LABEL_0070"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "100px"},	// 70:최종결재일
		 {id: "ZListComment", label : oBundleText.getText("LABEL_0072"), plabel : "", span : 0, type : "commentpopover3", sort : true, filter : true, width : "300px"}
	],	// 72:담당자의견
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_1098")	// 1098:의료비 신청
