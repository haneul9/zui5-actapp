...
sap.ui.jsfragment("ZUI5_HR_LifeStableRepayment.fragment.LifeStableRepaymentPage01", {
	...
	_colModel : [
		...
		{id: "LmamtSum", label : oBundleText.getText("LABEL_0409"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "12%", align : sap.ui.core.TextAlign.End},	// 409:대출원금
		{id: "Lmdat", label : oBundleText.getText("LABEL_0434"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "10%"},	// 434:중도상환일
		{id: "LmamtPri", label : oBundleText.getText("LABEL_0433"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "12%", align : sap.ui.core.TextAlign.End},	// 433:중도상환금액
