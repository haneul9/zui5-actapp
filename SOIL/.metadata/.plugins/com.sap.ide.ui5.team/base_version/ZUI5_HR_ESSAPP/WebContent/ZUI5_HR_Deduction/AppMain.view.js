...
sap.ui.jsview("ZUI5_HR_Deduction.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Deduction.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Deduction.ZUI5_HR_DeductionList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Deduction.ZUI5_HR_DeductionList", "ZUI5_HR_Deduction.ZUI5_HR_DeductionList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0487"),	// 487:고정/변동 공제 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_DEDUCT_FIX_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_DEDUCT_FIX_SRV");
