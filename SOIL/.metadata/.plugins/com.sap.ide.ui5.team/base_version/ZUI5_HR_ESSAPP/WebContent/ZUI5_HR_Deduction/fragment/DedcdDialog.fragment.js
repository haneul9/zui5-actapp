sap.ui.jsfragment("ZUI5_HR_Deduction.fragment.DedcdDialog", {
...
//						oController._DetailJSonModel.setProperty("/Data/Bnkgb", undefined);
						...
						oController._ListCondJSonModel.setProperty("/Data/Dedcd", undefined);
						oController._ListCondJSonModel.setProperty("/Data/Dedtx", undefined);
					}
...
//			columnHeaderHeight : 35,
		...
		oTable.addEventDelegate({
			onAfterRendering: function() {
				var oTable = sap.ui.getCore().byId("ZUI5_HR_DeductionDetail_DedcdTable") || sap.ui.getCore().byId("ZUI5_HR_DeductionList_DedcdTable");
