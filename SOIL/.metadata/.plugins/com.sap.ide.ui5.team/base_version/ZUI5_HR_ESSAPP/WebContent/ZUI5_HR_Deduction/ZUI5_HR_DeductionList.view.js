...
sap.ui.jsview("ZUI5_HR_Deduction.ZUI5_HR_DeductionList", {
	...
	getControllerName : function() {
		return "ZUI5_HR_Deduction.ZUI5_HR_DeductionList";
	},
	...
	createContent : function(oController) {
		...
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			showHeader : false,
			content : sap.ui.jsfragment("ZUI5_HR_Deduction.fragment.DeductionPage01",oController)
