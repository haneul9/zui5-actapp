...
sap.ui.jsfragment("ZUI5_HR_SickLeave.fragment.SickLeavePage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "15%"},	// 39:소속부서
		{id: "Aptxt", label : oBundleText.getText("LABEL_0929"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 929:병가
		{id: "Period", label : oBundleText.getText("LABEL_1204"), plabel : "", span : 0, type : "listText", sort : true, filter : true },	// 1204:기간
		{id: "Useday", label : oBundleText.getText("LABEL_0918"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "5%"},	// 918:사용일수
		{id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "5%"},	// 49:신청일
		{id: "ZappDate", label : oBundleText.getText("LABEL_0070"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "5%"},	// 70:최종결재일
		{id: "Docyn", label : oBundleText.getText("LABEL_0069"), plabel : "", span : 0, type : "ptifile", sort : true, filter : true, width : "3%"},	// 69:첨부
