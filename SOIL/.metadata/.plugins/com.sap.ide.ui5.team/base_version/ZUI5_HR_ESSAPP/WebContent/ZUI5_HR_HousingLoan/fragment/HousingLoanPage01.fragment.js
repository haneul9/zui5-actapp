...
sap.ui.jsfragment("ZUI5_HR_HousingLoan.fragment.HousingLoanPage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 39:소속부서
		{id: "Louset", label : oBundleText.getText("LABEL_0087"), plabel : "", span : 0, type : "listText", sort : true, filter : true},	// 87:용도
		{id: "Apamt", label : oBundleText.getText("LABEL_0081"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "9%", align : sap.ui.core.TextAlign.End},	// 81:신청금액
		{id: "Lnhym", label : oBundleText.getText("LABEL_0098"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 98:융자희망월
		{id: "Zform", label : oBundleText.getText("LABEL_0093"), plabel : "", span : 0, type : "listloan2", sort : true, filter : true, width : "6%"},	// 93:대출신청서
		{id: "Lnprt", label : oBundleText.getText("LABEL_0094"), plabel : "", span : 0, type : "listloan", sort : true, filter : true, width : "6%"},	// 94:대출확인서
		{id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"},	// 49:신청일
		{id: "ZappDate", label : oBundleText.getText("LABEL_0070"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"},	// 70:최종결재일
		{id: "Attachyn", label : oBundleText.getText("LABEL_0069"), plabel : "", span : 0, type : "file", sort : true, filter : true, width : "4%"},	// 69:첨부
		{id: "ZListComment", label : oBundleText.getText("LABEL_0072"), plabel : "", span : 0, type : "commentpopover", sort : true, filter : true, width : "7%"}	// 72:담당자의견
	],
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({text : oBundleText.getText("LABEL_0103") }).addStyleClass("Font18px FontColor0"),	// 103:주택자금 신청
