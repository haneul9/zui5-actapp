...
sap.ui.jsview("ZUI5_HR_HousingLoan.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_HousingLoan.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_HousingLoan.ZUI5_HR_HousingLoanList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_HousingLoan.ZUI5_HR_HousingLoanList", "ZUI5_HR_HousingLoan.ZUI5_HR_HousingLoanList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0103"),	// 103:주택자금 신청
			showLogout : false,
			app : this.app,
