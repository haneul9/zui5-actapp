...
sap.ui.jsview("ZUI5_HR_InfantCare.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_InfantCare.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_InfantCare.ZUI5_HR_InfantCareList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_InfantCare.ZUI5_HR_InfantCareList", "ZUI5_HR_InfantCare.ZUI5_HR_InfantCareList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0133"),	// 133:영유아 보육지원 신청	
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_CHILD_CARE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_CHILD_CARE_SRV");
