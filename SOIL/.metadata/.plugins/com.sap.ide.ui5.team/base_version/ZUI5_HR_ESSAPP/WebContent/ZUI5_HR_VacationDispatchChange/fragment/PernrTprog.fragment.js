sap.ui.jsfragment("ZUI5_HR_VacationDispatchChange.fragment.PernrTprog", {
	...
	createContent : function(oController) {
		...
		var tprogColModel = [
			...
			{id: "Ttext", label : oBundleText.getText("LABEL_0006"), plabel : "", span : 0, type : "string", sort : true, filter : true}
		];
		...
		var oTprogDialog = new sap.m.Dialog(oController.PAGEID + "_PernrTprogDialog", {
			...
			contentWidth : "800px",
			showHeader : true,
			title : oBundleText.getText("LABEL_0006"),
