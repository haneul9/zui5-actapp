...
sap.ui.controller("ZUI5_HR_VacationDispatchChange.ZUI5_HR_VacationDispatchChangeList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_VacationDispatchChange.ZUI5_HR_VacationDispatchChangeList
	 */

	PAGEID : "ZUI5_HR_VacationDispatchChangeList",
	...
	onPressNew : function(oEvent){
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_VacationDispatchChange.ZUI5_HR_VacationDispatchChangeDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_VacationDispatchChange.ZUI5_HR_VacationDispatchChangeList");
	...
	onPressSearch : function(oEvent){
		...
		function Search() {
			...
			oModel.read("/ChangeDispatchLeaveSet", {
				async : false,
				filters : aFilters,
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_2291") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2291:파견직 근태 변경/취소 신청
			};
