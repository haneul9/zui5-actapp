...
sap.ui.jsview("ZUI5_HR_VacationDispatchChange.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_VacationDispatchChange.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_VacationDispatchChange.ZUI5_HR_VacationDispatchChangeList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_VacationDispatchChange.ZUI5_HR_VacationDispatchChangeList", "ZUI5_HR_VacationDispatchChange.ZUI5_HR_VacationDispatchChangeList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2291"),	// 2291:파견직 근태 변경/취소 신청
			showLogout : false,
			app : this.app,
