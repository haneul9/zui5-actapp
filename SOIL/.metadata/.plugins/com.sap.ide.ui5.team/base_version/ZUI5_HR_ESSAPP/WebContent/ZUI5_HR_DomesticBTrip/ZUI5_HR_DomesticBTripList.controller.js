...
sap.ui.controller("ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripList
	 */

	PAGEID : "ZUI5_HR_DomesticBTripList",
	...
	onPressNew1 : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripDetail",
		      data : {Appno : "", ZreqForm : "HR04"}
		});	
	},
	// 신규신청 로직(영문)
	onPressNew2 : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripDetail",
		      data : {Appno : "", ZreqForm : "HR05"}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_DomesticBTrip.ZUI5_HR_DomesticBTripList");
		...
		if(oModel.getProperty(vContext.sPath + "/ZreqForm") == "HR05"){
			vLang = "EN"
		}
		oBundleText = jQuery.sap.resources({
			url : "/sap/bc/ui5_ui5/sap/ZUI5_HR_COMMON/translation/i18n.properties" + surfix, //번역파일 주소
	...
	onPressSearch : function(oEvent){
		...
		aFilters.push(new sap.ui.model.Filter('Subty', sap.ui.model.FilterOperator.EQ, '1'));
		if(SerchCond.Begtr != "") {
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1203") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1203:국내출장명령 신청
			};
