...
sap.ui.jsview("ZUI5_HR_ResignationInterview.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ResignationInterview.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ResignationInterview.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ResignationInterview.ZUI5_HR_ResignationInterviewList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ResignationInterview.ZUI5_HR_ResignationInterviewList", "ZUI5_HR_ResignationInterview.ZUI5_HR_ResignationInterviewList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0393"),	// 393:퇴직자 면접표 작성
			showLogout : false,
			app : this.app,
