...
sap.ui.jsfragment("ZUI5_HR_ResignationInterview.fragment.ResignationInterviewPage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0381"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "7%", align : sap.ui.core.TextAlign.Begin},	// 381:조직
		...
		{id: "Reret", label : oBundleText.getText("LABEL_0377"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"},	// 377:사직 신청일
		{id: "Reqdt", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"},	// 49:신청일
		{id: "Zrestt", label : oBundleText.getText("LABEL_0390"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "7%"},	// 390:작성상태
		{id: "Mgrnm", label : oBundleText.getText("LABEL_0373"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "7%"},	// 373:면접자
		{id: "Mgrdt", label : oBundleText.getText("LABEL_0380"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"},	// 380:작성일
		{id: "ZappDate", label : oBundleText.getText("LABEL_0107"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"}	// 107:결재일
	],
