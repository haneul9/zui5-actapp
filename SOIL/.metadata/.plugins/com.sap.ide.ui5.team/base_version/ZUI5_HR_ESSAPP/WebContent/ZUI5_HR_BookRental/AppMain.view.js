...
sap.ui.jsview("ZUI5_HR_BookRental.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_BookRental.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_BookRental.ZUI5_HR_BookRentalList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_BookRental.ZUI5_HR_BookRentalList", "ZUI5_HR_BookRental.ZUI5_HR_BookRentalList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1699"),	// 1699:도서 신청
			showLogout : false,
			app : this.app,
