...
sap.ui.jsfragment("ZUI5_HR_WorkScheduleType.fragment.WorkScheduleTypePage01", {
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_0505")	// 505:근무형태별근무일정조회
	...
	getFilterLayoutRender : function(oController) {
		...
		return new sap.m.Toolbar({
			...
			content : [
				...
				new sap.m.ToolbarSpacer({width : "20px"}),
				new sap.m.Text({
					text : oBundleText.getText("LABEL_0008")	// 8:근무일정규칙
				}).addStyleClass("Font14px FontBold"),
				new sap.m.ToolbarSpacer({width : "10px"}),
				new sap.m.ComboBox({
					width : "230px",
					...
					selectedKey : "{Schkz}",
					items : {
						path: "ZHR_WORKSCHDULE_SRV>/SchkzCodeList2Set",
						template: new sap.ui.core.ListItem({
							key: "{ZHR_WORKSCHDULE_SRV>Schkz}",
							text: "{ZHR_WORKSCHDULE_SRV>Rtext}"
						})
					}
				}).addStyleClass("Font14px FontColor6"),
				new sap.m.ToolbarSpacer(),
