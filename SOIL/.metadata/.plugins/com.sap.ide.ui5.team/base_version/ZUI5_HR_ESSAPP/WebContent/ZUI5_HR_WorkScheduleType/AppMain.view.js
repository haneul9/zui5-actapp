...
sap.ui.jsview("ZUI5_HR_WorkScheduleType.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorkScheduleType.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorkScheduleType.ZUI5_HR_WorkScheduleTypeList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorkScheduleType.ZUI5_HR_WorkScheduleTypeList", "ZUI5_HR_WorkScheduleType.ZUI5_HR_WorkScheduleTypeList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0505"),	// 505:근무형태별근무일정조회
			showLogout : false,
			app : this.app,
