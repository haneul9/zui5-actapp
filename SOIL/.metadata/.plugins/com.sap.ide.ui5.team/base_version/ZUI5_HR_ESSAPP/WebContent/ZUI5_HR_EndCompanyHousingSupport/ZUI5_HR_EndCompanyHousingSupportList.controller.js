...
sap.ui.controller("ZUI5_HR_EndCompanyHousingSupport.ZUI5_HR_EndCompanyHousingSupportList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_EndCompanyHousingSupport.ZUI5_HR_EndCompanyHousingSupportList
	 */

	PAGEID : "ZUI5_HR_EndCompanyHousingSupportList",
...
//		oController._RegnoCheckDialog.close();
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_EndCompanyHousingSupport.ZUI5_HR_EndCompanyHousingSupportDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_EndCompanyHousingSupport.ZUI5_HR_EndCompanyHousingSupportList");
		var oController = oView.getController();		
	...
	onPressSearch : function(oEvent){
		...
		aFilters.push(new sap.ui.model.Filter('Begbn', sap.ui.model.FilterOperator.EQ, "E"));
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_0361") + "-" + dateFormat.format(curDate) + ".xlsx"	// 361:사택지원 종료 신청
			};
