...
sap.ui.jsview("ZUI5_HR_EndCompanyHousingSupport.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_EndCompanyHousingSupport.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_EndCompanyHousingSupport.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_EndCompanyHousingSupport.ZUI5_HR_EndCompanyHousingSupportList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_EndCompanyHousingSupport.ZUI5_HR_EndCompanyHousingSupportList", "ZUI5_HR_EndCompanyHousingSupport.ZUI5_HR_EndCompanyHousingSupportList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0361"),	// 361:사택지원 종료 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_COMPANYHOUSE_HEAD_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_COMPANYHOUSE_HEAD_SRV"); 
