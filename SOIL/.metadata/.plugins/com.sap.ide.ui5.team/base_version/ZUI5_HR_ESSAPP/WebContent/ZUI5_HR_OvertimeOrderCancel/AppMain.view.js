...
sap.ui.jsview("ZUI5_HR_OvertimeOrderCancel.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_OvertimeOrderCancel.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OvertimeOrderCancel.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OvertimeOrderCancel.ZUI5_HR_OvertimeOrderCancelList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OvertimeOrderCancel.ZUI5_HR_OvertimeOrderCancelList", "ZUI5_HR_OvertimeOrderCancel.ZUI5_HR_OvertimeOrderCancelList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0678"),	// 678:특근명령서 취소신청서
			showLogout : false,
			app : this.app,
