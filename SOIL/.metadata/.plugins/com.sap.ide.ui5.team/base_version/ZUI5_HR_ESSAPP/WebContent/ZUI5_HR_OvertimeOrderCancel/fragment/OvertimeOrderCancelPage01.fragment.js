...
sap.ui.jsfragment("ZUI5_HR_OvertimeOrderCancel.fragment.OvertimeOrderCancelPage01", {
	...
	_colModel : [
		...
		{id: "Apperid", label : oBundleText.getText("LABEL_0031"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "80px"},	// 31:사번
		{id: "Apename", label : oBundleText.getText("LABEL_0038"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 38:성명
		{id: "Apzzjiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "150px"},	// 67:직위
		{id: "Aporgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "180px", align : sap.ui.core.TextAlign.Begin},	// 39:소속부서
		{id: "Datum", label : oBundleText.getText("LABEL_0644"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "100px"},	// 644:특근일
		{id: "Atext", label : oBundleText.getText("LABEL_0587"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "160px"},	// 587:특근유형
		{id: "Beguzt", label : oBundleText.getText("LABEL_0631"), plabel : "", span : 0, type : "listtime", sort : true, filter : true, width : "100px"},	// 631:시작시간
		{id: "Enduzt", label : oBundleText.getText("LABEL_0635"), plabel : "", span : 0, type : "listtime", sort : true, filter : true, width : "100px"},	// 635:종료시간
		{id: "Cmrsn", label : oBundleText.getText("LABEL_0676"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "250px"},	// 676:취소사유
