...
sap.ui.jsview("ZUI5_HR_DeviceCertTime.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeviceCertTime.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeviceCertTime.ZUI5_HR_DeviceCertTimeList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeviceCertTime.ZUI5_HR_DeviceCertTimeList", "ZUI5_HR_DeviceCertTime.ZUI5_HR_DeviceCertTimeList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0571"),	// 571:단말기 인증시간 조회
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_TIME_RECORDER_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_TIME_RECORDER_SRV");
