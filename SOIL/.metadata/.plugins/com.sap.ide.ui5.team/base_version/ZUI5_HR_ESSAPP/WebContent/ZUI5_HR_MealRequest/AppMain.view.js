...
sap.ui.jsview("ZUI5_HR_MealRequest.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_MealRequest.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_MealRequest.ZUI5_HR_MealRequestList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_MealRequest.ZUI5_HR_MealRequestList", "ZUI5_HR_MealRequest.ZUI5_HR_MealRequestList"));
	...
	loadModel : function() {
		...
		var oServiceURL3 = this.getUrl("/sap/opu/odata/sap/ZHR_MEALREQUEST_SRV/");
		...
		sap.ui.getCore().setModel(oModel3, "ZHR_MEALREQUEST_SRV"); 		
