...
sap.ui.jsfragment("ZUI5_HR_Portal.fragment.TotalRewardDashbordM", {
	...
	createContent : function(oController) {
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content :  new sap.m.Text({text : "(조직)" , textAlign : "Center"}).addStyleClass("Font20px FontColor6"),
			hAlign : "Center"
		});
		oRow.addCell(oCell);
		oMatrixLayout.addRow(oRow);
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Image({
						src : "/sap/bc/ui5_ui5/sap/zui5_hr_common/images/Main_icon_Reward2.png",
						height : "120px"
			  }),
		...
		var oMainMatrixLayout = new sap.ui.commons.layout.MatrixLayout({
			...
			common.Password.openPasswordDialog(oController, "H_ZP02");
