...
sap.ui.jsview("ZUI5_HR_RetiredAmtDisplay.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_RetiredAmtDisplay.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_RetiredAmtDisplay.ZUI5_HR_RetiredAmtDisplayList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_RetiredAmtDisplay.ZUI5_HR_RetiredAmtDisplayList", "ZUI5_HR_RetiredAmtDisplay.ZUI5_HR_RetiredAmtDisplayList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0747"),	// 747:퇴직 추계액 조회
			showLogout : false,
			app : this.app,
