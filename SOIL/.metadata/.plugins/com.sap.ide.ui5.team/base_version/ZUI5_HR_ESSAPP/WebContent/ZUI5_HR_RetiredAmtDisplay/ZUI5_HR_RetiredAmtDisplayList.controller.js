...
sap.ui.controller("ZUI5_HR_RetiredAmtDisplay.ZUI5_HR_RetiredAmtDisplayList", {
	/**
	...
	PAGEID : "ZUI5_HR_RetiredAmtDisplayList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data") || oController._ListCondJSonModel.getProperty("/Data").length < 1) {			
			...
			var JSonData = { Data : { Begda : dateFormat.format(prevDate) , Endda : dateFormat.format(begDate), Pernr : vPernr, Ename : vEname }};
	...
	onPressSearch : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_RetiredAmtDisplay.ZUI5_HR_RetiredAmtDisplayList"),
		...
		if(!SerchCond.Pernr) {
			...
			sap.m.MessageBox.alert(oBundleText.getText("LABEL_1040"),{});	// 1040:사번을 입력하여 주시기 바랍니다.
			return; 
		}
...
//			oController = oView.getController();
	...
	onExport : function(oEvent){
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0747") + "-" + dateFormat.format(curDate) + ".xlsx"	// 747:퇴직 추계액 조회
		};
