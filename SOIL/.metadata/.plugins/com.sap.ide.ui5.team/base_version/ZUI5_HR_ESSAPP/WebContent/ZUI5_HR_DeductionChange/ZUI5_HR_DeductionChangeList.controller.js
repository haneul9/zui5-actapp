...
sap.ui.controller("ZUI5_HR_DeductionChange.ZUI5_HR_DeductionChangeList", {
	/**
	...
	PAGEID : "ZUI5_HR_DeductionChangeList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data") || oController._ListCondJSonModel.getProperty("/Data").length < 1) {			
			...
			var JSonData = { Data : { Apbeg : dateFormat.format(prevDate) , Apend : dateFormat.format(curDate) , Pernr : vPernr, Ename : vEname, Dpernr : "", Dename : "" }};
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_DeductionChange.ZUI5_HR_DeductionChangeList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_DeductionChange.ZUI5_HR_DeductionChangeDetail",
			data : { Appno : _Appno }
		});
	},
	...
	onPressSearch : function(oEvent) {
		...
		if(SerchCond.Dpernr != "") {
			aFilters.push(new sap.ui.model.Filter('Dpernr', sap.ui.model.FilterOperator.EQ, SerchCond.Dpernr));
		}
...
//			oController = oView.getController();
	...
	onExport : function(oEvent){
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0512") + "-" + dateFormat.format(curDate) + ".xlsx"	// 512:변동공제 신청
		};
