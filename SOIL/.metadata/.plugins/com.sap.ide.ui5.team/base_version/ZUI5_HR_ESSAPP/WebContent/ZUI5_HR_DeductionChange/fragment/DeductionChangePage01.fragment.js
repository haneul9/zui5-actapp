...
sap.ui.jsfragment("ZUI5_HR_DeductionChange.fragment.DeductionChangePage01", {
	...
	_colModel : [
		...
		{id: "Dename", label : oBundleText.getText("LABEL_0507"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "120px"},	// 507:공제발생자
		{id: "Dorgtx", label : oBundleText.getText("LABEL_0509"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "180px", align : sap.ui.core.TextAlign.Begin},	// 509:공제발생자소속
	...
	getFilterLayoutRender : function(oController) {
		...
		return new sap.m.Toolbar({
			...
			content : [
				...
				new sap.m.ToolbarSpacer({width : "20px"}),
				new sap.m.Text({
					text : oBundleText.getText("LABEL_0508")	// 508:공제발생자 성명
				}).addStyleClass("Font14px FontBold"),
				new sap.m.ToolbarSpacer({width : "10px"}),
				new sap.m.Input(oController.PAGEID + "_Dename", {
					width : "150px",
					showValueHelp: true,
					valueHelpOnly: false,
					value : "{Dename}",
					customData : new sap.ui.core.CustomData({key : "Dpernr", value : "{Dpernr}"}),
					change : oController.EmpSearchByTx,
					valueHelpRequest: oController.displayEmpSearchDialog
				}).addStyleClass("Font14px FontColor6"),
				new sap.m.ToolbarSpacer(),
