...
sap.ui.jsview("ZUI5_HR_OvertimeOrder.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_OvertimeOrder.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OvertimeOrder.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OvertimeOrder.ZUI5_HR_OvertimeOrderList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OvertimeOrder.ZUI5_HR_OvertimeOrderList", "ZUI5_HR_OvertimeOrder.ZUI5_HR_OvertimeOrderList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0642"),	// 642:특근명령서
			showLogout : false,
			app : this.app,
