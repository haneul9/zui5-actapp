...
sap.ui.controller("ZUI5_HR_OvertimeOrder.ZUI5_HR_OvertimeOrderList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_OvertimeOrder.ZUI5_HR_OvertimeOrderList
	 */

	PAGEID : "ZUI5_HR_OvertimeOrderList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_OvertimeOrder.ZUI5_HR_OvertimeOrderList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_OvertimeOrder.ZUI5_HR_OvertimeOrderDetail",
			data : { Appno : _Appno }
		});
	},
...
//			}
	...
	onExport : function(oEvent) {
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0642") + "-" + dateFormat.format(curDate) + ".xlsx"	// 642:특근명령서
			};
