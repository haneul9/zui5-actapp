...
sap.ui.jsview("ZUI5_HR_Smock.AppMain", {
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Smock.ZUI5_HR_SmockList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Smock.ZUI5_HR_SmockList", "ZUI5_HR_Smock.ZUI5_HR_SmockList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0194"),	// 194:방염 작업복 신청
			showLogout : false,
			app : this.app,
