...
sap.ui.controller("ZUI5_HR_PregnancyRegistration.ZUI5_HR_PregnancyRegistrationList", {
	/**
	...
	PAGEID : "ZUI5_HR_PregnancyRegistrationList",
	...
	onPressRegCheck : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_PregnancyRegistration.ZUI5_HR_PregnancyRegistrationList");
	...
	onPressNew : function(oEvent){
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_PregnancyRegistration.ZUI5_HR_PregnancyRegistrationDetail",
		      data : {Appno : ""}
		});	
	},
	...
	onPressSearch : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_PregnancyRegistration.ZUI5_HR_PregnancyRegistrationList"),
			...
			oModel = sap.ui.getCore().getModel("ZHR_PREGNANT_REGI_SRV"),
...
//			}
	...
	onESSelectPerson : function(oEvent) {
		...
		if(vEmpSearchResult && vEmpSearchResult.length > 0 ) {
			...
			oController._ListCondJSonModel.setProperty("/Data/Ename", mEmpSearchResult.getProperty(_selPath + "/Encid"));
	...
	onExport : function(oEvent){
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0146") + "-" + dateFormat.format(curDate) + ".xlsx"	// 146:임신직원 등록 신청
			};
