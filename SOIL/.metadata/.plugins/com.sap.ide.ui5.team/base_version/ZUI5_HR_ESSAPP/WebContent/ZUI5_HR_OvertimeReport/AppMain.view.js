...
sap.ui.jsview("ZUI5_HR_OvertimeReport.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OvertimeReport.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OvertimeReport.ZUI5_HR_OvertimeReportList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OvertimeReport.ZUI5_HR_OvertimeReportList", "ZUI5_HR_OvertimeReport.ZUI5_HR_OvertimeReportList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2864"),	// 2864:특근조회(개인별)
			showLogout : false,
			app : this.app,
