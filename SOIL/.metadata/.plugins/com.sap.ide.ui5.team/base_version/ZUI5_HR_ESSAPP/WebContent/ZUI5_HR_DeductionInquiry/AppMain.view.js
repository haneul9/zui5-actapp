...
sap.ui.jsview("ZUI5_HR_DeductionInquiry.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZUI5_HR_DeductionInquiry.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeductionInquiry.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeductionInquiry.ZUI5_HR_DeductionInquiryList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeductionInquiry.ZUI5_HR_DeductionInquiryList", "ZUI5_HR_DeductionInquiry.ZUI5_HR_DeductionInquiryList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0492"),	// 492:고정 공제항목 조회
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_DEDUCT_MNG_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_DEDUCT_MNG_SRV");
