...
sap.ui.jsview("ZUI5_HR_FamilyCareLeave.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_FamilyCareLeave.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_FamilyCareLeave.ZUI5_HR_FamilyCareLeaveList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_FamilyCareLeave.ZUI5_HR_FamilyCareLeaveList", "ZUI5_HR_FamilyCareLeave.ZUI5_HR_FamilyCareLeaveList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2970"),	// 2970:가족돌봄휴직 신청
			showLogout : false,
			app : this.app,
