...
common.baseAppController("ZUI5_HR_DeductionChangeIndvDisplay.AppMain", {
	
	onInit : function () {		
		// Any of the strings can be replaced with a function, that returns a string
		var oAppConfig = {
				
				defaultPageId : "ZUI5_HR_DeductionChangeIndvDisplay.ZUI5_HR_DeductionChangeIndvDisplayList",
