...
sap.ui.controller("ZUI5_HR_VacationDispatch.ZUI5_HR_VacationDispatchList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_VacationDispatch.ZUI5_HR_VacationDispatchList
	 */

	PAGEID : "ZUI5_HR_VacationDispatchList",
	...
	onPressNew : function(oEvent){
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_VacationDispatch.ZUI5_HR_VacationDispatchDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_VacationDispatch.ZUI5_HR_VacationDispatchList");
	...
	onPressSearch : function(oEvent){
		...
		function Search() {
			...
			oModel.read("/DispatchLeaveListSet", {
				async : false,
				filters : aFilters,
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_2293") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2293:파견직 근태 신청
			};
