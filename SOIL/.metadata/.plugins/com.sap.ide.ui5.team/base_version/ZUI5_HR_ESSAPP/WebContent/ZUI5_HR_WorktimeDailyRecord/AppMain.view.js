...
sap.ui.jsview("ZUI5_HR_WorktimeDailyRecord.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorktimeDailyRecord.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorktimeDailyRecord.ZUI5_HR_WorktimeDailyRecordList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorktimeDailyRecord.ZUI5_HR_WorktimeDailyRecordList", "ZUI5_HR_WorktimeDailyRecord.ZUI5_HR_WorktimeDailyRecordList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0730"),	// 730:일별근태기록부 조회(부서장)
			showLogout : false,
			app : this.app,
