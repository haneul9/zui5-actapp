...
sap.ui.jsview("ZUI5_HR_OvertimeConfirm.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_OvertimeConfirm.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OvertimeConfirm.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OvertimeConfirm.ZUI5_HR_OvertimeConfirmList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OvertimeConfirm.ZUI5_HR_OvertimeConfirmList", "ZUI5_HR_OvertimeConfirm.ZUI5_HR_OvertimeConfirmList"));
