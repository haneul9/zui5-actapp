...
sap.ui.jsfragment("ZUI5_HR_OvertimeConfirm.fragment.OvertimeConfirmPage01", {
	...
	_colModel : [
		...
		{id: "Apperid", label : oBundleText.getText("LABEL_0031"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 31:사번
		{id: "Apename", label : oBundleText.getText("LABEL_0038"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 38:성명
		{id: "Apzzjiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 67:직위
		{id: "Aporgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "12%", align : sap.ui.core.TextAlign.Begin},	// 39:소속부서
		{id: "Datum", label : oBundleText.getText("LABEL_0644"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "6%"},	// 644:특근일
		{id: "Atext", label : oBundleText.getText("LABEL_0587"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 587:특근유형
		{id: "Beguzt", label : oBundleText.getText("LABEL_0631"), plabel : "", span : 0, type : "listtime", sort : true, filter : true, width : "4%"},	// 631:시작시간
		{id: "Enduzt", label : oBundleText.getText("LABEL_0635"), plabel : "", span : 0, type : "listtime", sort : true, filter : true, width : "4%"},	// 635:종료시간
		{id: "Tmrsn", label : oBundleText.getText("LABEL_0641"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%", align : sap.ui.core.TextAlign.Begin},	// 641:특근내역
		...
		{id: "ZListComment", label : oBundleText.getText("LABEL_0072"), plabel : "", span : 0, type : "commentpopover3", sort : true, filter : true, width : "17%", align : sap.ui.core.TextAlign.Begin}	// 72:담당자의견
	],
	...
	getFilterLayoutRender : function(oController) {
		...
		return new sap.m.Toolbar({
			...
			content : [
				...
				new sap.m.Text({
					text : oBundleText.getText("LABEL_0639")	// 639:특근 시작일
				...
				new sap.m.ToolbarSpacer({width : "20px"}),
				new sap.m.Text({
					text : oBundleText.getText("LABEL_0640")	// 640:특근 종료일
				}).addStyleClass("Font14px FontBold"),
				new sap.m.ToolbarSpacer({width : "10px"}),
