...
sap.ui.jsview("ZUI5_HR_WorktimePostConfirm.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_WorktimePostConfirm.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorktimePostConfirm.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorktimePostConfirm.ZUI5_HR_WorktimePostConfirmList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorktimePostConfirm.ZUI5_HR_WorktimePostConfirmList", "ZUI5_HR_WorktimePostConfirm.ZUI5_HR_WorktimePostConfirmList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0877"),	// 877:근무시간 사후확인서
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_WORKTIME_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_WORKTIME_SRV"); 
