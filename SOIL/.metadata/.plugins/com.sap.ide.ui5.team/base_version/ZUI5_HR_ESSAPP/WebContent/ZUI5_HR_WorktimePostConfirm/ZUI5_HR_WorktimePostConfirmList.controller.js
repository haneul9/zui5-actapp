...
sap.ui.controller("ZUI5_HR_WorktimePostConfirm.ZUI5_HR_WorktimePostConfirmList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_WorktimePostConfirm.ZUI5_HR_WorktimePostConfirmList
	 */

	PAGEID : "ZUI5_HR_WorktimePostConfirmList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_WorktimePostConfirm.ZUI5_HR_WorktimePostConfirmList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_WorktimePostConfirm.ZUI5_HR_WorktimePostConfirmDetail",
			data : { Appno : _Appno }
		});
	},
				...
				success: function(data,res) {
					if(data && data.results.length) {
						for(var i=0; i<data.results.length; i++) {
							...
							// 담당자 의견 
							OneData.Symptn = OneData.ZappResn;
							OneData.ZappResn = "";
...
//			}
	...
	onExport : function(oEvent) {
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0877") + "-" + dateFormat.format(curDate) + ".xlsx"	// 877:근무시간 사후확인서
			};
