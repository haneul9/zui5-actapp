sap.ui.jsfragment("ZUI5_HR_Manpower.fragment.Detail09", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var col_info1 = [
			{id: "Grouptx", label : oBundleText.getText("LABEL_0300"), plabel : oBundleText.getText("LABEL_0300"), span : 0, type : "string2", sort : false, filter : false, width : "20%"},	// 300:구분
			 {id: "Subgrtx", label : oBundleText.getText("LABEL_0067"), plabel : oBundleText.getText("LABEL_0067"), span : 0, type : "string", sort : false, filter : false, width : "6%"},	// 67:직위
			 ...
			 {id: "Zatyr1", label : oBundleText.getText("LABEL_0700"), plabel : oBundleText.getText("LABEL_2702"), span : 2, type : "string", sort : false, filter : false, width : "5%"},	// 700:근무기간, 2702:1년이상
			 {id: "Zatyr2", label : "", plabel : oBundleText.getText("LABEL_2703"), span : 0, type : "string", sort : false, filter : false, width : "5%"}	// 2703:1년미만
						 ];
