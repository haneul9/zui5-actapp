...
sap.ui.jsview("ZUI5_HR_ChangeShift.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ChangeShift.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ChangeShift.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ChangeShift.ZUI5_HR_ChangeShiftList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ChangeShift.ZUI5_HR_ChangeShiftList", "ZUI5_HR_ChangeShift.ZUI5_HR_ChangeShiftList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0011"),	// 근무편제변경 신청
			showLogout : false,
			app : this.app,
