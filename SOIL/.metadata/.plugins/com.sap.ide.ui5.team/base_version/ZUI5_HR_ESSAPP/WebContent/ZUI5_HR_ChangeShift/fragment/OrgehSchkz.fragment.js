sap.ui.jsfragment("ZUI5_HR_ChangeShift.fragment.OrgehSchkz", {
...
//			columnHeaderHeight : 35,
		...
		oTable.addEventDelegate({
			onAfterRendering: function() {
				var oTable = sap.ui.getCore().byId("ZUI5_HR_ChangeShiftDetail_OrgehTable");
		...
		var colModel = [
			...
			{id: "Begda", label : oBundleText.getText("LABEL_0042"), plabel : "", span : 0, type : "date", sort : true, filter : false, width : "10%"},	// 42:시작일
			{id: "Endda", label : oBundleText.getText("LABEL_0065"), plabel : "", span : 0, type : "date", sort : true, filter : false, width : "10%"}	// 65:종료일
		];
