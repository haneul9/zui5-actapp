...
sap.ui.jsfragment("ZUI5_HR_ChangeShift.fragment.ChangeShiftPage01", {
	...
	_colModel : [
		...
		{id: "Zzjiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "9%"},	// 67:직위
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "14%"},	// 39:소속부서
		{id: "Datum", label : oBundleText.getText("LABEL_0062"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "6%"},	// 62:적용일
		{id: "Tagper", label : oBundleText.getText("LABEL_0018"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : sap.ui.core.TextAlign.Begin},	// 대상인원
		{id: "Apename", label : oBundleText.getText("LABEL_0050"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 50:신청자
		...
		{id: "Docyn", label : oBundleText.getText("LABEL_0069"), plabel : "", span : 0, type : "ptifile", sort : true, filter : true, width : "6%"}	// 69:첨부
	],
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({text : oBundleText.getText("LABEL_0011") }).addStyleClass("Font18px FontColor0"),	// 11:근무편제변경 신청
