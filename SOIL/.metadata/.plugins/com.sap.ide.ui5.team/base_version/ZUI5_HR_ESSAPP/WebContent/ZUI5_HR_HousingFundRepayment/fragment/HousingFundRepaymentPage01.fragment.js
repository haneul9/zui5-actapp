...
sap.ui.jsfragment("ZUI5_HR_HousingFundRepayment.fragment.HousingFundRepaymentPage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 39:소속부서
		{id: "Paymm", label : oBundleText.getText("LABEL_0410"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "8%"},	// 410:대출지급일
		{id: "LnamtSum", label : oBundleText.getText("LABEL_0409"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%", align : sap.ui.core.TextAlign.End},	// 409:대출원금
		{id: "Lmdat", label : oBundleText.getText("LABEL_0418"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "8%"},	// 418:일시상환일
		{id: "MrpprSum", label : oBundleText.getText("LABEL_0417"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%", align : sap.ui.core.TextAlign.End},	// 417:일시상환금액
		{id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "8%"},	// 49:신청일
		{id: "ZappDate", label : oBundleText.getText("LABEL_0107"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "8%"},	// 107:결재일
		{id: "ZListComment", label : oBundleText.getText("LABEL_0072"), plabel : "", span : 0, type : "commentpopover", sort : true, filter : true, width : "8%"}	// 72:담당자의견
	],
