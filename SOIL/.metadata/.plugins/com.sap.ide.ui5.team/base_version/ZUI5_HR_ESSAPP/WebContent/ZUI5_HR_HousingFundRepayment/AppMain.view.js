...
sap.ui.jsview("ZUI5_HR_HousingFundRepayment.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZUI5_HR_HousingFundRepayment.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_HousingFundRepayment.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_HousingFundRepayment.ZUI5_HR_HousingFundRepaymentList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_HousingFundRepayment.ZUI5_HR_HousingFundRepaymentList", "ZUI5_HR_HousingFundRepayment.ZUI5_HR_HousingFundRepaymentList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0420"),	// 420:주택자금 중도상환 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_LIFE_LOAN_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_LIFE_LOAN_SRV");
