...
sap.ui.jsview("ZUI5_HR_CommuteRecordRetireGroup.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_CommuteRecordRetireGroup.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_CommuteRecordRetireGroup.ZUI5_HR_CommuteRecordRetireGroupList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_CommuteRecordRetireGroup.ZUI5_HR_CommuteRecordRetireGroupList", "ZUI5_HR_CommuteRecordRetireGroup.ZUI5_HR_CommuteRecordRetireGroupList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0916"),	// 916:퇴직자근태기록부확인(부서장)
			showLogout : false,
			app : this.app,
