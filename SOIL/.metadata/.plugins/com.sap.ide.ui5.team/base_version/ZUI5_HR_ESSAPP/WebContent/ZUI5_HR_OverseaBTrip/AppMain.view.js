...
sap.ui.jsview("ZUI5_HR_OverseaBTrip.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OverseaBTrip.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OverseaBTrip.ZUI5_HR_OverseaBTripList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OverseaBTrip.ZUI5_HR_OverseaBTripList", "ZUI5_HR_OverseaBTrip.ZUI5_HR_OverseaBTripList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1234"),	// 1234:해외출장명령 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_BUSITRIP_INT_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_BUSITRIP_INT_SRV"); 
