...
sap.ui.jsview("ZUI5_HR_LicenseResistration.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_LicenseResistration.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_LicenseResistration.ZUI5_HR_LicenseResistrationList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_LicenseResistration.ZUI5_HR_LicenseResistrationList", "ZUI5_HR_LicenseResistration.ZUI5_HR_LicenseResistrationList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_3013"),	// 3013:자격/면허등록 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_LISENCE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_LISENCE_SRV"); 
