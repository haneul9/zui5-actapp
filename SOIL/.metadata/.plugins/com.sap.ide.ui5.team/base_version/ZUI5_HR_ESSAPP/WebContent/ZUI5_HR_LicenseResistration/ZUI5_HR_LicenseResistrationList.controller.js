...
sap.ui.controller("ZUI5_HR_LicenseResistration.ZUI5_HR_LicenseResistrationList", {
	/**
	...
	PAGEID : "ZUI5_HR_LicenseResistrationList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data")){
			...
			var JSonData = {Data : {Apbeg : dateFormat.format(prevDate), Apend : dateFormat.format(curDate), Ename : vEname, Encid : vEncid,  Auth : _gAuth}};
	...
	onPressNew : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_LicenseResistration.ZUI5_HR_LicenseResistrationList");
		var oController = oView.getController();
		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_LicenseResistration.ZUI5_HR_LicenseResistrationDetail",
			data : {Appno : ""}
		});	
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_3013") + "-" + dateFormat.format(curDate) + ".xlsx"	// 3013:자격/면허등록 신청
			};
