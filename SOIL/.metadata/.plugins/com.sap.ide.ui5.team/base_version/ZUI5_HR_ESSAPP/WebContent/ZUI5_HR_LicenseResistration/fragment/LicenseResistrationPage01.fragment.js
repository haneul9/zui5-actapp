sap.ui.jsfragment("ZUI5_HR_LicenseResistration.fragment.LicenseResistrationPage01", {
	...
	_colModel : [
		 ...
		 {id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "14%", align : "Begin"},	// 39:소속부서
		 {id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "9%"},	// 49:신청일
		 {id: "Cttypt", label : oBundleText.getText("LABEL_3014"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "14%"},	// 3014:자격/면허
		 {id: "Ctgrdt", label : oBundleText.getText("LABEL_0242"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 242:등급
		 {id: "Isautt", label : oBundleText.getText("LABEL_3015"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "12%"},	// 3015:발급기관
		 {id: "ZappDate", label : oBundleText.getText("LABEL_0186"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "9%"}	// 186:담당자 확인일자
	],
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							...
							content : [ 
								...
								new sap.m.Text({
									text : oBundleText.getText("LABEL_3013")	// 3013:자격/면허등록 신청
