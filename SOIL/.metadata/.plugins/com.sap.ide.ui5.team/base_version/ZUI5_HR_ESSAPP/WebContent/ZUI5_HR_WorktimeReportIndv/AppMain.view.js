...
sap.ui.jsview("ZUI5_HR_WorktimeReportIndv.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorktimeReportIndv.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorktimeReportIndv.ZUI5_HR_WorktimeReportIndvList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorktimeReportIndv.ZUI5_HR_WorktimeReportIndvList", "ZUI5_HR_WorktimeReportIndv.ZUI5_HR_WorktimeReportIndvList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0903"),	// 903:근로시간 조회(부서별)
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_WORKHOUR_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_WORKHOUR_SRV");
