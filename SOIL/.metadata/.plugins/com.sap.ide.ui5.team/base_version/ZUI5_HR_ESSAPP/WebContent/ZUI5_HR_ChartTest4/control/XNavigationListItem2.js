// Provides control ZUI5_HR_ChartTest4.control.XNavigationListItem.
sap.ui.define(["jquery.sap.global", "sap/ui/core/Item",
	...
	function(jQuery, Item, Icon, NavigationList, Renderer, IconPool, NavigationListItem, MessageToast, RatingIndicator) {
		...
		var XNavigationListItem = NavigationListItem.extend("ZUI5_HR_ChartTest4.control.XNavigationListItem", /** @lends sap.tnt.NavigationListItem.prototype */ {
			library: "sap.tnt",
			properties: {
				/**
				...
				favoriteyn :  {type : "boolean", group : "Misc", defaultValue : false},
			},
			metadata: {
				defaultAggregation: "xitems",
				aggregations: {
					xitems: {
						type: "ZUI5_HR_ChartTest4.control.XNavigationListItem",
						multiple: true,
						singularName: "item"
					}
				}
			...
			getLevel: function() {
				...
				while (parent && parent.getMetadata().getName() == 'ZUI5_HR_ChartTest4.control.XNavigationListItem') {
					level = level + 1;
...
//			this._renderIcon(rm);
		...
		renderRatingIndicator: function(rm) {
			if (icon) {
