...
sap.ui.controller("ZUI5_HR_HolidayDelegateTask.ZUI5_HR_HolidayDelegateTaskList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_HolidayDelegateTask.ZUI5_HR_HolidayDelegateTaskList
	 */

	PAGEID : "ZUI5_HR_HolidayDelegateTaskList",
	...
	onBeforeShow : function(oEvent) {
		var dateFormat = sap.ui.core.format.DateFormat.getDateTimeInstance({pattern: "yyyy-MM-dd"}),
			...
			endDate = new Date(curDate.getFullYear(), curDate.getMonth()+1 , curDate.getDate()),
		...
		if(!oController._ListCondJSonModel.getProperty("/Data") || oController._ListCondJSonModel.getProperty("/Data").length < 1) {			
			...
			var JSonData = { Data : { Apbeg : dateFormat.format(prevDate) , Apend : dateFormat.format(endDate), Encid : vEncid, Ename : vEname }};
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_HolidayDelegateTask.ZUI5_HR_HolidayDelegateTaskList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_HolidayDelegateTask.ZUI5_HR_HolidayDelegateTaskDetail",
			data : { Appno : _Appno }
		});
	},
...
//			}
	...
	onExport : function(oEvent) {
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0855") + "-" + dateFormat.format(curDate) + ".xlsx"	// 855:휴일대근 신청서
			};
