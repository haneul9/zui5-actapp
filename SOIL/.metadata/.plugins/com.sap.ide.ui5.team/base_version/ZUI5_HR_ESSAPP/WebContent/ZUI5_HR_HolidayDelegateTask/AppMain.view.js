...
sap.ui.jsview("ZUI5_HR_HolidayDelegateTask.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_HolidayDelegateTask.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_HolidayDelegateTask.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_HolidayDelegateTask.ZUI5_HR_HolidayDelegateTaskList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_HolidayDelegateTask.ZUI5_HR_HolidayDelegateTaskList", "ZUI5_HR_HolidayDelegateTask.ZUI5_HR_HolidayDelegateTaskList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0855"),	// 855:휴일대근 신청서
			showLogout : false,
			app : this.app,
