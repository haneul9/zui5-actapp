...
sap.ui.jsview("ZUI5_HR_CommuteRecord.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_CommuteRecord.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_CommuteRecord.ZUI5_HR_CommuteRecordList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_CommuteRecord.ZUI5_HR_CommuteRecordList", "ZUI5_HR_CommuteRecord.ZUI5_HR_CommuteRecordList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0584"),	// 584:출퇴근 기록 조회
			showLogout : false,
			app : this.app,
