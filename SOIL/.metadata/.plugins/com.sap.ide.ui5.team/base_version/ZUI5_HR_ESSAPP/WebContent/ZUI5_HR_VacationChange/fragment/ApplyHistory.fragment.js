sap.ui.jsfragment("ZUI5_HR_VacationChange.fragment.ApplyHistory", {
	...
	_HistoryColModel : [
		...
		{id: "Vcbeg", label : oBundleText.getText("LABEL_0042"), plabel : "", span : 0, type : "date", sort : true, filter : true, width : "120px"},	// 42:시작일
		{id: "Vcend", label : oBundleText.getText("LABEL_0065"), plabel : "", span : 0, type : "date", sort : true, filter : true, width : "120px"},	// 65:종료일
		...
		{id: "Offdut", label : "Off-Duty Day", plabel : "", span : 0, type : "Checkbox5", sort : true, filter : true, width : "150px"},
		{id: "Conchk", label : oBundleText.getText("LABEL_1055"), plabel : "", span : 0, type : "Checkbox5", sort : true, filter : true, width : "80px"},	// 1055:집중휴가
		{id: "Mrdchk", label : "MRD", plabel : "", span : 0, type : "Checkbox5", sort : true, filter : true, width : "80px"},
		{id: "ShiftYn", label : oBundleText.getText("LABEL_1526"), plabel : "", span : 0, type : "Checkbox6", sort : true, filter : true, width : "80px"}	// 1526:교대조
			...
			cells : [
				...
				new sap.ui.commons.layout.MatrixLayoutCell({
					content : new sap.m.Toolbar({
						content : [
							new sap.m.DatePicker(oController.PAGEID +"_ApplyHisotryApbeg",{
						    	valueFormat : "yyyy-MM-dd",
						    	displayFormat : "yyyy.MM.dd",
						    	value : "{Apbeg}",
						    	width : "150px",
						    	change : oController.onChangeApplyHisotryApbeg
						    }).addStyleClass("FontFamily"),
