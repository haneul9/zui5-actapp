...
sap.ui.controller("ZUI5_HR_VacationChange.ZUI5_HR_VacationChangeList", {
	/**
	...
	PAGEID : "ZUI5_HR_VacationChangeList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data")){
			...
			var JSonData = {Data : {Apbeg : dateFormat.format(prevDate), Apend : dateFormat.format(curDate), Zpernr : vPernr, Encid : vEncid, Ename : vEname, Auth : _gAuth}};
	...
	onPressNew : function(oEvent){
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_VacationChange.ZUI5_HR_VacationChangeDetail",
		      data : {Appno : ""}
		});	
	},
	
	onSelectRow : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_VacationChange.ZUI5_HR_VacationChangeList");
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_2358") + "-" + dateFormat.format(curDate) + ".xlsx"	// 2358:휴가 변경/취소 신청
			};
