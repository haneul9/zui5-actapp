...
sap.ui.controller("ZUI5_HR_WorktimeDispatchDailyRecord.ZUI5_HR_WorktimeDispatchDailyRecordList", {
	/**
	...
	PAGEID : "ZUI5_HR_WorktimeDispatchDailyRecordList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data") || oController._ListCondJSonModel.getProperty("/Data").length < 1) {			
			var JSonData = { Data : { Tsmon : dateFormat.format(prevDate), Orgeh : "", Orgtx : "", Tmare : "TMA1", Encid : "", Ename : "" }};
...
//		this.onPressSearch();
	...
	onPressSearch : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_WorktimeDispatchDailyRecord.ZUI5_HR_WorktimeDispatchDailyRecordList"),
		...
		if(!SerchCond.Tsmon || !SerchCond.Tmare) {
			oController._ListJSonModel.setData({Data:[]});
			oTable.setVisibleRowCount(0);
			return;
		}

		aFilters.push(new sap.ui.model.Filter('Dspch', sap.ui.model.FilterOperator.EQ, "X"));
		if(SerchCond.Tsmon != "") {
...
//			oTable.setVisibleRowCount(Datas.Data.length > 15 ? 15 : Datas.Data.length);
			oTable.setVisibleRowCount(Datas.Data.length || 1);
...
//			}
	...
	onAfterOrgehClose : function(oController) {
	...
	onExport : function(oEvent){
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0977") + "-" + dateFormat.format(curDate) + ".xlsx"	// 977:파견직근태기록부조회
		};
