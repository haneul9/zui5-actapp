...
common.baseAppController("ZUI5_HR_WorktimeDispatchDailyRecord.AppMain", {
	
	onInit : function () {		
		// Any of the strings can be replaced with a function, that returns a string
		var oAppConfig = {
				
				defaultPageId : "ZUI5_HR_WorktimeDispatchDailyRecord.ZUI5_HR_WorktimeDispatchDailyRecordList",
