...
sap.ui.jsview("ZUI5_HR_ProductionPromotionEvaluation.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ProductionPromotionEvaluation.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ProductionPromotionEvaluation.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ProductionPromotionEvaluation.ZUI5_HR_ProductionPromotionEvaluationList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ProductionPromotionEvaluation.ZUI5_HR_ProductionPromotionEvaluationList", "ZUI5_HR_ProductionPromotionEvaluation.ZUI5_HR_ProductionPromotionEvaluationList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0937"),	// 937:생산직 승진자 평가
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_TECH_PROMOTION_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_TECH_PROMOTION_SRV");
		...
		var oServiceURL4 = this.getUrl("/sap/opu/odata/sap/ZHR_WORKSCHDULE_SRV/");
		...
		sap.ui.getCore().setModel(oModel4, "ZHR_WORKSCHDULE_SRV");
