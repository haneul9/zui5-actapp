...
sap.ui.controller("ZUI5_HR_ExcWork.ZUI5_HR_ExcWorkList", {
	/**
	...
	onPressNew : function(oEvent){
		var oView = sap.ui.getCore().byId("ZUI5_HR_ExcWork.ZUI5_HR_ExcWorkList");
		var oController = oView.getController();
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_ExcWork.ZUI5_HR_ExcWorkDetail",
		      data : {Appno : ""}
		});	
	},
