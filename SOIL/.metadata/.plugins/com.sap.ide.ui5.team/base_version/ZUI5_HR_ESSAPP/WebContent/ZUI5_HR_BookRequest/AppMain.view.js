...
sap.ui.jsview("ZUI5_HR_BookRequest.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_BookRequest.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_BookRequest.ZUI5_HR_BookRequestList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_BookRequest.ZUI5_HR_BookRequestList", "ZUI5_HR_BookRequest.ZUI5_HR_BookRequestList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1699"),	// 1699:도서 조회 및 예약
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL3 = this.getUrl("/sap/opu/odata/sap/ZHR_BOOK_SRV/");
		...
		sap.ui.getCore().setModel(oModel3, "ZHR_BOOK_SRV"); 		
