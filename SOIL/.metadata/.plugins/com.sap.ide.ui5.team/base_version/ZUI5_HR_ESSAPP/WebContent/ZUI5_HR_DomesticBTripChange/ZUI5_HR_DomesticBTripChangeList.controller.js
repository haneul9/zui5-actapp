...
sap.ui.controller("ZUI5_HR_DomesticBTripChange.ZUI5_HR_DomesticBTripChangeList", {
	/**
	...
	PAGEID : "ZUI5_HR_DomesticBTripChangeList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data")){
			...
			var JSonData = {Data : {Begtr : dateFormat.format(prevDate), 
				                    Endtr : dateFormat.format(nextDate),
	...
	onPressNew1 : function(oEvent){
		var surfix = "?" + new Date().getTime(), vLanguegae = "";
		//No Cache를 위해 NoCache 파라메터를 추가한다.
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_DomesticBTripChange.ZUI5_HR_DomesticBTripChangeDetail",
		      data : {Appno : "", Langu : "3"}
		});	
	},
	// 신규신청 로직(영문)
...
//	// 신규신청 로직(국문)
//	onPressNew1 : function(oEvent){
//		var oView = sap.ui.getCore().byId("ZUI5_HR_DomesticBTripChange.ZUI5_HR_DomesticBTripChangeList");
//		var oController = oView.getController();	
//		oController._BusinessTripCheckFlag = "1";
//		if(!oController._BusinessTripCheckDialog) {
//			oController._BusinessTripCheckDialog = sap.ui.jsfragment("fragment.BusinessTripCheck", oController);
//			oView.addDependent(oController._BusinessTripCheckDialog);
//		}
//		oController._BusinessTripCheckDialog.open();	
//	},
//	// 신규신청 로직(영문)
//	onPressNew2 : function(oEvent){
//		var oView = sap.ui.getCore().byId("ZUI5_HR_DomesticBTripChange.ZUI5_HR_DomesticBTripChangeList");
//		var oController = oView.getController();	
//		oController._BusinessTripCheckFlag = "2";
//		if(!oController._BusinessTripCheckDialog) {
//			oController._BusinessTripCheckDialog = sap.ui.jsfragment("fragment.BusinessTripCheck", oController);
//			oView.addDependent(oController._BusinessTripCheckDialog);
//		}
...
//		var oController = oView.getController();
//		var surfix = "?" + new Date().getTime(), vLanguegae = "";
//		if(oController._BusinessTripCheckFlag == "1"){
//			//No Cache를 위해 NoCache 파라메터를 추가한다.
//			oBundleText = jQuery.sap.resources({
//				url : "/sap/bc/ui5_ui5/sap/ZUI5_HR_COMMON/translation/i18n.properties" + surfix, //번역파일 주소
//				locale : "KO" 	
...
//			});	
//			
//		}else if(oController._BusinessTripCheckFlag == "2"){
//			//No Cache를 위해 NoCache 파라메터를 추가한다.
//			oBundleText = jQuery.sap.resources({
//				url : "/sap/bc/ui5_ui5/sap/ZUI5_HR_COMMON/translation/i18n.properties" + surfix, //번역파일 주소
//				locale : "EN" 	
...
//			});	
//		}
//		oController._BusinessTripCheckDialog.close();
//	},
	...
	onSelectRow : function(oEvent){
		...
		var surfix = "?" + new Date().getTime(), vLang = "KO";
		if(oModel.getProperty(vContext.sPath + "/ZreqForm") == "HR07"){
			vLang = "EN"
		}
		oBundleText = jQuery.sap.resources({
			url : "/sap/bc/ui5_ui5/sap/ZUI5_HR_COMMON/translation/i18n.properties" + surfix, //번역파일 주소
		...
		sap.ui.getCore().getEventBus().publish("nav", "to", {
		      ...
		      data : {Appno : oModel.getProperty(vContext.sPath + "/Appno"),
		    	      ZreqForm : oModel.getProperty(vContext.sPath + "/ZreqForm")
		      }}
	...
	onPressRow : function(oEvent){
		...
		var vAppno = oController._ListJSonModel.getProperty(oEvent.getSource().getBindingContext().sPath + "/Appno"),
			vZreqForm = oController._ListJSonModel.getProperty(oEvent.getSource().getBindingContext().sPath + "/ZreqForm");
	...
	onPressSearch : function(oEvent){
		...
		if(SerchCond.Begtr != "" && SerchCond.Endtr != "") {
			if(common.Common.checkDate(SerchCond.Begtr, SerchCond.Endtr) == false) {
				return ;
			}
		}
		...
		aFilters.push(new sap.ui.model.Filter('Subty', sap.ui.model.FilterOperator.EQ, '2'));
		if(SerchCond.Begtr != "") {
			aFilters.push(new sap.ui.model.Filter('Begtr', sap.ui.model.FilterOperator.EQ, common.Common.adjustGMT(sap.ui.getCore().byId(oController.PAGEID + "_Begtr").getDateValue())));
		}
		if(SerchCond.Endtr != "") {
			aFilters.push(new sap.ui.model.Filter('Endtr', sap.ui.model.FilterOperator.EQ, common.Common.adjustGMT(sap.ui.getCore().byId(oController.PAGEID + "_Endtr").getDateValue())));
		}
		if(!common.Common.checkNull(SerchCond.Pernr)) {
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_1225") + "-" + dateFormat.format(curDate) + ".xlsx"	// 1225:국내출장명령 변경/취소 신청
			};
