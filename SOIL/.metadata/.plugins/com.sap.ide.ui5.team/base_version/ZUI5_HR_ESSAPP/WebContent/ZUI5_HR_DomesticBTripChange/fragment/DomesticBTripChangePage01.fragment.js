sap.ui.jsfragment("ZUI5_HR_DomesticBTripChange.fragment.DomesticBTripChangePage01", {
	...
	_colModel : [
		...
		{id: "Newyntx", label : oBundleText.getText("LABEL_1228"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "100px"},	// 1228:신규구분
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Toolbar({
				...
				content : [ new sap.m.Image({
							...
							new sap.m.Text({text : oBundleText.getText("LABEL_1225") }).addStyleClass("Font18px FontColor0"),	// 1225:국내출장명령 변경/취소 신청
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			content : new sap.m.Toolbar({	
				content : [ new sap.m.Toolbar(oController.PAGEID + "_ManualToolbar",{	
							...
							new sap.m.ToolbarSpacer(),
							new sap.m.Button({
								text : oBundleText.getText("LABEL_1226"), 	// 1226:변경/취소 신청(국문)
								type : "Default", 
								press : oController.onPressNew1
							}),
							new sap.m.Button({
								text : oBundleText.getText("LABEL_1227"), 	// 1227:변경/취소 신청(영문)
								type : "Default", 
