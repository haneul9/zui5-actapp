sap.ui.jsfragment("ZUI5_HR_DomesticBTripChange.fragment.DepatureDialog", {
		...
		var oRow = new sap.ui.commons.layout.MatrixLayoutRow({
			cells : [
				new sap.ui.commons.layout.MatrixLayoutCell({
					content : oTable1,
					vAlign : "Top"
				}).addStyleClass("MatrixData4 PaddingLeft5 PaddingTop5px PaddingRight5px paddingBottom5px"),
				new sap.ui.commons.layout.MatrixLayoutCell({
					content : oTable2,
					vAlign : "Top"
				}).addStyleClass("MatrixData4 PaddingLeft5 PaddingTop5px PaddingRight5px paddingBottom5px"),
