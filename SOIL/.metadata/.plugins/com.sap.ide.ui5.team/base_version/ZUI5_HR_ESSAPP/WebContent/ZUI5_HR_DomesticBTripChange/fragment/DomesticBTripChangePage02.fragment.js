...
sap.ui.jsfragment("ZUI5_HR_DomesticBTripChange.fragment.DomesticBTripChangePage02", {
		...
		var aRows = [
				...
				cells : [
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							//변경/취소
							text : oBundleText.getText("CHANGE_CANCEL"),
							required : true
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [
								 new sap.m.ComboBox({
							            items : {
							            	path: "ZHR_BUSITRIP_DOM_SRV>/NewynListSet",
											filters : [
												{sPath : 'Langu', sOperator : 'EQ', oValue1 : oController._vLangu}
											],
							            	template: new sap.ui.core.ListItem({
							            		key: "{ZHR_BUSITRIP_DOM_SRV>Newyn}",
							            		text: "{ZHR_BUSITRIP_DOM_SRV>Newyntx}"
							            	})
							            },
							            editable : {
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							//변경기간
							text : oBundleText.getText("CHANGE_PERIOD")
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [
								new sap.m.DatePicker({
							    	...
							    	width : "150px",
						    	    editable : {
										parts : [{path : "ZappStatAl"}, {path : "Pernr"}, {path : "Newyn"}],
										formatter : function(fVal1, fVal2, fVal3) {
											return ((fVal1 == "" || fVal1 == "10") && !common.Common.checkNull(fVal2) && fVal3 == "2") ? true : false;
										}
									},
			...
			new sap.ui.commons.layout.MatrixLayoutRow({
				...
				cells : [
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							text : oBundleText.getText("WORKSCHEDULE")
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
			...
			new sap.ui.commons.layout.MatrixLayoutRow({
				...
				cells : [
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							//변경/취소 사유
							text : oBundleText.getText("CHANGE_REASON"),
							required : true
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						...
						content : new sap.m.Toolbar({
							...
							content : [
								new sap.m.TimePicker({
									...
									value : "{Beguz}",
									editable : {
										parts : [{path : "ZappStatAl"}, {path : "Pernr"}, {path : "Begtr"}, {path : "Endtr"},{path : "Newyn"}],
										formatter : function(fVal1, fVal2, fVal3, fVal4, fVal5){
											if((fVal1 == "" || fVal1 == "10") && fVal2){
												if(common.Common.checkNull(fVal3) || common.Common.checkNull(fVal4) || fVal3 != fVal4 || fVal5 != "2") return false;
												else return true;
											}
											else return false;
										}
...
//					height : "20px",
					content : [
						...
						new sap.m.Text({
							text : oBundleText.getText("LABEL_1225") 	// 1225:국내출장명령 변경/취소 신청
	...
	getDetailTable : function(oController){
		...
		var oPah = new sap.m.ComboBox({ 
			 selectedKey: "{Pah}",
			editable : {
				parts : [{path : "ZappStatAl"}, {path : "Newyn"}],
				formatter : function(fVal1, fVal2){
					return ((fVal1 == "" || fVal1 == "10") && fVal2 == "2") ;
				}
			},
			width : "100%"
		}).addStyleClass("Font14px FontColor6");
...
//			width : "120px",
			//출발지
			multiLabels : [ new sap.ui.commons.TextView({text : oBundleText.getText("DEPARTURE"), textAlign : "Center"}).addStyleClass("FontFamilyBold")],
...
//			width : "120px",
			//도착지
			multiLabels : [ new sap.ui.commons.TextView({text : oBundleText.getText("DESTINATION"), textAlign : "Center"}).addStyleClass("FontFamilyBold")],
			template : [new sap.m.Input({
				value : "{Elotx}",
		    	editable : false,
				textAlign : "Center",
...
//			width : "120px",
			//교통편
			multiLabels : [ new sap.ui.commons.TextView({text : oBundleText.getText("TRANSPORTATION"), textAlign : "Center"}).addStyleClass("FontFamilyBold")],
			template : [new sap.m.Input({
				value : "{Trftx}",
		    	editable : false,
				textAlign : "Center",
		...
		oTable.addColumn(new sap.ui.table.Column({
			...
			showFilterMenuEntry : false,
			// 숙박시설
			multiLabels : [ new sap.ui.commons.TextView({text : oBundleText.getText("ACCOMDATION"), textAlign : "Center"}).addStyleClass("FontFamilyBold")	],
			template : oAcc
		}));
...
//			width : "120px",
			//숙박일
			multiLabels : [ new sap.ui.commons.TextView({text : oBundleText.getText("STAYING_DAYS"), textAlign : "Center"}).addStyleClass("FontFamilyBold")],
			template : [new sap.m.Input({
				value : "{Day}",
		...
		oTable.addColumn(new sap.ui.table.Column({
			...
			width : "120px",
			// 삭제
			multiLabels : [ new sap.m.CheckBox({text : oBundleText.getText("DELETION"),
												editable : { parts : [{path : "ZappStatAl"}, {path : "Newyn"}],
													formatter : function(fVal1, fVal2) {
														return ((fVal1 == "" || fVal1 == "10") && fVal2 == "2") ? true : false;
													}	
												},
				...
				new sap.m.Toolbar({
					...
					content : [
					    ...
					    new sap.m.Text({text : {
						    path : "Ename",
					   		formatter : function(fVal){
								if(oController._vLangu && oController._vLangu == "E") return "Schedule";
								else return oBundleText.getText("LABEL_1207");	// 1207:상세 내역
					    }}}).addStyleClass("MiddleTitle"),
						new sap.m.ToolbarSpacer({}),
						new sap.m.Button({
							// 추가
