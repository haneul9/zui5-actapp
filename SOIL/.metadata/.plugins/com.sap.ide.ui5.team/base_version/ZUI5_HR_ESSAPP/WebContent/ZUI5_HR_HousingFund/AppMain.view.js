...
sap.ui.jsview("ZUI5_HR_HousingFund.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_HousingFund.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_HousingFund.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_HousingFund.ZUI5_HR_HousingFundList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_HousingFund.ZUI5_HR_HousingFundList", "ZUI5_HR_HousingFund.ZUI5_HR_HousingFundList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1463"),	// 1463:개인별 주택자금 조회
			showLogout : false,
			app : this.app,
