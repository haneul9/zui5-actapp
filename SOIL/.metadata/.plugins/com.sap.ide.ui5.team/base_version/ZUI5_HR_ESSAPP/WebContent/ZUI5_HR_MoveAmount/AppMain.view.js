...
sap.ui.jsview("ZUI5_HR_MoveAmount.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_MoveAmount.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_MoveAmount.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_MoveAmount.ZUI5_HR_MoveAmountList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_MoveAmount.ZUI5_HR_MoveAmountList", "ZUI5_HR_MoveAmount.ZUI5_HR_MoveAmountList"));
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_MOVING_FEE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_MOVING_FEE_SRV");
