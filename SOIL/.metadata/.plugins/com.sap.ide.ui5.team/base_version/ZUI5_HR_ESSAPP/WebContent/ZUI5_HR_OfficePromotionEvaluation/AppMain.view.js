...
sap.ui.jsview("ZUI5_HR_OfficePromotionEvaluation.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_OfficePromotionEvaluation.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_OfficePromotionEvaluation.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_OfficePromotionEvaluation.ZUI5_HR_OfficePromotionEvaluationList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_OfficePromotionEvaluation.ZUI5_HR_OfficePromotionEvaluationList", "ZUI5_HR_OfficePromotionEvaluation.ZUI5_HR_OfficePromotionEvaluationList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0982"),	// 982:사무직 승진자 평가
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_OFIC_PROMOTION_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_OFIC_PROMOTION_SRV");
