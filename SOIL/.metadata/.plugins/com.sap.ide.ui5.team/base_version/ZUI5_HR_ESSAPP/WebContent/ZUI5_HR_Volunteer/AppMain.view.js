...
sap.ui.jsview("ZUI5_HR_Volunteer.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Volunteer.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Volunteer.ZUI5_HR_VolunteerList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Volunteer.ZUI5_HR_VolunteerList", "ZUI5_HR_Volunteer.ZUI5_HR_VolunteerList"));
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_VOLUNTEER_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_VOLUNTEER_SRV");
