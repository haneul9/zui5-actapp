...
sap.ui.jsview("ZUI5_HR_ProductionEvaluation.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ProductionEvaluation.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ProductionEvaluation.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ProductionEvaluation.ZUI5_HR_ProductionEvaluationList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ProductionEvaluation.ZUI5_HR_ProductionEvaluationList", "ZUI5_HR_ProductionEvaluation.ZUI5_HR_ProductionEvaluationList"));
