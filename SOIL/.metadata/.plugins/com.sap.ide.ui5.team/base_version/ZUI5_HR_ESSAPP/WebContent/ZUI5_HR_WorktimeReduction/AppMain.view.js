...
sap.ui.jsview("ZUI5_HR_WorktimeReduction.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_WorktimeReduction.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_WorktimeReduction.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_WorktimeReduction.ZUI5_HR_WorktimeReductionList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_WorktimeReduction.ZUI5_HR_WorktimeReductionList", "ZUI5_HR_WorktimeReduction.ZUI5_HR_WorktimeReductionList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_2989"),	// 2989:근로시간 단축 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_WORKTIME_REDUCE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_WORKTIME_REDUCE_SRV");
