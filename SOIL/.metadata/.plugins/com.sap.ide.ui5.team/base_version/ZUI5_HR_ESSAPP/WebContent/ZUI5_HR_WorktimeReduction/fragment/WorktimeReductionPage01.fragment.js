...
sap.ui.jsfragment("ZUI5_HR_WorktimeReduction.fragment.WorktimeReductionPage01", {
	...
	_colModel : [
		...
		{id: "Jiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 67:직위
		...
		{id: "Wktrdtx", label : oBundleText.getText("LABEL_2990"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "9%"},	// 2990:근로단축유형
		{id: "Lfcyltx", label : oBundleText.getText("LABEL_0157"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 157:신청유형
		{id: "Days", label : oBundleText.getText("LABEL_2991"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 2991:단축기간
		{id: "HoursN", label : oBundleText.getText("LABEL_0671"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "6%"},	// 671:근무시간
		{id: "Docyn", label : oBundleText.getText("LABEL_0069"), plabel : "", span : 0, type : "ptifile", sort : true, filter : true, width : "5%"},	// 69:첨부
	...
	getFilterLayoutRender : function(oController) {
		...
		return new sap.m.Toolbar({
			...
			content : [
				...
				new sap.m.ToolbarSpacer({width : "20px"}),
				new sap.m.Text({
					text : oBundleText.getText("LABEL_3032")	// 3032:단축기간 시작일
				}).addStyleClass("Font14px FontBold"),
				new sap.m.ToolbarSpacer({width : "10px"}),
				...
				new sap.m.ToolbarSpacer({width : "20px"}),
				new sap.m.Text({
					text : oBundleText.getText("LABEL_3033")	// 3033:단축기간 종료일
				}).addStyleClass("Font14px FontBold"),
				new sap.m.ToolbarSpacer({width : "10px"}),
				...
				new sap.m.ToolbarSpacer({width : "10px"}),
				new sap.m.ComboBox(oController.PAGEID + "_Wktrd", {
					width : "150px",
					selectedKey : "{Wktrd}",
					items : {
