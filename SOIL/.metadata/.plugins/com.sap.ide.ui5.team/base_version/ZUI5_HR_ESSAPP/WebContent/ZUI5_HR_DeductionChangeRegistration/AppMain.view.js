...
sap.ui.jsview("ZUI5_HR_DeductionChangeRegistration.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_Deduction.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_DeductionChangeRegistration.AppMain";
	},

	/** Is initially called once after the Controller has been instantiated. It is the place where the UI is constructed. 
	* Since the Controller is given to this method, its event handlers can be attached right away. 
	* @memberOf ZHR_UI5_DeductionChangeRegistration.AppMain
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_DeductionChangeRegistration.ZUI5_HR_DeductionChangeRegistrationDetail"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_DeductionChangeRegistration.ZUI5_HR_DeductionChangeRegistrationDetail", "ZUI5_HR_DeductionChangeRegistration.ZUI5_HR_DeductionChangeRegistrationDetail"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0512"),	// 512:변동공제 신청
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_DEDUCT_CHG_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_DEDUCT_CHG_SRV");
