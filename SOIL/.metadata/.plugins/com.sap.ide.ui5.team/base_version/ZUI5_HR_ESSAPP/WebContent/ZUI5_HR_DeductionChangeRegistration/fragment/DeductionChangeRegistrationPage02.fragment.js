sap.ui.jsfragment("ZUI5_HR_DeductionChangeRegistration.fragment.DeductionChangeRegistrationPage02", {
		...
		var aRows = [
			...
			new sap.ui.commons.layout.MatrixLayoutRow({
				...
				cells : [
					...
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							text : oBundleText.getText("LABEL_0507")	// 507:공제발생자
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
							content : [ 
								...
								new sap.m.Input({
									...
									value : "{Dperid}",
									editable : false
								}).addStyleClass("Font14px FontColor3 PaddingLeft5")
							]
						}).addStyleClass("ToolbarNoBottomLine")
					}).addStyleClass("MatrixData"),
					// 공제발생자소속
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Label({
							text : oBundleText.getText("LABEL_0509")	// 509:공제발생자소속
						}).addStyleClass("Font14px FontBold FontColor3")
					}).addStyleClass("MatrixLabel"),
					new sap.ui.commons.layout.MatrixLayoutCell({
						content : new sap.m.Toolbar({
						...
						content : new sap.m.Toolbar({
							content : [
								new sap.m.Input({
									width : "45%",
									value : "{Inmsg}",
									maxLength : common.Common.getODataPropertyLength("ZHR_DEDUCT_CHG_SRV", "DeductChgAppl", "Inmsg"),
									editable : {
										parts : [{path : "ZappStatAl"}, {path : "Pernr"}],
										formatter : function(fVal1, fVal2) {
											return ((fVal1 == "" || fVal1 == "10") && fVal2) ? true : false;
