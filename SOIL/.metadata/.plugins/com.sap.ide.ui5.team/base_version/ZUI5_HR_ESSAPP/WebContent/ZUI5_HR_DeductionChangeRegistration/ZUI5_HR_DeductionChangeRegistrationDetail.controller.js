...
sap.ui.controller("ZUI5_HR_DeductionChangeRegistration.ZUI5_HR_DeductionChangeRegistrationDetail", {
	/**
	...
	PAGEID : "ZUI5_HR_DeductionChangeRegistrationDetail",
	...
	onBack : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_DeductionChangeRegistration.ZUI5_HR_DeductionChangeRegistrationDetail"),
		...
		// 공통적용사항
		oController.commonAction(oController, oController._DetailJSonModel.getData());
	...
	DedtxSearchInput : function(oEvent) {
		...
		if(!oController._DedcdDialog) {
			oController._DedcdDialog = sap.ui.jsfragment("ZUI5_HR_DeductionChangeRegistration.fragment.DedcdDialog", oController);
	...
	onSelectDedcd : function(oEvent) {
		...
		oController._DetailJSonModel.setProperty("/Data/Dperid", dedcdTableData.Perid);
...
//			oController = oView.getController();
	...
	onPreSaveOpenDialog : function(oEvent) {
		...
		if(!oController._PreSaveDialog) {
			oController._PreSaveDialog = sap.ui.jsfragment("ZUI5_HR_DeductionChangeRegistration.fragment.PreSaveDialog", oController);
