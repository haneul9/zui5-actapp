...
sap.ui.jsview("ZUI5_HR_Workplace.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZUI5_HR_Workplace.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Workplace.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Workplace.ZUI5_HR_WorkplaceList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Workplace.ZUI5_HR_WorkplaceList", "ZUI5_HR_Workplace.ZUI5_HR_WorkplaceList"));
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_EMPLOYEE_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_EMPLOYEE_SRV");
