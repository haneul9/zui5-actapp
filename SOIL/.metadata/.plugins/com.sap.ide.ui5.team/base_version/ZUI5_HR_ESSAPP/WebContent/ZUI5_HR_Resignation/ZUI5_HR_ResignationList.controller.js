...
sap.ui.controller("ZUI5_HR_Resignation.ZUI5_HR_ResignationList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_Resignation.ZUI5_HR_ResignationList
	 */

	PAGEID : "ZUI5_HR_ResignationList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_Resignation.ZUI5_HR_ResignationList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
	    	  id : "ZUI5_HR_Resignation.ZUI5_HR_ResignationDetail",
		      data : { Appno : _Appno }
		});
	},
...
//			}
	...
	onExport : function(oEvent){
		...
		var oSettings = {
			    ...
			    fileName: oBundleText.getText("LABEL_0375") + "-" + dateFormat.format(curDate) + ".xlsx"	// 375:사직 신청
			};
