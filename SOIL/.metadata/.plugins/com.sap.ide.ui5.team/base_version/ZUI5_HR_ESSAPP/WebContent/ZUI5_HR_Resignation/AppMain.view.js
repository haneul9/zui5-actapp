...
sap.ui.jsview("ZUI5_HR_Resignation.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Resignation.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Resignation.ZUI5_HR_ResignationList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Resignation.ZUI5_HR_ResignationList", "ZUI5_HR_Resignation.ZUI5_HR_ResignationList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0375"),	// 375:사직 신청
			showLogout : false,
			app : this.app,
