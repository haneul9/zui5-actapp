...
sap.ui.jsview("ZUI5_HR_ProdEvalOpinionDisp.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_ProdEvalOpinionDisp.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_ProdEvalOpinionDisp.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_ProdEvalOpinionDisp.ZUI5_HR_ProdEvalOpinionDispList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_ProdEvalOpinionDisp.ZUI5_HR_ProdEvalOpinionDispList", "ZUI5_HR_ProdEvalOpinionDisp.ZUI5_HR_ProdEvalOpinionDispList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0894"),	// 894:생산직 평가조정 의견기술 조회
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_APPRAISAL_DISP_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_APPRAISAL_DISP_SRV");
