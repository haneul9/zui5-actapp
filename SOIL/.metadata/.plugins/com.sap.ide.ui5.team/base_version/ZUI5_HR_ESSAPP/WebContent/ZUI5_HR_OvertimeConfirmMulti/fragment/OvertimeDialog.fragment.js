sap.ui.jsfragment("ZUI5_HR_OvertimeConfirmMulti.fragment.OvertimeDialog", {
...
//					valueHelpRequest: oController.displayEmpSearchDialog
		...
		oTable.addEventDelegate({
			onAfterRendering: function() {
				var oTable = sap.ui.getCore().byId("ZUI5_HR_OvertimeConfirmMultiDetail_OvertimeTable");
		...
		oTable.addEventDelegate({
			onAfterRendering: function() {
				...
				common.Common.generateRowspan({
					selector : '#ZUI5_HR_OvertimeConfirmMultiDetail_OvertimeTable-header-fixed-fixrow > tbody',
					colIndexes : [0, 1, 2]
				});

				common.Common.generateRowspan({
					selector : '#ZUI5_HR_OvertimeConfirmMultiDetail_OvertimeTable-header > tbody',
					colIndexes : [10, 11, 12]
				});
			}
		});
