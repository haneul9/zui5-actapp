...
sap.ui.controller("ZUI5_HR_OvertimeConfirmMulti.ZUI5_HR_OvertimeConfirmMultiList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_OvertimeConfirmMulti.ZUI5_HR_OvertimeConfirmMultiList
	 */

	PAGEID : "ZUI5_HR_OvertimeConfirmMultiList",
	...
	onBeforeShow : function(oEvent) {
		...
		if(!oController._ListCondJSonModel.getProperty("/Data") || oController._ListCondJSonModel.getProperty("/Data").length < 1) {			
			...
			var JSonData = { Data : { Apbeg : dateFormat.format(prevDate) , Apend : dateFormat.format(curDate), Pernr : vPernr, Ename : vEname }};
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_OvertimeConfirmMulti.ZUI5_HR_OvertimeConfirmMultiList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_OvertimeConfirmMulti.ZUI5_HR_OvertimeConfirmMultiDetail",
			data : { Appno : _Appno }
		});
	},
	...
	onPressSearch : function(oEvent) {
		...
		if(SerchCond.Pernr != "") {
			aFilters.push(new sap.ui.model.Filter('Appernr', sap.ui.model.FilterOperator.EQ, SerchCond.Pernr));
		}
