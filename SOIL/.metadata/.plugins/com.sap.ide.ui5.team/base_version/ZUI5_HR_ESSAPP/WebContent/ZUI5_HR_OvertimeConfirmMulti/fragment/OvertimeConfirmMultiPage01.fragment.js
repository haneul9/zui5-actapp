...
sap.ui.jsfragment("ZUI5_HR_OvertimeConfirmMulti.fragment.OvertimeConfirmMultiPage01", {
	...
	_colModel : [
		...
		{id: "Apename", label : oBundleText.getText("LABEL_0038"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 38:성명
		{id: "Apzzjiklnt", label : oBundleText.getText("LABEL_0067"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "10%"},	// 67:직위
		{id: "Aporgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "14%", align : sap.ui.core.TextAlign.Begin},	// 39:소속부서
		{id: "Datumt", label : oBundleText.getText("LABEL_0644"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "12%", align : sap.ui.core.TextAlign.Begin},	// 644:특근일
		...
		{id: "ZListComment", label : oBundleText.getText("LABEL_0072"), plabel : "", span : 0, type : "commentpopover3", sort : true, filter : true, width : "21%", align : sap.ui.core.TextAlign.Begin}	// 72:담당자의견
	],
