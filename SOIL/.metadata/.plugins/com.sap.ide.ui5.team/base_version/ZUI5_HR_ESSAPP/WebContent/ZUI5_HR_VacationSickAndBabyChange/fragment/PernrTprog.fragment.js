sap.ui.jsfragment("ZUI5_HR_VacationSickAndBabyChange.fragment.PernrTprog", {
	...
	createContent : function(oController) {
		...
		oTprogTable.addEventDelegate({
			onAfterRendering: function() {
				var oTable = sap.ui.getCore().byId("ZUI5_HR_VacationSickAndBabyChangeDetail_TprogTable");
		...
		var tprogColModel = [
			...
			{id: "Datum", label : oBundleText.getText("LABEL_0057"), plabel : "", span : 0, type : "date", sort : true, filter : false, width : "30%"},	// 57:일자
