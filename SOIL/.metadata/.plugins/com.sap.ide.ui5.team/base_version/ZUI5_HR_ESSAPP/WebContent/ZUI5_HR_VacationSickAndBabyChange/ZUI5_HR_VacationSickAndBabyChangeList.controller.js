...
sap.ui.controller("ZUI5_HR_VacationSickAndBabyChange.ZUI5_HR_VacationSickAndBabyChangeList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_VacationSickAndBabyChange.ZUI5_HR_VacationSickAndBabyChangeList
	 */

	PAGEID : "ZUI5_HR_VacationSickAndBabyChangeList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_VacationSickAndBabyChange.ZUI5_HR_VacationSickAndBabyChangeList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_VacationSickAndBabyChange.ZUI5_HR_VacationSickAndBabyChangeDetail",
			data : { Appno : _Appno }
		});
	},
	...
	onPressSearch : function(oEvent) {
		...
		function Search() {
			...
			oModel.read("/ChangeLongLeaveSet", {
				async: false,
				filters: aFilters,
...
//			}
	...
	onExport : function(oEvent) {
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0764") + "-" + dateFormat.format(curDate) + ".xlsx"	// 764:병가/출산휴가/육아휴직 변경/취소 신청서
			};
