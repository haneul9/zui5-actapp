...
sap.ui.jsview("ZUI5_HR_SalaryStatement.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf ZHR_UI5_SalaryStatement.AppMain
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_SalaryStatement.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_SalaryStatement.ZUI5_HR_SalaryStatementList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_SalaryStatement.ZUI5_HR_SalaryStatementList", "ZUI5_HR_SalaryStatement.ZUI5_HR_SalaryStatementList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1592"),	// 1592:급여명세서
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_PAYSLIP_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_PAYSLIP_SRV"); 
