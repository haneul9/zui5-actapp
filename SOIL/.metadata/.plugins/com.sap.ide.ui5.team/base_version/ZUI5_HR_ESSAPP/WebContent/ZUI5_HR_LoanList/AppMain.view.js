...
sap.ui.jsview("ZUI5_HR_LoanList.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_LoanList.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_LoanList.ZUI5_HR_LoanList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_LoanList.ZUI5_HR_LoanList", "ZUI5_HR_LoanList.ZUI5_HR_LoanList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_1808"),	// 1808:사내복지기금 대출현황
			showLogout : false,
			app : this.app,
	...
	loadModel : function() {
		...
		var oServiceURL2 = this.getUrl("/sap/opu/odata/sap/ZHR_LOAN_SRV/");
		...
		sap.ui.getCore().setModel(oModel2, "ZHR_LOAN_SRV"); 
...
//		var oServiceURL5 = this.getUrl("/sap/opu/odata/sap/ZHR_DAILYTIME_SRV/");
...
//		sap.ui.getCore().setModel(oModel5, "ZHR_DAILYTIME_SRV"); 
		
//		var oServiceURL6 = this.getUrl("/sap/opu/odata/sap/ZHR_OVERTIME_SRV/");
...
//		sap.ui.getCore().setModel(oModel6, "ZHR_OVERTIME_SRV"); 
