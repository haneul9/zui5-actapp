...
sap.ui.jsfragment("ZUI5_HR_Transition.fragment.TransitionPage01", {
	...
	_colModel : [
		...
		{id: "Orgtx", label : oBundleText.getText("LABEL_0039"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "7%", align : sap.ui.core.TextAlign.Begin},	// 39:소속부서
		{id: "ZreqDate", label : oBundleText.getText("LABEL_0049"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"},	// 49:신청일
		{id: "Hojikcht", label : oBundleText.getText("LABEL_0522"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "7%"},	// 522:인계직책
		{id: "Horeasnt", label : oBundleText.getText("LABEL_0520"), plabel : "", span : 0, type : "listText", sort : true, filter : true, align : sap.ui.core.TextAlign.Begin},	// 520:인계사유
		{id: "Actdt", label : oBundleText.getText("LABEL_0292"), plabel : "", span : 0, type : "listdate", sort : true, filter : true, width : "7%"},	// 292:발령일
		{id: "Accpnnm", label : oBundleText.getText("LABEL_0526"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 526:인수자
		{id: "Entp1nm", label : oBundleText.getText("LABEL_0527"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"},	// 527:입회자1
		{id: "Entp2nm", label : oBundleText.getText("LABEL_0528"), plabel : "", span : 0, type : "listText", sort : true, filter : true, width : "8%"}	// 528:입회자2
	],
