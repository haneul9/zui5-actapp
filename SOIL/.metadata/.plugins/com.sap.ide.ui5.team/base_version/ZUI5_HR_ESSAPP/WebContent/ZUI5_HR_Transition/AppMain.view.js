...
sap.ui.jsview("ZUI5_HR_Transition.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "ZUI5_HR_Transition.AppMain";
	},

	/** Is initially called once after the Controller has been instantiated. It is the place where the UI is constructed. 
	* Since the Controller is given to this method, its event handlers can be attached right away. 
	* @memberOf ZHR_UI5_Transition.AppMain
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "ZUI5_HR_Transition.ZUI5_HR_TransitionList"});		
		this.app.addPage(sap.ui.jsview("ZUI5_HR_Transition.ZUI5_HR_TransitionList", "ZUI5_HR_Transition.ZUI5_HR_TransitionList"));
		
		return new sap.m.Shell({
			title : oBundleText.getText("LABEL_0535"),	// 535:인수인계서 작성
			showLogout : false,
			app : this.app,
