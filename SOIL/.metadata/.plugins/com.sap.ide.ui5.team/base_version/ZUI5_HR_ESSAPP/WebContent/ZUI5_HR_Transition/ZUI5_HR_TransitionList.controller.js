...
sap.ui.controller("ZUI5_HR_Transition.ZUI5_HR_TransitionList", {
	/**
	 ...
	 * 
	 * @memberOf ZUI5_HR_Transition.ZUI5_HR_TransitionList
	 */

	PAGEID : "ZUI5_HR_TransitionList",
	...
	onDetailPage : function(oEvent) {
		var oView = sap.ui.getCore().byId("ZUI5_HR_Transition.ZUI5_HR_TransitionList"),
			oController = oView.getController();

		sap.ui.getCore().getEventBus().publish("nav", "to", {
			id : "ZUI5_HR_Transition.ZUI5_HR_TransitionDetail",
			data : { Appno : _Appno }
		});
	},
				...
				success: function(data,res) {
					if(data && data.results.length) {
						...
						Datas.Data.sort(function(a, b) {
							return new Date(b.ZreqDate) - new Date(a.ZreqDate);
						});
					}
				},
				error: function(Res) {
...
//			oController = oView.getController();
	...
	onExport : function(oEvent){
		...
		var oSettings = {
				...
				fileName: oBundleText.getText("LABEL_0535") + "-" + dateFormat.format(curDate) + ".xlsx"	// 535:인수인계서 작성
		};
