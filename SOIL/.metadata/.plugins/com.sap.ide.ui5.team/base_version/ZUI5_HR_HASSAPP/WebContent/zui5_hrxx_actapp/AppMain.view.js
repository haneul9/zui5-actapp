...
//		sap.ui.getCore().setModel(PersaJSONModel, "PersaModel");
		...
		//문서유형 리스트
		var vDocTypeList = {DocTypeListSet :[{Docty : "10", Doctx : "일반 발령", PageId : "zui5_hrxx_actapp.ActAppDocument"},
		                                      {Docty : "20", Doctx : "채용 발령", PageId : "zui5_hrxx_actapp.ActRecDocument"},
