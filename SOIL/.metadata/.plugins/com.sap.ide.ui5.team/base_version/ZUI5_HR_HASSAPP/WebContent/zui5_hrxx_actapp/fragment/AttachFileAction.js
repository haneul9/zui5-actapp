jQuery.sap.declare("zui5_hrxx_actapp.fragment.AttachFileAction");
...
zui5_hrxx_actapp.fragment.AttachFileAction = {
		
	oController : null,
		
	/** 
	* @memberOf zui5_hrxx_actapp.fragment.AttachFileAction
	*/
	...
	typeMissmatch : function (oEvent) {
		var oController = zui5_hrxx_actapp.fragment.AttachFileAction.oController;
	...
	uploadComplete: function (oEvent) {
		...
		zui5_hrxx_actapp.fragment.AttachFileAction.refreshAttachFileList(oController);
	},
