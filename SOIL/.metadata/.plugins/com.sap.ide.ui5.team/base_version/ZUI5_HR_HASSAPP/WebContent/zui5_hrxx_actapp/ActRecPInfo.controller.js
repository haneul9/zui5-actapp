...
//  인적사항을 저장 한다.	
	saveSub01 : function(fVal) {
		...
		switch(oController._vMolga) {
			case "41":
				if(oController.onCheckSub01Validation(oController, oLnmhgI, null, vLnmhgI, "I", "한글 성을 입력바랍니다.")) return false;          // 성 (한글)
				if(oController.onCheckSub01Validation(oController, oFnmhgI, null, vFnmhgI, "I", "한글 이름을 입력바랍니다.")) return false;          // 이름 (한글)
				if(oController.onCheckSub01Validation(oController, oNachnI, null, vNachnI, "I", "영문 성을 입력바랍니다.")) return false;          // 성
				if(oController.onCheckSub01Validation(oController, oVornaI, null, vVornaI, "I", "영문 이름을 입력바랍니다.")) return false;          // 이름
				if(oController.onCheckSub01Validation(oController, oLnmchI, null, vLnmchI, "I", "한자 성을 입력바랍니다.")) return false;          // 성 (중국어)
				if(oController.onCheckSub01Validation(oController, oFnmchI, null, vFnmchI, "I", "한자 이름을 입력바랍니다.")) return false;          // 이름 (중국어)
				if(oController.onCheckSub01Validation(oController, oRegnoI, null, vRegnoI, "I", "주민등록번호를 입력바랍니다.")) return false;          // 주민번호
				if(oController.onCheckSub01Validation(oController, oGeschR1, oGeschR2, vGeschR, "R", "성별을 선택해 주십시오.")) return false;          // 성별
				if(oController.onCheckSub01Validation(oController, oNatioL, null, vNatioL, "I", "국적을 선택해 주십시오.")) return false;          // 국적
				if(oController.onCheckSub01Validation(oController, oFamstL, null, vFamstL, "L", "결혼여부를 선택해 주십시오.")) return false;          // 결혼 여부
				if(oController.onCheckSub01Validation(oController, oZzgbdatD, null, vZzgbdatD, "D", "실제생일을 입력바랍니다.")) return false;          // 생일
				if(oController.onCheckSub01Validation(oController, oZzgbdtyR1, oZzgbdtyR2, vZzgbdtyR, "R", "양/음력을 선택해 주십시오.")) return false;          // 생일구분
				if(oController.onCheckSub01Validation(oController, oHndnoI, null, vHndnoI, "I", "휴대폰번호를 입력바랍니다.")) return false;          // 휴대폰번호
				if(oController.onCheckSub01Validation(oController, oLand1L, null, vLand1L, "I", "주소-국가를 선택바랍니다")) return false;          // 주소/국가
				if(oController.onCheckSub01Validation(oController, oPstlzI, null, vPstlzI, "I", "우편번호를 입력바랍니다.")) return false;          // 우편번호/시
				if(oController.onCheckSub01Validation(oController, oStateL, null, vStateL, "L", "시/도를 입력바랍니다")) return false;          // 지역
				if(oController.onCheckSub01Validation(oController, oOrt01I, null, vOrt01I, "I", "시/구/군/읍/면을 입력바랍니다")) return false;          // 주소1
				if(oController.onCheckSub01Validation(oController, oOrt02I, null, vOrt02I, "I", "도로/건물 번호를 입력바랍니다")) return false;          // 주소2
				if(oController.onCheckSub01Validation(oController, oStrasI, null, vStrasI, "I", "주소(동/호)를 입력바랍니다")) return false;          // 상세 주소/번지
				break;
			case "28":
				if(oController.onCheckSub01Validation(oController, oZzlocnmI, null, vZzlocnmI, "I", "한자 성명을 입력바랍니다.")) return false;          // 중국어 성명
				if(oController.onCheckSub01Validation(oController, oKornmI, null, vKornmI, "I", "한글 성명을 입력바랍니다.")) return false;          // 한글성명
				if(oController.onCheckSub01Validation(oController, oNachnI, null, vNachnI, "I", "영문 성을 입력바랍니다.")) return false;          // 성
				if(oController.onCheckSub01Validation(oController, oVornaI, null, vVornaI, "I", "영문 이름을 입력바랍니다.")) return false;          // 이름
				if(oController.onCheckSub01Validation(oController, oGeschR1, oGeschR2, vGeschR, "R", "성별을 선택해 주십시오.")) return false;          // 성별
				if(oController.onCheckSub01Validation(oController, oHukotL, null, vHukotL, "L", "호구유형을 선택해 주십시오.")) return false;          // 호구
				if(oController.onCheckSub01Validation(oController, oNatioL, null, vNatioL, "L", "국적을 선택해 주십시오.")) return false;          // 국적
				if(oController.onCheckSub01Validation(oController, oGbdatD, null, vGbdatD, "D", "생일을 입력바랍니다.")) return false;          // 생년월일
				if(oController.onCheckSub01Validation(oController, oZzgbdtyR1, oZzgbdtyR2, null, vZzgbdtyR, "R", "양/음력을 선택해 주십시오.")) return false;          // 생일구분
				if(oController.onCheckSub01Validation(oController, oZzgbdatD, null, vZzgbdatD, "D", "실제생일을 입력바랍니다.")) return false;          // 생일
				if(oController.onCheckSub01Validation(oController, oHndnoI, null, vHndnoI, "I", "휴대폰번호를 입력바랍니다.")) return false;          // 휴대폰번호
				if(oController.onCheckSub01Validation(oController, oFamstL, null, vFamstL, "L", "결혼여부를 선택해 주십시오.")) return false;          // 결혼 여부
				if(oController.onCheckSub01Validation(oController, oLand1L, null, vLand1L, "I", "주소-국가를 선택바랍니다")) return false;          // 주소/국가
				if(oController.onCheckSub01Validation(oController, oPstlzI, null, vPstlzI, "I", "우편번호를 입력바랍니다.")) return false;          // 우편번호/시
				if(oController.onCheckSub01Validation(oController, oStateL, null, vStateL, "L", "시/도를 입력바랍니다")) return false;          // 지역
				if(oController.onCheckSub01Validation(oController, oOrt01I, null, vOrt01I, "I", "시/지역을 입력바랍니다")) return false;          // 주소1
				if(oController.onCheckSub01Validation(oController, oOrt02I, null, vOrt02I, "I", "군/구 코드를 입력바랍니다")) return false;          // 주소2
				if(oController.onCheckSub01Validation(oController, oStrasI, vStrasI, "I", "상세주소 및 번지를 입력바랍니다")) return false;          // 상세 주소/번지
				if(oController.onCheckSub01Validation(oController, oHsnmrI, vHsnmrI, "I", "번지를 입력바랍니다")) return false;          // 번지
				break;
			case "40":
				if(oController.onCheckSub01Validation(oController, oVornaI, null, vVornaI, "I", "영문 이름을 입력바랍니다.")) return false;          // 이름
				if(oController.onCheckSub01Validation(oController, oNachnI, null, vNachnI, "I", "영문 성을 입력바랍니다.")) return false;          // 성
				if(oController.onCheckSub01Validation(oController, oPannoI, null, vPannoI, "I", "PAN No.를 입력바랍니다.")) return false;          // PAN No.
				if(oController.onCheckSub01Validation(oController, oGbdatD, null, vGbdatD, "D", "생일을 입력바랍니다.")) return false;          // 생일
				if(oController.onCheckSub01Validation(oController, oGeschR1, oGeschR2, vGeschR, "R", "성별을 선택해 주십시오.")) return false;          // 성별
				if(oController.onCheckSub01Validation(oController, oZzfathnI, null, vZzfathnI, "I", "아버지 성명을 입력바랍니다.")) return false;          // 아버지 성명
				if(oController.onCheckSub01Validation(oController, oFamstL, null, vFamstL, "L", "결혼여부를 선택해 주십시오.")) return false;          // 결혼 여부
				if(oController.onCheckSub01Validation(oController, oNatioL, null, vNatioL, "L", "국적을 선택해 주십시오.")) return false;          // 국적
				if(oController.onCheckSub01Validation(oController, oHndnoI, null, vHndnoI, "I", "휴대폰번호를 입력바랍니다.")) return false;          // 휴대폰번호
				if(oController.onCheckSub01Validation(oController, oLand1L, null, vLand1L, "I", "주소-국가를 선택바랍니다")) return false;          // 주소/국가
				if(oController.onCheckSub01Validation(oController, oPstlzI, null, vPstlzI, "I", "우편번호를 입력바랍니다.")) return false;          // 우편번호/시
				if(oController.onCheckSub01Validation(oController, oStrasI, null, vStrasI, "I", "상세주소 및 번지를 입력바랍니다")) return false;          // 상세 주소/번지
				if(oController.onCheckSub01Validation(oController, oOrt02I, null, vOrt02I, "I", "지역을 입력바랍니다")) return false;          // 주소2
				if(oController.onCheckSub01Validation(oController, oOrt01I, null, vOrt01I, "I", "시를 입력바랍니다")) return false;          // 주소1
				if(oController.onCheckSub01Validation(oController, oStateL, null, vStateL, "L", "주를 입력바랍니다")) return false;          // 지역
				break;
			case "VN":
				if(oController.onCheckSub01Validation(oController, oVornaI, null, vVornaI, "I", "영문 이름을 입력바랍니다.")) return false;          // 이름
				if(oController.onCheckSub01Validation(oController, oNachnI, null, vNachnI, "I", "영문 성을 입력바랍니다.")) return false;          // 성
				if(oController.onCheckSub01Validation(oController, oGeschR1, oGeschR2, vGeschR, "R", "성별을 선택해 주십시오.")) return false;     // 성별
				if(oController.onCheckSub01Validation(oController, oCtznoI, null, vCtznoI, "I", "Citizen No.를 입력바랍니다.")) return false;          // Citizen No.
				if(oController.onCheckSub01Validation(oController, oNatioL, null, vNatioL, "L", "국적을 선택해 주십시오.")) return false;          // 국적
				if(oController.onCheckSub01Validation(oController, oHndnoI, null, vHndnoI, "I", "휴대폰번호를 입력바랍니다.")) return false;          // 휴대폰번호
				if(oController.onCheckSub01Validation(oController, oGbdatD, null, vGbdatD, "D", "생일을 입력바랍니다.")) return false;          // 생년월일
				if(oController.onCheckSub01Validation(oController, oFamstL, null, vFamstL, "L", "결혼여부를 선택해 주십시오.")) return false;          // 결혼 여부
				...
				if(oController.onCheckSub01Validation(oController, oPstlzI, null, vPstlzI, "I", "우편번호를 입력바랍니다.")) return false;          // 우편번호/시
				if(oController.onCheckSub01Validation(oController, oStrasI, null, vStrasI, "I", "상세주소 및 번지를 입력바랍니다")) return false;          // 상세 주소/번지
				if(oController.onCheckSub01Validation(oController, oOrt01I, null, vOrt01I, "I", "시/지역을 입력바랍니다")) return false;          // 주소2
				if(oController.onCheckSub01Validation(oController, oStateL, null, vStateL, "L", "주를 입력바랍니다")) return false;          // 지역
				break;
		}
	...
	onCheckSub01Validation : function(oController, oControll1, oControll2, vValue, vType, vMSG) {
		switch(vType) {
			case "I" :
				if(vValue == "") {
	...
	saveSub02 : function() {
		...
		if(oController._vMolga != "41") {
			...
			if(vOneData.Anzkl == "") {
				...
				sap.m.MessageBox.alert("기간(년제)을 선택해 주십시오.");
				return;
			}
		}
...
//	경력사항 저장  
	saveSub03 : function() {
		...
		if(vOneData.Begda == null) {
			oBegda.setValueState(sap.ui.core.ValueState.Error);
			sap.m.MessageBox.alert("입사일자를 입력바랍니다.");
			return;
		}
		...
		if(vOneData.Endda == null) {
			oEndda.setValueState(sap.ui.core.ValueState.Error);
			sap.m.MessageBox.alert("퇴사일자를 입력바랍니다.");
			return;
		}
...
//	자격면허 저장  
	saveSub06 : function() {
		...
		if(vOneData.Ctbeg == null) {
			...
			sap.m.MessageBox.alert("취득일자을 입력바랍니다.");
			return;
		}
