...
//	}
	...
	setInputFiled : function(oController) {
		...
		oColumn =  new sap.ui.table.Column({
        	...
        	vAlign : "Middle",
        	multiLabels :  [new sap.m.Label({text : "", textAlign : "Center"}),
        	                new sap.m.Label({text : "상태", textAlign : "Center"})],
            headerSpan : [2,1],
            width : "60px",
		...
		oColumn =  new sap.ui.table.Column({
        	...
        	multiLabels : [new sap.m.Label({text : "발령대상자", textAlign : "Center"}),
        	               new sap.m.Label({text : "* " + "사번", textAlign : "Center"})],
		...
		oColumn =  new sap.ui.table.Column({
        	...
        	vAlign : "Middle",
        	multiLabels : [new sap.m.Label({text : "발령대상자", textAlign : "Center"}),
        	               new sap.m.Label({text : "성명", textAlign : "Center"})],
            headerSpan : [multiHeaderLine,1],
            width : "100px",
        	template: new sap.ui.commons.TextView({
				width:"100%",
		...
		oColumn =  new sap.ui.table.Column({
        	...
        	vAlign : "Middle",
        	multiLabels : [new sap.m.Label({text : "발령대상자", textAlign : "Center"}),
        	               new sap.m.Label({text : "소속", textAlign : "Center"})],
            headerSpan : [multiHeaderLine,1],
            width : "150px",
        	template: new sap.ui.commons.TextView({
				width:"100%",
		...
		oColumn =  new sap.ui.table.Column({
        	...
        	vAlign : "Middle",
        	multiLabels : [new sap.m.Label({text : "발령대상자", textAlign : "Center"}),
        	               new sap.m.Label({text : "직위", textAlign : "Center"})],
            headerSpan : [multiHeaderLine,1],
            width : "100px",
        	template: new sap.ui.commons.TextView({
				width:"100%",
		...
		oColumn =  new sap.ui.table.Column({
        	...
        	vAlign : "Middle",
        	multiLabels : [new sap.m.Label({text : "발령대상자", textAlign : "Center"}),
        	               new sap.m.Label({text : "* " +"발령일", textAlign : "Center"})],
            headerSpan : [multiHeaderLine,1],
            width : "120px",
        	template: new sap.ui.commons.TextView({
				width:"100%",
...
//						return fVal;
		...
		if(oController._vActiveControl && oController._vActiveControl.length) {
			for(var i=0; i<oController._vActiveControl.length; i++) {
				...
				if(Fieldtype.substring(0, 1) == "M") {
					vHeader += "* " + vLabelText; //oController._vActiveControl[i].Label;
				} else {
					vHeader += vLabelText; //oController._vActiveControl[i].Label;
				}
		...
		oColumn =  new sap.ui.table.Column({
        	...
        	vAlign : "Middle",
        	multiLabels : [new sap.m.Label({text :"",  textAlign : "Center"}),
        	               new sap.m.Label({text :"처리결과",  textAlign : "Center"})],
            headerSpan : [1,1],
            template: new sap.ui.commons.TextView({
				width:"100%",
				text : "{Upbigo}",  
...
//	},
	...
	validData : function() {
		...
		var vilidProcess = function() {	
			...
			RetireUploadDataSheet.SetCellValue(idx + vHeaderCount, "Upbigo", "데이터 검증 중입니다. 잠시만 기다려 주십시오.", 0);
