...
////// Bank Key
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label(oController.PAGEID + "_Label_Sub24_Bankl", {text: "은행키", required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
...
////// Bank Account
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label(oController.PAGEID + "_Label_Sub24_Bankn", {text: "은행계좌번호", required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
...
////// 표준백분율
        ...
        var oRequestPanel = new sap.m.Panel(oController.PAGEID + "_POP_Sub24_Panel", {
			...
			headerToolbar : new sap.m.Toolbar({
				...
				content : [new sap.m.Label(oController.PAGEID + "_POP_Sub24_PanelLabel",{text : "은행정보", design : "Bold"}).addStyleClass("L2P13Font"),
