sap.ui.jsview("zui5_hrxx_acteducation.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_acteducation.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "zui5_hrxx_acteducation.EducationRequestList"});		
		this.app.addPage(sap.ui.jsview("zui5_hrxx_acteducation.EducationRequestList", "zui5_hrxx_acteducation.EducationRequestList"));
...
//			backgroundOpacity : 0.5,
	...
	loadModel : function() {
		...
		var sServiceURL1 = this.getUrl("/sap/opu/odata/sap/ZHRXX_EDUCATION_SRV/");
		...
		sap.ui.getCore().setModel(oModel,"ZHRXX_EDUCATION_SRV");
		...
		var oActappModel = new sap.ui.model.odata.ODataModel(sServiceURL3, true, undefined, undefined, undefined, undefined, undefined, false);
		oActappModel.setCountSupported(false);
		sap.ui.getCore().setModel(oActappModel,"ZHRXX_ACTIONAPP_SRV");
		...
		try {
			oActappModel.read("/PersAreaListSet/?$filter=Actty%20eq%20%271%27", 
					null, 
					null, 
					false,
					function(oData, oResponse) {					
		...
		//학력등록 신청 리스트
		var mEducationRegistList = new sap.ui.model.json.JSONModel();
		sap.ui.getCore().setModel(mEducationRegistList, "EduBackgroundRegistSet");
