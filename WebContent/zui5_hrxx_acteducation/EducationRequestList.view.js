sap.ui.jsview("zui5_hrxx_acteducation.EducationRequestList", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_acteducation.EducationRequestList";
	},
	...
	createContent : function(oController) {
		...
		var oColumnList = new sap.m.ColumnListItem(oController.PAGEID + "_COLUMNLIST", {
			...
			cells : [
				...
				}).addStyleClass("L2P13Font"), //입학일자
				new sap.m.Text({
				     text : {path : "Endda",
				    	 formatter : common.Common.DateFormatter
					 }	 
				}).addStyleClass("L2P13Font"), //졸업일자
				new sap.m.Text({
				     text : "{Insti}" ,	 
				}).addStyleClass("L2P13Font"), //학교명 
				new sap.m.Text({
				     text : "{Stext}" 
				}).addStyleClass("L2P13Font"), //학위
				new sap.m.Text({
				     text : "{Rpers}"
		...
		var oTable = new sap.m.Table(oController.PAGEID + "_TABLE", {
			...
			columns : [
			          ...
			          new sap.m.Column({
			        	  ...
			        	  demandPopin: true}), 	  
		        	  new sap.m.Column({
			        	  header: new sap.m.Text({text : oBundleText.getText( "SCHCD")}).addStyleClass("L2P13Font"),
			        	  demandPopin: true,
			        	  hAlign : sap.ui.core.TextAlign.Begin,
			        	  width: "150px",
			        	  minScreenWidth: "tablet"}),  	  
			          new sap.m.Column({
			        	  header: new sap.m.Label({text : oBundleText.getText( "SLABS")}).addStyleClass("L2P13Font"),
			        	  hAlign : sap.ui.core.TextAlign.Begin,
			        	  width: "150px",
			        	  demandPopin: true}),	  
			          new sap.m.Column({
