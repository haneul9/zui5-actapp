sap.ui.jsview("zui5_hrxx_actann.AnnounceContent", {
	...
	*/ 
	createContent : function(oController) {
		...
		var tHtml = "<iframe style='width:100%;border:0px;height:470px;' name='htmleditor1' id='htmleditor1' src='zui5_hrxx_actann/Editor.html'></iframe>";
		var oHtmlEditLayout = new sap.ui.commons.layout.VerticalLayout(oController.PAGEID + "_HTMLEditor",  {
			width : "100%",
			content : new sap.ui.core.HTML({content : tHtml, preferDOM : false})
		});
