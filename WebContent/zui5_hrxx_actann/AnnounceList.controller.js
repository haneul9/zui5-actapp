...
sap.ui.controller("zui5_hrxx_actann.AnnounceList", {
	...
	onBeforeShow: function(evt) {
		...
		var oAnndaFrom = sap.ui.getCore().byId(this.PAGEID + "_Annda_From");
		var oAnndaTo = sap.ui.getCore().byId(this.PAGEID + "_Annda_To");
		
		oAnndaFrom.setDateValue(prevDate);
		oAnndaTo.setDateValue(nextDate);
	},
	...
	onPressSearch : function(oEvent) {
		...
		var oAnndaFrom = sap.ui.getCore().byId(oController.PAGEID + "_Annda_From");
		var oAnndaTo = sap.ui.getCore().byId(oController.PAGEID + "_Annda_To");
		
	    var filterString = "";
	    
	    filterString += "/?$filter=";  
		filterString += "(Annda%20ge%20datetime%27" + oAnndaFrom.getValue() + "T00%3a00%3a00%27%20and%20Annda%20le%20datetime%27" + oAnndaTo.getValue() + "T00%3a00%3a00%27)";
