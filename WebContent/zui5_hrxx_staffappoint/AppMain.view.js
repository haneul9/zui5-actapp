sap.ui.jsview("zui5_hrxx_staffappoint.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf zui5_hrxx_staffappoint.AppMain
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_staffappoint.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "zui5_hrxx_staffappoint.Staff"});		
		this.app.addPage(sap.ui.jsview("zui5_hrxx_staffappoint.Staff", "zui5_hrxx_staffappoint.Staff"));
	...
	loadModel : function() {
		...
		sap.ui.getCore().setModel(mEmpCodeList, "EmpCodeList");
