...
//		this._vDeafultContry = null;
//	    switch(this._vMolga) {
//	    	case "01" : oController._vDeafultContry = {Land1 : "DE", Land1tx : "Germany", Natiotx : "Germany"}; break;
//	    	case "06" : oController._vDeafultContry = {Land1 : "FR", Land1tx : "France", Natiotx : "Franch"}; break;
//		    case "07" : oController._vDeafultContry = {Land1 : "CA", Land1tx : "Canadian", Natiotx : "Canadian"}; break;
//			case "08" : oController._vDeafultContry = {Land1 : "GB", Land1tx : "United Kingdom", Natiotx : "United Kingdom"}; break;
//		    case "10" : oController._vDeafultContry = {Land1 : "US", Land1tx : "USA", Natiotx : "American US"}; break;
//			case "11" : oController._vDeafultContry = {Land1 : "IE", Land1tx : "Ireland", Natiotx : "Ireland"}; break;
//			case "13" : oController._vDeafultContry = {Land1 : "AU", Land1tx : "Australian AU", Natiotx : "Australian AU"}; break;
//			case "18" : oController._vDeafultContry = {Land1 : "CZ", Land1tx : "Czech Republic", Natiotx : "Czech Republic"}; break;
//			case "22" : oController._vDeafultContry = {Land1 : "JP", Land1tx : "Japan", Natiotx : "Japan"}; break;
//			case "25" : oController._vDeafultContry = {Land1 : "SG", Land1tx : "Singapore", Natiotx : "Singapore"}; break;
//			case "32" : oController._vDeafultContry = {Land1 : "MX", Land1tx : "Mexico", Natiotx : "Mexico"}; break;
//			case "39" : oController._vDeafultContry = {Land1 : "CL", Land1tx : "Chile", Natiotx : "Chile"}; break;			
//			default : break;
//		}
		
		var oTitle = sap.ui.getCore().byId(this.PAGEID + "_PAGETITLE");
		if(this._vActionType == "V") oTitle.setText(oBundleText.getText("VIEW_CONT_TITLE"));
		else if(this._vActionType == "M")  oTitle.setText(oBundleText.getText("MODIFY_CONT_TITLE"));
		else oTitle.setText(oBundleText.getText("ADD_CONT_TITLE"));
...
//	},
	...
	setSpecialCodeData : function(Fieldname, vAddFilter, select) {
		...
		if(select) vCodeModel.EmpCodeListSet.push({Field : Fieldname, Ecode : "0000", Etext : oBundleText.getText("SELECTDATA")});
