...
/////////////////////////////////////////////////////////////////////////////////////////////	
	...
	onDisplaySearchZipcodeDialog : function(oEvent) {
		window.open("/sap/bc/ui5_ui5/sap/ZL2P01UI59001/zip_search.html?CBF=fn_SetAddr", "pop", "width=450,height=550, scrollbars=yes, resizable=yes");
	},
...
function fn_SetAddr(Zip ,Addr1,Addr2,jibunAddr) {
	console.log(Zip);
	var oView = sap.ui.getCore().byId("zui5_hrxx_actapp2.ActRecPInfo");
	var oController = oView.getController();	
	var Pstlz = Zip;
...
//	sap.ui.getCore().byId("ZKL_PA_EmpProfile_1020_KR_" + Gubun + "_Ort02").setValue(Ort02);
	...
	if(oState) {
		for(var i = 0 ; i < oState.getItems().length ; i++){
			if(oState.getItems()[i].getText() == Bezei){
				oState.setSelectedItem(oState.getItems()[i]);
				break;
			}
		}
	}
	if(oOrt01) oOrt01.setValue(Ort01);
	if(oOrt02) oOrt02.setValue(Ort02);
	if(oLocat) oLocat.setValue(Ort02);
};
