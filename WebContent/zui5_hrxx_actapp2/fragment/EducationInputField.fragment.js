sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.EducationInputField", {
	...
	createContent : function(oController) {
		...
		var oDialog = new sap.m.Dialog(oController.PAGEID + "_Input_Dialog",{
			...
			contentHeight : "130px",
			showHeader : true,
			beginButton : new sap.m.Button({text : oBundleText.getText("CONFIRM_BTN"), icon: "sap-icon://accept", press : oController.onPressConfirmInput}), //
			endButton : new sap.m.Button({text : oBundleText.getText("CANCEL_BTN"), icon: "sap-icon://sys-cancel-2", press : oController.onCOCloseInput}),
		});
