sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.ActRecPInfo_Sub01_Form_25", {
	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf fragment.ActRecPInfo_Sub01_Form_25
	*/
...
///// TITLE
		...
		var oAnred = new sap.m.Select(oController.PAGEID + "_Sub01_Form_25_Anred", {
     	    width : "95%",
	...
	/////// 영문 이름
		...
		var oVorna = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Vorna", {
			type : "Text",
			width : "95%",
...
/////// 영문 중간이름
		...
		var oMidnm = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Midnm", {
			type : "Text",
			width : "95%",
...
/////// 영문 성
		...
		var oNachn = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Nachn", {
			type : "Text",
			width : "95%",
...
/////// Known As
		...
		var oRufnm = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Rufnm", {
			type : "Text",
			width : "95%",
...
/////// 성별
		...
		var oGesch1 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_25_Gesch1", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
			text : oBundleText.getText("MALE")
		});
		var oGesch2 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_25_Gesch2", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
...
/////// 생일
		...
		var oGbdat = new sap.m.DatePicker(oController.PAGEID + "_Sub01_Form_25_Gbdat", {
			width : "95%",
...
/////// 국적
		...
		var oNatio = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Natio", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
...
///// 신분증번호
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("PERID_25"), required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
		
		var oPerid = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Perid", {
			type : "Text",
			width : "95%",
			maxLength : 11,
			liveChange : oController.changeModifyContent,
...
/////// 결혼여부
		...
		var oFamst = new sap.m.Select(oController.PAGEID + "_Sub01_Form_25_Famst", {
     	   width : "95%",
     	   enabled : !oController._DISABLED,
...
///// Primary 휴대폰번호
		...
		var oTelno = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Telno", {
			type : "Text",
			width : "95%",
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED
	...
	/////// 전화번호
		...
		var oHndno = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Hndno", {
			type : "Text",
			width : "95%",
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED
...
///// 이메일
		...
		var oEmail = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Email", {
			type : "Text",
			width : "95%",
...
/////// Communication Language
		...
		var oSprsl = new sap.m.Select(oController.PAGEID + "_Sub01_Form_25_Sprsl", {
     	   width : "95%",
     	   enabled : !oController._DISABLED,
        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
/////// 상세주소 -> 상세주소 및 번지
		...
		var oStras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Stras", {
			type : "Text",
			width : "95%",
...
/////// 지역 -> 주
		...
		var oState = new sap.m.Select(oController.PAGEID + "_Sub01_Form_25_State", {
     	   width : "95%",
     	   change : oController.changeModifyContent,
     	   enabled : !oController._DISABLED
        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
/////// 상세주소2 -> 상세주소 및 번지
		...
		var oLocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Locat", {
			type : "Text",
			width : "95%",
...
/////// 우편번호
		...
		var oPstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Pstlz", {
			type : "Text",
			width : "95%",
...
/////// 주소2 -> 시
		...
		var oOrt01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Ort01", {
			type : "Text",
			width : "95%",
...
/////// 주소-국가
		...
		var oLand1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Land1", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
...
//		oRow.addCell(oCell);
//		
//		var oEmecname2 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emecname2", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecrelat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emecrelat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmectelnr = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emectelnr", {
//			type : "Text",
//			width : "38.6%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emecstras", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstate = new sap.m.Select(oController.PAGEID + "_Sub01_Form_25_Emecstate", {
//     	   width : "95%",
//     	   change : oController.changeModifyContent,
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//		oRow.addCell(oCell);
//		
//		var oEmeclocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emeclocat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecpstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emecpsltz", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecort01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emecort01", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecland1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_25_Emecland1", {
//			width : "95%",
//			showValueHelp: true,
//			valueHelpOnly: true,
//			valueHelpRequest: oController.onDisplaySearchNatioDialog,
