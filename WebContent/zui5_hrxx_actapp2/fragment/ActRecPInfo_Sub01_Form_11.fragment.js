sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.ActRecPInfo_Sub01_Form_11", {
	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf fragment.ActRecPInfo_Sub01_Form_10
	*/
...
///// TITLE
		...
		var oAnred = new sap.m.Select(oController.PAGEID + "_Sub01_Form_11_Anred", {
     	    width : "95%",
	...
	/////// 영문 이름
		...
		var oVorna = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Vorna", {
			type : "Text",
			width : "95%",
...
/////// 영문 중간이름
		...
		var oMidnm = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Midnm", {
			type : "Text",
			width : "95%",
...
/////// 영문 성
		...
		var oNachn = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Nachn", {
			type : "Text",
			width : "95%",
	...
	/////// 이니셜
		...
		var oInits = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Inits", {
			type : "Text",
			width : "95%",
...
/////// Known As
		...
		var oRufnm = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Rufnm", {
			type : "Text",
			width : "95%",
	...
	/////// Secondary Title
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: "Second title" /*oBundleText.getText("TITL2_08")*/}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
		
		var oTitl2 = new sap.m.Select(oController.PAGEID + "_Sub01_Form_11_Titl2", {
     	    width : "95%",
     	    change : oController.changeModifyContent,
     	    enabled : !oController._DISABLED
        }).addStyleClass("L2P13Font"); //.setModel(sap.ui.getCore().getModel("EmpCodeList"));
	...
	/////// 생일
		...
		var oGbdat = new sap.m.DatePicker(oController.PAGEID + "_Sub01_Form_11_Gbdat", {
			width : "95%",
...
/////// 성별
		...
		var oGesch1 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_11_Gesch1", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
			text : oBundleText.getText("MALE")
		});
		var oGesch2 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_11_Gesch2", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
	...
	/////// Place of Birth
		...
		var oGbort = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Gbort", {
			type : "Text",
			width : "95%",
	...
	///// 신분증번호
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("PERID_11"), required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
		
		var oPerid = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Perid", {
			type : "Text",
			width : "95%",
			maxLength : 11,
			liveChange : oController.changeModifyContent,
	...
	/////// 결혼여부
		...
		var oFamst = new sap.m.Select(oController.PAGEID + "_Sub01_Form_11_Famst", {
     	   width : "95%",
     	   enabled : !oController._DISABLED,
	...
	/////// 종교
		...
		var oKonfe = new sap.m.Select(oController.PAGEID + "_Sub01_Form_11_Konfe", {
     	   width : "95%",
     	   change : oController.changeModifyContent,
     	   enabled : !oController._DISABLED
        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
/////// 국적
		...
		var oNatio = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Natio", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
	...
	/////// 두번째 국적
		...
		var oNati2 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Nati2", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
...
///// Primary 휴대폰번호
		...
		var oTelno = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Telno", {
			type : "Text",
			width : "95%",
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED
	...
	/////// 전화번호
		...
		var oHndno = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Hndno", {
			type : "Text",
			width : "95%",
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED
...
///// 이메일
		...
		var oEmail = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Email", {
			type : "Text",
			width : "95%",
...
/////// Communication Language
		...
		var oSprsl = new sap.m.Select(oController.PAGEID + "_Sub01_Form_11_Sprsl", {
     	   width : "95%",
     	   enabled : !oController._DISABLED,
        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
/////// 상세주소 -> 상세주소 및 번지
		...
		var oStras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Stras", {
			type : "Text",
			width : "95%",
...
/////// 지역 -> 주
		...
		var oState = new sap.m.Select(oController.PAGEID + "_Sub01_Form_11_State", {
     	   width : "95%",
     	   change : oController.changeModifyContent,
     	   enabled : !oController._DISABLED
        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
/////// 상세주소2 -> 상세주소 및 번지
		...
		var oLocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Locat", {
			type : "Text",
			width : "95%",
...
/////// 우편번호
		...
		var oPstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Pstlz", {
			type : "Text",
			width : "95%",
...
/////// 주소2 -> 시
		...
		var oOrt01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Ort01", {
			type : "Text",
			width : "95%",
...
/////// 주소-국가
		...
		var oLand1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Land1", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
			valueHelpRequest: oController.onDisplaySearchNatioDialog,
...
//		oRow.addCell(oCell);
//		
//		var oEmecname2 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emecname2", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecrelat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emecrelat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmectelnr = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emectelnr", {
//			type : "Text",
//			width : "38.6%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emecstras", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstate = new sap.m.Select(oController.PAGEID + "_Sub01_Form_11_Emecstate", {
//     	   width : "95%",
//     	   change : oController.changeModifyContent,
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//		oRow.addCell(oCell);
//		
//		var oEmeclocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emeclocat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecpstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emecpsltz", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecort01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emecort01", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecland1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_11_Emecland1", {
//			width : "95%",
//			showValueHelp: true,
//			valueHelpOnly: true,
//			valueHelpRequest: oController.onDisplaySearchNatioDialog,
