...
///// 신분증번호
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("PERID_13"), required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
...
//		oRow.addCell(oCell);
//		
//		var oEmecname2 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emecname2", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecrelat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emecrelat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmectelnr = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emectelnr", {
//			type : "Text",
//			width : "38.6%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emecstras", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstate = new sap.m.Select(oController.PAGEID + "_Sub01_Form_13_Emecstate", {
//     	   width : "95%",
//     	   change : oController.changeModifyContent,
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//		oRow.addCell(oCell);
//		
//		var oEmeclocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emeclocat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecpstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emecpsltz", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecort01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emecort01", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecland1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_13_Emecland1", {
//			width : "95%",
//			showValueHelp: true,
//			valueHelpOnly: true,
//			valueHelpRequest: oController.onDisplaySearchNatioDialog,
