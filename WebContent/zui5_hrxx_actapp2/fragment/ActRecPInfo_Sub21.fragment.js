sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.ActRecPInfo_Sub21", {
	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf fragment.ActRecPInfo_Sub21
	*/
...
//		oRow.addCell(oCell);
//		
//		var oBegda = new sap.m.DatePicker(oController.PAGEID + "_Sub21_Begda", {
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEndda = new sap.m.DatePicker(oController.PAGEID + "_Sub21_Endda", {
//			width : "95%",
//			valueFormat : "yyyy-MM-dd",
//	    	displayFormat : gDtfmt,
//	    	change : oController.changeDate,
...
//		oRow.addCell(oCell);
//		
//		var oSerty = new sap.m.Select(oController.PAGEID + "_Sub21_Serty", {
//     	   width : "95%",
//     	   enabled : !oController._DISABLED
...
//		oRow.addCell(oCell);
//		
//		var oPreas = new sap.m.Select(oController.PAGEID + "_Sub21_Preas", {
//     	   width : "95%",
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//		oRow.addCell(oCell);
//		
//		var oJobcl = new sap.m.Select(oController.PAGEID + "_Sub21_Jobcl", {
//     	   width : "95%",
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//		oRow.addCell(oCell);
//		
//		var oMrank = new sap.m.Select(oController.PAGEID + "_Sub21_Mrank", {
//     	   width : "95%",
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//				content : [new sap.m.Label({text : oBundleText.getText( "TSUB21F"), design : "Bold"}).addStyleClass("L2P13Font"),
//				           new sap.m.ToolbarSpacer()]
//			}).addStyleClass("L2PToolbarNoBottomLine"),
//			content : [oRequestLayout]
//		});
		
		var oLayout = new sap.ui.commons.layout.VerticalLayout(oController.PAGEID + "_Sub21_LAYOUT",  {
			width : "100%",
			content : []
		});
