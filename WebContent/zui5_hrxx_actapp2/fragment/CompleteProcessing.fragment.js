...
sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.CompleteProcessing", {
	...
	createContent : function(oController) {
		...
		var oTable = new sap.m.Table(oController.PAGEID + "_CP_Table", {
			...
			columns : [
		        	  ...
		        	  new sap.m.Column({
			        	  header: new sap.m.Label({text : oBundleText.getText("PROCESS_STATUS")}).addStyleClass("L2P13Font"),
			        	  demandPopin: true,
			        	  hAlign : sap.ui.core.TextAlign.Begin,
			        	  width : "150px",
			        	  minScreenWidth: "tablet"}),  	  
...
//				 new sap.ui.model.Filter("Pchk", sap.ui.model.FilterOperator.EQ, true)
		...
		var oMesasge = new sap.m.Toolbar({
			...
			content : [new sap.m.Label({text : oBundleText.getText("MSG_ACTAPP_WAIT_NOTICE")}).addStyleClass("L2P13Font L2PFontColorBlue")]
...
//		});
		...
		var oDialog = new sap.m.Dialog(oController.PAGEID + "_CP_Dialog",{
			...
			endButton : new sap.m.Button(oController.PAGEID + "_CP_ConfirmBtn", {text : oBundleText.getText("CONFIRM_BTN"), icon: "sap-icon://accept", press : oController.onCPClose, enabled : false})
		});
