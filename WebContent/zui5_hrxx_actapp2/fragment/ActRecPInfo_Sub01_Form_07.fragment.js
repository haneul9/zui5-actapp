sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.ActRecPInfo_Sub01_Form_07", {
	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf fragment.ActRecPInfo_Sub01_Form_07
	*/
...
/////// 성별
		...
		var oGesch3 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_07_Gesch3", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
			text : "TBD" //oBundleText.getText("UNKNOWN")
		});
...
///// 신분증번호
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("PERID_07"), required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
		...
		var oPerid = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Perid", {
			type : "Number",
			width : "95%",
			maxLength : 9, //common.Common.getODataPropertyLength("ZL2P01GW0001_SRV", "RecruitingSubjects", "Perid"),
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED
		});
...
/////// 지역 -> 주
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: "Province" /*oBundleText.getText("STATE_10")*/, required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
...
//		oRow.addCell(oCell);
//		
//		var oEmecname2 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emecname2", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecrelat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emecrelat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmectelnr = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emectelnr", {
//			type : "Text",
//			width : "38.6%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emecstras", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstate = new sap.m.Select(oController.PAGEID + "_Sub01_Form_07_Emecstate", {
//     	   width : "95%",
//     	   change : oController.changeModifyContent,
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//		oRow.addCell(oCell);
//		
//		var oEmeclocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emeclocat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecpstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emecpsltz", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecort01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emecort01", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecland1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_07_Emecland1", {
//			width : "95%",
//			showValueHelp: true,
//			valueHelpOnly: true,
//			valueHelpRequest: oController.onDisplaySearchNatioDialog,
