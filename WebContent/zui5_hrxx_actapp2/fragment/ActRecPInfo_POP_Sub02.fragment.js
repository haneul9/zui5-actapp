...
/////// 학교 -> 학교명
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("SCHCDNM"), required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
...
/////// 전공
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label(oController.PAGEID + "_Sub02_Sltp1_Label", {text: oBundleText.getText("SLTP1")}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
...
/////// Qualification
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell(oController.PAGEID + "_Sub02_Zzquali_cell1",{
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
		...
		var oZzquali = new sap.m.Input(oController.PAGEID + "_Sub02_Zzquali", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
			valueHelpRequest: oController.SearchQualiDialog,
			customData: new sap.ui.core.CustomData({key : "Key", value : ""})
		}).addStyleClass("L2P13Font");
	
		oCell = new sap.ui.commons.layout.MatrixLayoutCell(oController.PAGEID + "_Sub02_Zzquali_cell2",{
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : oZzquali
		}).addStyleClass("L2PInputTableData L2PPaddingLeft10");
...
//			hAlign : sap.ui.commons.layout.HAlign.Begin,
//			vAlign : sap.ui.commons.layout.VAlign.Middle,
//			content : [new sap.m.Label({text: oBundleText.getText("ANZKL"), required : true}).addStyleClass("L2P13Font")]
//		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
//		oRow.addCell(oCell);
//
...
//			hAlign : sap.ui.commons.layout.HAlign.Begin,
//			vAlign : sap.ui.commons.layout.VAlign.Middle,
//			content : [new sap.m.Label({text: oBundleText.getText("ZZFMART") + " / " + oBundleText.getText("ZZACKSL")}).addStyleClass("L2P13Font")]
//		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
//		oRow.addCell(oCell);
//		
...
//        }).addStyleClass("L2P13Font");
//		
//		oCell = new sap.ui.commons.layout.MatrixLayoutCell(oController.PAGEID + "_Sub02_Zzfmark_DataField",{
//			hAlign : sap.ui.commons.layout.HAlign.Begin,
//			vAlign : sap.ui.commons.layout.VAlign.Middle,
//			colSpan : 3,
...
//		oRequestLayout.addRow(oRow);
		...
		var oDialog = new sap.m.Dialog(oController.PAGEID + "_POP_Sub02_Dialog",{
			...
			title : oBundleText.getText("TSUB02F_2"),
