...
/////// 언어구분
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			content : [new sap.m.Label({text: oBundleText.getText("AUSPR"), required : true}).addStyleClass("L2P13Font")]
...
/////// 숙련도
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,			
			content : [new sap.m.Label({text: oBundleText.getText("AUSPRTX"), required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
		...
		var oDialog = new sap.m.Dialog(oController.PAGEID + "_POP_Sub22_Dialog",{
			...
			title : oBundleText.getText("TSUB22F"),
