sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.ActRecPInfo_Sub01_Form_10", {
...
///// TITLE
		...
		var oAnred = new sap.m.Select(oController.PAGEID + "_Sub01_Form_10_Anred", {
     	    width : "95%",
	...
	/////// 영문 이름
		...
		var oVorna = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Vorna", {
			type : "Text",
			width : "95%",
...
/////// 영문 중간이름
		...
		var oMidnm = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Midnm", {
			type : "Text",
			width : "95%",
...
/////// 영문 성
		...
		var oNachn = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Nachn", {
			type : "Text",
			width : "95%",
...
/////// Known As
		...
		var oRufnm = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Rufnm", {
			type : "Text",
			width : "95%",
...
/////// 성별
		...
		var oGesch1 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_10_Gesch1", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
			text : oBundleText.getText("MALE")
		});
		var oGesch2 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_10_Gesch2", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
			text : oBundleText.getText("FEMALE")
		});
		var oGesch3 = new sap.m.RadioButton(oController.PAGEID + "_Sub01_Form_10_Gesch3", {
			groupName : "Gesch",
			select : oController.changeModifyContent,
			text : "TBD"
		});
...
/////// 생일
		...
		var oGbdat = new sap.m.DatePicker(oController.PAGEID + "_Sub01_Form_10_Gbdat", {
			width : "95%",
...
/////// 국적
		...
		var oNatio = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Natio", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
...
///// 신분증번호
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("PERID_10"), required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
		
		var oPerid = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Perid", {
			type : "Text",
			width : "95%",
			maxLength : 11,
			placeholder : "XXX-XX-XXXX",
			liveChange : oController.onChangeSSN,
			enabled : !oController._DISABLED
		});
...
/////// 결혼여부
		...
		var oFamst = new sap.m.Select(oController.PAGEID + "_Sub01_Form_10_Famst", {
     	   width : "95%",
     	   enabled : !oController._DISABLED,
...
///// Primary 휴대폰번호
		...
		var oTelno = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Telno", {
			type : "Text",
			width : "95%",
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED 
	...
	/////// 전화번호
		...
		var oHndno = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Hndno", {
			type : "Text",
			width : "95%",
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED
...
///// 이메일
		...
		var oEmail = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Email", {
			type : "Text",
			width : "95%",
...
/////// Communication Language
		...
		var oSprsl = new sap.m.Select(oController.PAGEID + "_Sub01_Form_10_Sprsl", {
     	   width : "95%",
     	   enabled : !oController._DISABLED,
        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
/////// 상세주소 -> 상세주소 및 번지
		...
		var oStras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Stras", {
			type : "Text",
			width : "95%",
			maxLength : 25, //common.Common.getODataPropertyLength("ZL2P01GW0001_SRV", "RecruitingSubjects", "Stras"),
			liveChange : oController.changeModifyContent,
			enabled : !oController._DISABLED
		});
...
/////// 지역 -> 주
		...
		var oState = new sap.m.Select(oController.PAGEID + "_Sub01_Form_10_State", {
     	   width : "95%",
     	   change : oController.changeModifyContent,
     	   enabled : !oController._DISABLED
        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
/////// 상세주소2 -> 상세주소 및 번지
		...
		var oLocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Locat", {
			type : "Text",
			width : "95%",
...
/////// 우편번호
		...
		var oPstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Pstlz", {
			type : "Text",
			width : "95%",
...
/////// 주소2 -> 시
		...
		var oOrt01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Ort01", {
			type : "Text",
			width : "95%",
...
/////// 주소-국가
		...
		var oLand1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Land1", {
			width : "95%",
			showValueHelp: true,
			valueHelpOnly: true,
...
//		oRow.addCell(oCell);
//		
//		var oEmecname2 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emecname2", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecrelat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emecrelat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmectelnr = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emectelnr", {
//			type : "Text",
//			width : "38.6%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstras = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emecstras", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecstate = new sap.m.Select(oController.PAGEID + "_Sub01_Form_10_Emecstate", {
//     	   width : "95%",
//     	   change : oController.changeModifyContent,
//     	   enabled : !oController._DISABLED
//        }).addStyleClass("L2P13Font").setModel(sap.ui.getCore().getModel("EmpCodeList"));
...
//		oRow.addCell(oCell);
//		
//		var oEmeclocat = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emeclocat", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecpstlz = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emecpsltz", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecort01 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emecort01", {
//			type : "Text",
//			width : "95%",
...
//		oRow.addCell(oCell);
//		
//		var oEmecland1 = new sap.m.Input(oController.PAGEID + "_Sub01_Form_10_Emecland1", {
//			width : "95%",
//			showValueHelp: true,
//			valueHelpOnly: true,
//			valueHelpRequest: oController.onDisplaySearchNatioDialog,
