sap.ui.jsfragment("zui5_hrxx_actapp2.fragment.ActRecPInfo_Sub24_08", {
	...
	*/
	...
	createContent : function(oController) {
		...
		var oColumnList = new sap.m.ColumnListItem(oController.PAGEID + "_Sub24_COLUMNLIST", {
			...
			cells : [ 
					    new sap.m.Text({
					    	text : {path : "Bnksa", formatter : function(fVal) {
		...
		var oTable = new sap.m.Table(oController.PAGEID + "_Sub24_TABLE", {
			...
			columns : [
		        	  ...
		        	  new sap.m.Column({
			        	  ...
			        	  demandPopin: true}),
		        	  new sap.m.Column({
			        	  header: new sap.m.Label({text : "Building Society No."}).addStyleClass("L2P13Font"),
			        	  hAlign : sap.ui.core.TextAlign.Center,
			        	  demandPopin: true}),
		        	  new sap.m.Column({
