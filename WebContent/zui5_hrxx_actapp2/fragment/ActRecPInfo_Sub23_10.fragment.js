...
/////// 장애여부 상태
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("DISAB"), required : false}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
...
//		var oDisle = new sap.m.DatePicker(oController.PAGEID + "_Sub23_Disle", {
//			width : "95%",
...
/////// 보훈 유형  -- 미국만
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("VETST"), required : false}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
		...
		oVetsLayout.createRow(new sap.ui.commons.layout.MatrixLayoutCell({
			...
			content : new sap.m.Toolbar({
				...
				content : [oVets5, 
				           ...
				           new sap.m.Label(oController.PAGEID + "_Sub23_Dcrdt_Label", {text : oBundleText.getText("DCRDT"), visibale : false}),
...
//				design : sap.m.ToolbarDesign.Auto,
//				content : [new sap.m.Label({text : oBundleText.getText( "TSUB23F"), design : "Bold"}).addStyleClass("L2P13Font"),
