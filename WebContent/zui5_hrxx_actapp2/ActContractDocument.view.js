sap.ui.jsview("zui5_hrxx_actapp2.ActContractDocument", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_actapp2.ActContractDocument";
	},
		...
		var oListPanel = new sap.m.Panel({
			...
			headerToolbar : new sap.m.Toolbar({
				...
				content : [new sap.ui.core.Icon({src : "sap-icon://collaborate", size : "1.0rem", color : "#666666"}),
				           ...
				           new sap.m.ToolbarSpacer(),
				           new sap.m.Button(oController.PAGEID + "_Add_Rec_Btn",{text: oBundleText.getText("ADD_CONT_BTN"), icon : "sap-icon://add-contact", press : oController.addRecPerson, visible : false}),
				           new sap.m.Button(oController.PAGEID + "_Mod_Rec_Btn",{text: oBundleText.getText("MODIFY_CONT_BTN"), icon : "sap-icon://edit", press : oController.modifyRecPerson, visible : false}),
				           new sap.m.Button(oController.PAGEID + "_View_Rec_Btn",{text: oBundleText.getText("VIEW_CONT_BTN"), icon : "sap-icon://personnel-view", press : oController.viewRecPerson, visible : false}),
		...
		var oPage = new sap.m.Page(oController.PAGEID + "_PAGE", {
			...
			customHeader : new sap.m.Bar({
								...
								contentMiddle : new sap.m.Text({
									   			text : oBundleText.getText( "TITLE_RECACTREQ_REG_3RD")
