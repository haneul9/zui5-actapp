...
sap.ui.jsview("zui5_hrxx_actcerti.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_actcerti.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "zui5_hrxx_actcerti.CertiAppMain"});		
		this.app.addPage(sap.ui.jsview("zui5_hrxx_actcerti.CertiAppMain", "zui5_hrxx_actcerti.CertiAppMain"));
...
//        });
		...
		var oCertiRegistrationList = new sap.ui.model.json.JSONModel();
		sap.ui.getCore().setModel(oCertiRegistrationList, "CertiRegistrationList");
		...
		//코드 리스트
		var oCertiTypeSearchList = new sap.ui.model.json.JSONModel();
		sap.ui.getCore().setModel(oCertiTypeSearchList, "CertiTypeSearchList");
		oCertiTypeSearchList.setSizeLimit(500);
	},
