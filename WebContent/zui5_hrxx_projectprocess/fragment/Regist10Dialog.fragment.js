sap.ui.jsfragment("zui5_hrxx_projectprocess.fragment.Regist10Dialog", {
...
//        });
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			content : [new sap.m.Label({text: "BG",	required : true}).addStyleClass("L2P13Font")]
        ...
        oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Input(oController.PAGEID + "_10_Bgoid",{
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Label({text: oBundleText.getText("APRNR"),required : true}).addStyleClass("L2P13Font")]
		}).addStyleClass("L2PInputTableLabel L2PPaddingLeft10");
		oRow.addCell(oCell);
        ...
        oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			hAlign : sap.ui.commons.layout.HAlign.Begin,
			vAlign : sap.ui.commons.layout.VAlign.Middle,
			content : [new sap.m.Input(oController.PAGEID + "_10_Aprnr",{
		...
		var oDialog = new sap.m.Dialog(oController.PAGEID + "_10_Dialog",{
