sap.ui.jsview("zui5_hrxx_projectprocess.ApprovalPeriod", {
	

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf zui5_hrxx_projectprocess.ApprovalPeriod
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_projectprocess.ApprovalPeriod";
	},
...
//        });  
		...
		var oFilePanel = new sap.m.Panel({
			...
			headerToolbar : new sap.m.Toolbar({
				...
				content : [new sap.m.Label({text : oBundleText.getText("TITLE_PROJECT_PROCESS30"), design : "Bold"}).addStyleClass("L2P13Font"),
				          ]
