...
sap.ui.controller("zui5_hrxx_projectprocess.ApprovalPeriod", {
	PAGEID : "ApprovalPeriod",
	_Bizty : "",
	_vPersa : "",
...
*/
	...
	onPressSearch : function(oEvent) {
		var oView = sap.ui.getCore().byId("zui5_hrxx_projectprocess.ApprovalPeriod");
				...
				try {
					...
					oModel.remove(
						    ...
						    function (oData, response) {
								process_result = true;
								common.Common.log("Sucess RetirementApprovalPeriodSet Remove !!!");
						    },
						    function (oError) {
						    	var Err = {};
								if (oError.response) {
