sap.ui.jsview("zui5_hrxx_actretire.AppMain", {

	/** Specifies the Controller belonging to this View. 
	* In the case that it is not implemented, or that "null" is returned, this View does not have a Controller.
	* @memberOf zui5_hrxx_actretire.AppMain
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_actretire.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "zui5_hrxx_actretire.RetireRequestList"});		
		this.app.addPage(sap.ui.jsview("zui5_hrxx_actretire.RetireRequestList", "zui5_hrxx_actretire.RetireRequestList"));
