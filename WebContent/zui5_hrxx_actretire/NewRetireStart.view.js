sap.ui.jsview("zui5_hrxx_actretire.NewRetireStart", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_actretire.NewRetireStart";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oRetireOptionLayout = new sap.ui.commons.layout.MatrixLayout({
			width : "100%",
			layoutFixed : false,
			columns : 4,
			widths: ["15%","35%","15%","35%"],
