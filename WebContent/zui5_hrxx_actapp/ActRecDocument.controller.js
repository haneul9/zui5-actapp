	...
	setRecSubjectListColumn : function(oController) {
		...
		if(oController._vMolga == "41") {
			vColumns = [ {id : "Pchk", label : "", control : "CheckBox", width : 30, align : "Center"},
		                 ...
		                 {id : "Actda", label : oBundleText.getText("ACTDA"), control : "Hidden1", width : "80", align: "Center"},		//발령일
		                 {id : "Ename", label : oBundleText.getText("ENAME"), control : "Hidden", width : "80", align: "Center"},		//발령일
