...
sap.ui.controller("zui5_hrxx_actapp.ActAppAnnounce", {
...
//			if(this._vDocty == "20") {
//				zui5_hrxx_actapp.common.Common.setRecSubjectListColumn(this);
//			} else {
//				zui5_hrxx_actapp.common.Common.setSubjectListColumn(this);
//			}			
...
//			if(oAllCheckbox) oAllCheckbox.setChecked(true);
	...
	onChangeData : function(oEvent) {
		var oView = sap.ui.getCore().byId("zui5_hrxx_actapp.ActAppAnnounce");
	...
	onPressSave : function(oEvent) {
		...
		if(check_idxs.length < 1) {
			sap.m.MessageBox.alert(oBundleText.getText("MSG_ANNOUNCE_TARGET"));
			return false;
		}
...
//		var oHTML = sap.ui.getCore().byId(oController.PAGEID + "_AAP_HTML");
	...
	onPressAnnounce  : function(oEvent) {
		...
		var DataProcess = function() {
			...
			var msg = oBundleText.getText("MSG_ANNOUNCED");
