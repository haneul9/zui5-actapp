...
sap.ui.jsview("zui5_hrxx_actcertisupport.AppMain", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_actcertisupport.AppMain";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		this.app = new sap.m.App({initialPage: "zui5_hrxx_actcertisupport.FeeManagement"});		
		this.app.addPage(sap.ui.jsview("zui5_hrxx_actcertisupport.FeeManagement", "zui5_hrxx_actcertisupport.FeeManagement"));
...
//        });
		...
		var sServiceURL1 = this.getUrl("/sap/opu/odata/sap/ZHRXX_CERTI_SRV/");
		...
		sap.ui.getCore().setModel(oModel,"ZHRXX_CERTI_SRV");
		...
		var oCertiFee = new sap.ui.model.json.JSONModel();
		sap.ui.getCore().setModel(oCertiFee, "CertiFee");
		
		var oCertiFeeSupport = new sap.ui.model.json.JSONModel();
		sap.ui.getCore().setModel(oCertiFeeSupport, "CertiFeeSupport");
		...
		try {
	    	...
	    	if(vScryn != "X") {
	    		document.location.href = "/sap/bc/ui5_ui5/sap/zhrxx_common/NoAuth.html";
	    		return;
	    	}
		} catch(ex) {
		...
		var oFileList = new sap.ui.model.json.JSONModel();
		sap.ui.getCore().setModel(oFileList, "FileList");
	},
