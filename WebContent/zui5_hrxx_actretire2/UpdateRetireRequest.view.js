sap.ui.jsview("zui5_hrxx_actretire2.UpdateRetireRequest", {
	...
	*/ 
	getControllerName : function() {
		return "zui5_hrxx_actretire2.UpdateRetireRequest";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var oIConFilter1 = new sap.m.IconTabFilter(oController.PAGEID + "_ICONFILTER_1",{
			...
			content : sap.ui.jsfragment("zui5_hrxx_actretire2.fragment.Overview", oController)
		});
		...
		var oIConFilter2 = new sap.m.IconTabFilter(oController.PAGEID + "_ICONFILTER_2",{
			...
			content : sap.ui.jsfragment("zui5_hrxx_actretire2.fragment.ChiefFaceToFace", oController)			
		});
		...
		var oIConFilter3 = new sap.m.IconTabFilter(oController.PAGEID + "_ICONFILTER_3", {
			...
			content : sap.ui.jsfragment("zui5_hrxx_actretire2.fragment.RetireSurvey", oController)
		});
		...
		var oIConFilter4 = new sap.m.IconTabFilter(oController.PAGEID + "_ICONFILTER_4",{
			...
			content : sap.ui.jsfragment("zui5_hrxx_actretire2.fragment.HRFaceToFace", oController)
		});
		...
		var oIConFilter5 = new sap.m.IconTabFilter(oController.PAGEID + "_ICONFILTER_5",{
			...
			content : sap.ui.jsfragment("zui5_hrxx_actretire2.fragment.RetireCheck", oController)
		});
		...
		var oIConFilter6 = new sap.m.IconTabFilter(oController.PAGEID + "_ICONFILTER_6",{
			...
			content : sap.ui.jsfragment("zui5_hrxx_actretire2.fragment.RetireDocument", oController)
		});
		
		var oProcessFilter = new sap.m.IconTabSeparator(oController.PAGEID + "_PROCESS",{icon : "sap-icon://process"});
