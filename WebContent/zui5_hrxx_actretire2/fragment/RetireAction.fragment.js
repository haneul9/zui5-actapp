sap.ui.jsfragment("zui5_hrxx_actretire2.fragment.RetireAction", {
...
//		}).addStyleClass("L2PToolbarNoBottomLine");
		...
		oCell = new sap.ui.commons.layout.MatrixLayoutCell({
			...
			content : [new sap.m.Label({text: oBundleText.getText("ACT_EXIST_REQUEST")}).addStyleClass("L2P13Font")]
